#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_log.c"
...
#line 2 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_log.c"
...
#line 1155 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_log.c"
...
qboolean CalculateTeamRedShirt(gentity_t *ent)
{
	...
	for (i = 0; i < g_maxclients.integer; i++)
	{
		...
		nScore -= player->client->ps.fd.suicides; 
		if (nScore > nHighestScore)
		{
			nHighestScore = nScore;
			nBestPlayer = i;
