#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
#line 19 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\q_shared.h"
...
#line 20 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\botlib.h"
...
#line 132 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\botlib.h"
...
typedef struct botlib_import_s
{
	...
	void		(__cdecl *Print)(int type, char *fmt, ...);
...
#line 21 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
#line 22 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\be_ea.h"
...
#line 23 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\be_ai_char.h"
...
#line 24 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\be_ai_chat.h"
...
typedef struct bot_match_s
{
	...
	int type;
	int subtype;
	bot_matchvariable_t variables[8];
} bot_match_t;
...
#line 25 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\be_ai_gen.h"
...
int GeneticParentsAndChildSelection(int numranks, float *ranks, int *parent1, int *parent2, int *child);
#line 26 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\be_ai_goal.h"
...
#line 27 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\be_ai_move.h"
...
#line 28 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\be_ai_weap.h"
...
void BotResetWeaponState(int weaponstate);
#line 29 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
#line 31 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
#line 32 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"

#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\chars.h"
...
#line 34 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\inv.h"
...
#line 35 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\syn.h"
...
#line 36 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
boteventtracker_t gBotEventTracker[32];
...
#line 70 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"


vmCvar_t bot_nogoals;
vmCvar_t bot_debugmessages;
#line 75 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
void BotOrder(gentity_t *ent, int clientnum, int ordernum)
{
	...
	if (clientnum != -1)
	{
		...
		else
		{
			...
			botstates[clientnum]->chatAltObject = ((void *)0);
		...
		while (i < 32)
		{
			if (botstates[i] && OnSameTeam(ent, &g_entities[i]))
			{
				...
				else
				{
					...
					botstates[i]->chatAltObject = ((void *)0);
...
void __cdecl BotAI_Print(int type, char *fmt, ...) { return; }
...
int BotAI_GetEntityState( int entityNum, entityState_t *state ) {
	...
	if (ent->r.svFlags & 0x00000001) return qfalse;
...
void BotChangeViewAngles(bot_state_t *bs, float thinktime) {
	...
	if (bs->ideal_viewangles[0] > 180) bs->ideal_viewangles[0] -= 360;
	...
	if (bs->viewangles[0] > 180) bs->viewangles[0] -= 360;
...
void BotInputToUserCommand(bot_input_t *bi, usercmd_t *ucmd, int delta_angles[3], int time, int useTime) {
	...
	if (bi->actionflags & 0x0008000) {
		bi->actionflags |= 0x0000010;
		bi->actionflags &= ~0x0008000;
	}
	
	if (bi->actionflags & 0x0000008) ucmd->buttons = 1;
	if (bi->actionflags & 0x0000001) ucmd->buttons |= 1;
	if (bi->actionflags & 0x0200000) ucmd->buttons |= 128;

	if (bi->actionflags & 0x0020000) ucmd->buttons |= 8;
	if (bi->actionflags & 0x0000002) ucmd->buttons |= 4;
	if (bi->actionflags & 0x0080000) ucmd->buttons |= 16;

	if (bi->actionflags & 0x0100000) ucmd->buttons |= 512;
...
#line 579 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"

	if (bi->weapon == WP_NONE)
	{


#line 585 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
	...
	ucmd->angles[0] = ((int)((bi->viewangles[0])*65536/360) & 65535);
	ucmd->angles[1] = ((int)((bi->viewangles[1])*65536/360) & 65535);
	ucmd->angles[2] = ((int)((bi->viewangles[2])*65536/360) & 65535);
	...
	if (bi->dir[2]) angles[0] = bi->viewangles[0];
	else angles[0] = 0;
	...
	ucmd->forwardmove = ((forward)[0]*(bi->dir)[0]+(forward)[1]*(bi->dir)[1]+(forward)[2]*(bi->dir)[2]) * bi->speed;
	ucmd->rightmove = ((right)[0]*(bi->dir)[0]+(right)[1]*(bi->dir)[1]+(right)[2]*(bi->dir)[2]) * bi->speed;
	ucmd->upmove = abs((int)(forward[2])) * bi->dir[2] * bi->speed;
	
	if (bi->actionflags & 0x0000200) ucmd->forwardmove += 127;
	if (bi->actionflags & 0x0000800) ucmd->forwardmove -= 127;
	if (bi->actionflags & 0x0001000) ucmd->rightmove -= 127;
	if (bi->actionflags & 0x0002000) ucmd->rightmove += 127;
	
	if (bi->actionflags & 0x0000010) ucmd->upmove += 127;
	
	if (bi->actionflags & 0x0000080) ucmd->upmove -= 127;
...
void BotUpdateInput(bot_state_t *bs, int time, int elapsed_time) {
	...
	for (j = 0; j < 3; j++) {
		bs->viewangles[j] = AngleMod(bs->viewangles[j] + ((bs->cur_ps.delta_angles[j])*(360.0/65536)));
	}
	...
	if (bi.actionflags & 0x0000008) {
		if (bs->lastucmd.buttons & 1) bi.actionflags &= ~(0x0000008|0x0000001);
	}
...
void RemoveColorEscapeSequences( char *text ) {
	...
	l = 0;
	for ( i = 0; text[i]; i++ ) {
		if (( &text[i] && *(&text[i]) == '^' && *((&text[i])+1) && *((&text[i])+1) != '^' && *((&text[i])+1) <= '7' && *((&text[i])+1) >= '0' )) {
			i++;
			continue;
		}
		if (text[i] > 0x7E)
...
int BotAI(int client, float thinktime) {
	...
	int start = 0;
	int end = 0;
#line 704 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"

	trap_EA_ResetInput(client);
	
	bs = botstates[client];
	if (!bs || !bs->inuse) {
		BotAI_Print(4, "BotAI: client %d is not setup\n", client);
		return qfalse;
	}
	...
	((bs->origin)[0]=(bs->cur_ps.origin)[0],(bs->origin)[1]=(bs->cur_ps.origin)[1],(bs->origin)[2]=(bs->cur_ps.origin)[2]);
	
	((bs->eye)[0]=(bs->cur_ps.origin)[0],(bs->eye)[1]=(bs->cur_ps.origin)[1],(bs->eye)[2]=(bs->cur_ps.origin)[2]);
	bs->eye[2] += bs->cur_ps.viewheight;
	


	start = trap_Milliseconds();
#line 753 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
#line 764 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
void BotScheduleBotThink(void) {
	...
	for( i = 0; i < 32; i++ ) {
		...
		botstates[i]->botthink_residual = 0 * botnum / numbots;
		botnum++;
	}
}
...
int BotAISetupClient(int client, struct bot_settings_s *settings, qboolean restart) {
	...
	if (bs && bs->inuse) {
		BotAI_Print(4, "BotAISetupClient: client %d already setup\n", client);
		return qfalse;
	}
	...
	if (PlayersInGame())
	{ 
		BotDoChat(bs, "GeneralGreetings", 1);
	}
...
int OrgVisible(vec3_t org1, vec3_t org2, int ignore)
{
	...
	trap_Trace(&tr, org1, ((void *)0), ((void *)0), org2, ignore, (0x00000001|0x00001000));
...
int WPOrgVisible(gentity_t *bot, vec3_t org1, vec3_t org2, int ignore)
{
	...
	if (tr.fraction == 1)
	{
		trap_Trace(&tr, org1, ((void *)0), ((void *)0), org2, ignore, (0x00000001|0x00000010|0x00000100|0x00001000));

		if (tr.fraction != 1 && tr.entityNum != ((1<<10)-1) && g_entities[tr.entityNum].s.eType == ET_SPECIAL)
		{
...
int OrgVisibleBox(vec3_t org1, vec3_t mins, vec3_t maxs, vec3_t org2, int ignore)
{
	...
	{
		trap_Trace(&tr, org1, mins, maxs, org2, ignore, (0x00000001|0x00001000));
	}
...
int CheckForFunc(vec3_t org, int ignore)
{
	...
	((under)[0]=(org)[0],(under)[1]=(org)[1],(under)[2]=(org)[2]);

	under[2] -= 64;

	trap_Trace(&tr, org, ((void *)0), ((void *)0), under, ignore, (0x00000001|0x00001000));
...
qboolean BotPVSCheck( const vec3_t p1, const vec3_t p2 )
{
	...
	{
		vec3_t subPoint;
		((subPoint)[0]=(p1)[0]-(p2)[0],(subPoint)[1]=(p1)[1]-(p2)[1],(subPoint)[2]=(p1)[2]-(p2)[2]);
...
int GetNearestVisibleWP(vec3_t org, int ignore)
{
	...
	while (i < gWPNum)
	{
		...
		{
			((a)[0]=(org)[0]-(gWPArray[i]->origin)[0],(a)[1]=(org)[1]-(gWPArray[i]->origin)[1],(a)[2]=(org)[2]-(gWPArray[i]->origin)[2]);
...
int PassWayCheck(bot_state_t *bs, int windex)
{
	...
	if (g_RMG.integer)
	{
		if ((gWPArray[windex]->flags & 0x00020000) ||
			(gWPArray[windex]->flags & 0x00040000))
		{ 
			return 1;
		}
	}

	if (bs->wpDirection && (gWPArray[windex]->flags & 0x00004000))
	{ 
		
	}
	else if (!bs->wpDirection && (gWPArray[windex]->flags & 0x00008000))
	{ 
...
float TotalTrailDistance(int start, int end, bot_state_t *bs)
{
	...
	while (beginat < endat)
	{
		...
		if (!g_RMG.integer)
		{
			if ((end > start && gWPArray[beginat]->flags & 0x00008000) ||
				(start > end && gWPArray[beginat]->flags & 0x00004000))
			{ 
				return -1;
			}
		}
...
#line 1262 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
void CheckForShorterRoutes(bot_state_t *bs, int newwpindex)
{
	...
	{ 
		...
		bs->wpSwitchTime = level.time + 250;
...
void WPConstantRoutine(bot_state_t *bs)
{
	...
	if (bs->wpCurrent->flags & 0x00000020)
	{ 
...
#line 1438 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
	}
}
...
void WPTouchRoutine(bot_state_t *bs)
{
	...
	if (bs->wpCurrent->flags & 0x00200000)
	{ 
		bs->noUseTime = level.time + 4000;
	}


	if ((bs->wpCurrent->flags & 0x00000010) && bs->wpCurrent->forceJumpTo)
	{ 
...
#line 1491 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"

	if (bs->isCamper && bot_camp.integer && (BotIsAChickenWuss(bs) || BotCTFGuardDuty(bs) || bs->isCamper == 2) && ((bs->wpCurrent->flags & 0x00002000) || (bs->wpCurrent->flags & 0x00000800)) &&
	...
	{ 
		...
		{
			bs->isCamping = level.time + rand()%15000 + 5000;
			bs->wpCamping = bs->wpCurrent;
			bs->wpCampingTo = gWPArray[lastNum];

			if (bs->wpCurrent->flags & 0x00000800)
			{
...
{
	((bs->ideal_viewangles)[0]=(bs->goalAngles)[0],(bs->ideal_viewangles)[1]=(bs->goalAngles)[1],(bs->ideal_viewangles)[2]=(bs->goalAngles)[2]);
}
...
{
	vec3_t playerMins = {-15, -15, -8};
	vec3_t playerMaxs = {15, 15, 40};
	vec3_t from, to;
	...
	((dirAng)[0]=(traceto)[0]-(bs->origin)[0],(dirAng)[1]=(traceto)[1]-(bs->origin)[1],(dirAng)[2]=(traceto)[2]-(bs->origin)[2]);
	VectorNormalize(dirAng);
	vectoangles(dirAng, dirAng);

	if (AngleDifference(bs->viewangles[1], dirAng[1]) > 60 ||
		AngleDifference(bs->viewangles[1], dirAng[1]) < -60)
	{ 
		return 0;
	}

	((from)[0]=(bs->origin)[0],(from)[1]=(bs->origin)[1],(from)[2]=(bs->origin)[2]);
	((to)[0]=(traceto)[0],(to)[1]=(traceto)[1],(to)[2]=(traceto)[2]);

	((dirDif)[0]=(to)[0]-(from)[0],(dirDif)[1]=(to)[1]-(from)[1],(dirDif)[2]=(to)[2]-(from)[2]);
	...
	trap_Trace(&tr, from, playerMins, playerMaxs, to, bs->client, (0x00000001|0x00000010|0x00000100|0x00001000));
...
#line 1645 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
...
int BotTrace_Jump(bot_state_t *bs, vec3_t traceto)
{
	...
	((a)[0]=(traceto)[0]-(bs->origin)[0],(a)[1]=(traceto)[1]-(bs->origin)[1],(a)[2]=(traceto)[2]-(bs->origin)[2]);
	vectoangles(a, a);

	AngleVectors(a, fwd, ((void *)0), ((void *)0));
	...
	trap_Trace(&tr, bs->origin, mins, maxs, traceto_mod, bs->client, (0x00000001|0x00000010|0x00000100|0x00001000));
	...
	((tracefrom_mod)[0]=(bs->origin)[0],(tracefrom_mod)[1]=(bs->origin)[1],(tracefrom_mod)[2]=(bs->origin)[2]);
	...
	trap_Trace(&tr, tracefrom_mod, mins, maxs, traceto_mod, bs->client, (0x00000001|0x00000010|0x00000100|0x00001000));

	if (tr.fraction == 1 || Q_irand(0,100) >= 87)
	{
		if (orTr >= 0 && orTr < 32 && botstates[orTr] && botstates[orTr]->jumpTime > level.time)
		{
			
		}

		if (bs->currentEnemy && bs->currentEnemy->s.number == orTr && (BotGetWeaponRange(bs) == 4 || BotGetWeaponRange(bs) == 1))
		{
...
int PassStandardEnemyChecks(bot_state_t *bs, gentity_t *en)
{
	...
	if (OnSameTeam(&g_entities[bs->client], en) && g_tkbot.integer == 0)
	{ 
		return 0;
	}
	...
	if (BotMindTricked(bs->client, en->s.number))
	{
		...
		{ 
			...
			((vs)[0]=(bs->origin)[0]-(en->client->ps.origin)[0],(vs)[1]=(bs->origin)[1]-(en->client->ps.origin)[1],(vs)[2]=(bs->origin)[2]-(en->client->ps.origin)[2]);
...
void BotDamageNotification(gclient_t *bot, gentity_t *attacker)
{
	...
	{ 
		...
		while (i < 32)
		{
			...
			{
				botstates[i]->lastAttacked = ((void *)0);
			}
	...
	{ 
		...
		bs->enemySeenTime = level.time + 20000;
	}
}
...
int BotCanHear(bot_state_t *bs, gentity_t *en, float endist)
{
	...
	switch(gBotEventTracker[en->s.number].events[gBotEventTracker[en->s.number].eventSequence & (2-1)])
	{ 
...
int ScanForEnemies(bot_state_t *bs)
{
	...
	{
		if (
			(i != bs->client && g_entities[i].client && 
		...
		{
			((a)[0]=(g_entities[i].client->ps.origin)[0]-(bs->eye)[0],(a)[1]=(g_entities[i].client->ps.origin)[1]-(bs->eye)[1],(a)[2]=(g_entities[i].client->ps.origin)[2]-(bs->eye)[2]);
			...
			if (distcheck < closest && ((InFieldOfVision(bs->viewangles, 90, a) && !BotMindTricked(bs->client, i)) || BotCanHear(bs, &g_entities[i], distcheck)) && OrgVisible(bs->eye, g_entities[i].client->ps.origin, -1))
			{
				if (BotMindTricked(bs->client, i))
				{
					...
					{
						if (!hasEnemyDist || distcheck < (hasEnemyDist - 64))
						{ 
...
{ 
	...
	((xybot)[0]=(bs->origin)[0],(xybot)[1]=(bs->origin)[1],(xybot)[2]=(bs->origin)[2]);
	((xywp)[0]=(bs->wpCurrent->origin)[0],(xywp)[1]=(bs->wpCurrent->origin)[1],(xywp)[2]=(bs->wpCurrent->origin)[2]);

	xybot[2] = 0;
	xywp[2] = 0;

	((a)[0]=(xybot)[0]-(xywp)[0],(a)[1]=(xybot)[1]-(xywp)[1],(a)[2]=(xybot)[2]-(xywp)[2]);
...
jmPass:
	...
	bs->chickenWussCalculationTime = level.time + 10000;

	if (g_entities[bs->client].health < 5)
	{ 
		return 1;
	}
	...
	if (bWRange == 1 || bWRange == 4)
	{
		if (bWRange != 4 || !bs->saberSpecialist)
		{ 
...
gentity_t *GetNearestBadThing(bot_state_t *bs)
{
	...
	while (i < level.num_entities)
	{
		...
		{ 
			...
			((hold)[0]=(bs->origin)[0]-(ent->r.currentOrigin)[0],(hold)[1]=(bs->origin)[1]-(ent->r.currentOrigin)[1],(hold)[2]=(bs->origin)[2]-(ent->r.currentOrigin)[2]);
			...
			if (ent->s.weapon == WP_ROCKET_LAUNCHER &&
				...
				(ent->r.ownerNum > 0 && ent->r.ownerNum < 32 &&
			...
			{
				trap_Trace(&tr, bs->origin, ((void *)0), ((void *)0), ent->s.pos.trBase, bs->client, (0x00000001|0x00001000));
		...
		if (ent && !ent->client && ent->inuse && ent->damage && ent->s.weapon && ent->r.ownerNum < 32 && ent->r.ownerNum >= 0)
		{ 
...
int BotDefendFlag(bot_state_t *bs)
{
	...
	((a)[0]=(bs->origin)[0]-(flagPoint->origin)[0],(a)[1]=(bs->origin)[1]-(flagPoint->origin)[1],(a)[2]=(bs->origin)[2]-(flagPoint->origin)[2]);

	if (VectorLength(a) > 256)
	{
...
int BotGetFlagBack(bot_state_t *bs)
{
	...
	if (bs->wpDestSwitchTime < level.time)
	{
		if (ent->client)
		{
			((usethisvec)[0]=(ent->client->ps.origin)[0],(usethisvec)[1]=(ent->client->ps.origin)[1],(usethisvec)[2]=(ent->client->ps.origin)[2]);
		}
		else
		{
			((usethisvec)[0]=(ent->s.origin)[0],(usethisvec)[1]=(ent->s.origin)[1],(usethisvec)[2]=(ent->s.origin)[2]);
		}
...
{ 
	...
	((a)[0]=(wp->origin)[0]-(flagEnt->s.pos.trBase)[0],(a)[1]=(wp->origin)[1]-(flagEnt->s.pos.trBase)[1],(a)[2]=(wp->origin)[2]-(flagEnt->s.pos.trBase)[2]);

	bestdist = VectorLength(a);

	if (bestdist <= 128)
	{
		trap_Trace(&tr, wp->origin, mins, maxs, flagEnt->s.pos.trBase, flagEnt->s.number, (0x00000001|0x00001000));
	...
	while (i < gWPNum)
	{
		((a)[0]=(gWPArray[i]->origin)[0]-(flagEnt->s.pos.trBase)[0],(a)[1]=(gWPArray[i]->origin)[1]-(flagEnt->s.pos.trBase)[1],(a)[2]=(gWPArray[i]->origin)[2]-(flagEnt->s.pos.trBase)[2]);
		testdist = VectorLength(a);

		if (testdist < bestdist)
		{
			trap_Trace(&tr, gWPArray[i]->origin, mins, maxs, flagEnt->s.pos.trBase, flagEnt->s.number, (0x00000001|0x00001000));
...
int CTFTakesPriority(bot_state_t *bs)
{
	...
	if (bs->cur_ps.weapon == WP_BRYAR_PISTOL &&
		(level.time - bs->lastDeadTime) < 1000)
	{ 
		...
		(level.time - bs->lastDeadTime) < 5000 &&
	...
	if (droppedRedFlag && (droppedRedFlag->flags & 0x00001000))
	{
	...
	if (droppedBlueFlag && (droppedBlueFlag->flags & 0x00001000))
	{
...
int EntityVisibleBox(vec3_t org1, vec3_t mins, vec3_t maxs, vec3_t org2, int ignore, int ignore2)
{
	...
	else if (tr.entityNum != ((1<<10)-1) && tr.entityNum == ignore2)
	{
		return 1;
	}
...
int Siege_TargetClosestObjective(bot_state_t *bs, int flag)
{
	...
	if ( bs->wpDestination && (bs->wpDestination->flags & flag) && bs->wpDestination->associated_entity != ((1<<10)-1) &&
	...
	while (i < gWPNum)
	{
		if ( gWPArray[i] && gWPArray[i]->inuse && (gWPArray[i]->flags & flag) && gWPArray[i]->associated_entity != ((1<<10)-1) &&
			 &g_entities[gWPArray[i]->associated_entity] && g_entities[gWPArray[i]->associated_entity].use )
		{
			((a)[0]=(gWPArray[i]->origin)[0]-(bs->origin)[0],(a)[1]=(gWPArray[i]->origin)[1]-(bs->origin)[1],(a)[2]=(gWPArray[i]->origin)[2]-(bs->origin)[2]);
...
hasPoint:
	...
	((a)[0]=(bs->origin)[0]-(bs->wpDestination->origin)[0],(a)[1]=(bs->origin)[1]-(bs->wpDestination->origin)[1],(a)[2]=(bs->origin)[2]-(bs->wpDestination->origin)[2]);
	...
	if (BotGetWeaponRange(bs) == 1 ||
		BotGetWeaponRange(bs) == 4)
	{
		bs->shootGoal = ((void *)0); 
	}
	...
	if (bs->touchGoal)
	{
		...
		((bs->goalPosition)[0]=(dif)[0],(bs->goalPosition)[1]=(dif)[1],(bs->goalPosition)[2]=(dif)[2]);
	}
...
{ 
	...
	while (i < 32)
	{
		...
		{
			((a)[0]=(ent->client->ps.origin)[0]-(bs->origin)[0],(a)[1]=(ent->client->ps.origin)[1]-(bs->origin)[1],(a)[2]=(ent->client->ps.origin)[2]-(bs->origin)[2]);
...
int SiegeTakesPriority(bot_state_t *bs)
{
	...
	{ 
		...
		(level.time - bs->lastDeadTime) < 15000 &&
		bs->wpDestination && bs->wpDestination->weight)
	{
		dest_sw = bs->wpDestination;
		dosw = 1;
	...
	if (bcl->sess.sessionTeam == 1)
	{
		attacker = imperial_attackers;
		flagForDefendableObjective = 0x00080000;
		flagForAttackableObjective = 0x00100000;
	}
	else
	{
		attacker = rebel_attackers;
		flagForDefendableObjective = 0x00100000;
		flagForAttackableObjective = 0x00080000;
	}
	...
	if (bs->siegeState == SIEGESTATE_ATTACKER)
	{
		...
		{ 
			...
			if (bs->shootGoal)
			{
				...
				{
					trap_Trace(&tr, bs->origin, ((void *)0), ((void *)0), dif, bs->client, (0x00000001|0x00001000));
...
int JMTakesPriority(bot_state_t *bs)
{
	int i = 0;
	int wpClose = -1;
	gentity_t *theImportantEntity = ((void *)0);
...
int BotHasAssociated(bot_state_t *bs, wpobject_t *wp)
{
	...
	if (wp->associated_entity == ((1<<10)-1))
	{ 
		return 1;
	}
	...
	{
		if (bs->cur_ps.ammo[as->item->giTag] > 10) 
		{
			return 1;
		}
...
#line 3668 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
	...
	if (badthing)
	{
		...
		{
			((a)[0]=(badthing->s.pos.trBase)[0]-(bs->wpCurrent->origin)[0],(a)[1]=(badthing->s.pos.trBase)[1]-(bs->wpCurrent->origin)[1],(a)[2]=(badthing->s.pos.trBase)[2]-(bs->wpCurrent->origin)[2]);
			plusLen = VectorLength(a);
			((a)[0]=(badthing->s.pos.trBase)[0]-(gWPArray[tempInt]->origin)[0],(a)[1]=(badthing->s.pos.trBase)[1]-(gWPArray[tempInt]->origin)[1],(a)[2]=(badthing->s.pos.trBase)[2]-(gWPArray[tempInt]->origin)[2]);
	...
	{ 
		if (bs->wpDestSwitchTime < level.time)
		{
			...
			{
				((usethisvec)[0]=(bs->revengeEnemy->client->ps.origin)[0],(usethisvec)[1]=(bs->revengeEnemy->client->ps.origin)[1],(usethisvec)[2]=(bs->revengeEnemy->client->ps.origin)[2]);
			}
			else
			{
				((usethisvec)[0]=(bs->revengeEnemy->s.origin)[0],(usethisvec)[1]=(bs->revengeEnemy->s.origin)[1],(usethisvec)[2]=(bs->revengeEnemy->s.origin)[2]);
			}
		...
		bs->squadLeader->client && (bs->squadLeader->client->pers.connected == CA_ACTIVE || bs->squadLeader->client->pers.connected == CA_AUTHORIZING))
	{
		if (bs->wpDestSwitchTime < level.time)
		{
			...
			{
				((usethisvec)[0]=(bs->squadLeader->client->ps.origin)[0],(usethisvec)[1]=(bs->squadLeader->client->ps.origin)[1],(usethisvec)[2]=(bs->squadLeader->client->ps.origin)[2]);
			}
			else
			{
				((usethisvec)[0]=(bs->squadLeader->s.origin)[0],(usethisvec)[1]=(bs->squadLeader->s.origin)[1],(usethisvec)[2]=(bs->squadLeader->s.origin)[2]);
			}
	...
	else if (bs->currentEnemy)
	{
		...
		{
			((usethisvec)[0]=(bs->currentEnemy->client->ps.origin)[0],(usethisvec)[1]=(bs->currentEnemy->client->ps.origin)[1],(usethisvec)[2]=(bs->currentEnemy->client->ps.origin)[2]);
		}
		else
		{
			((usethisvec)[0]=(bs->currentEnemy->s.origin)[0],(usethisvec)[1]=(bs->currentEnemy->s.origin)[1],(usethisvec)[2]=(bs->currentEnemy->s.origin)[2]);
		}
		...
		if (bs->frame_Enemy_Len < distChange || (bChicken && bChicken != 2))
		{
			...
			{
				((a)[0]=(gWPArray[cWPIndex+1]->origin)[0]-(usethisvec)[0],(a)[1]=(gWPArray[cWPIndex+1]->origin)[1]-(usethisvec)[1],(a)[2]=(gWPArray[cWPIndex+1]->origin)[2]-(usethisvec)[2]);
				plusLen = VectorLength(a);
				((a)[0]=(gWPArray[cWPIndex-1]->origin)[0]-(usethisvec)[0],(a)[1]=(gWPArray[cWPIndex-1]->origin)[1]-(usethisvec)[1],(a)[2]=(gWPArray[cWPIndex-1]->origin)[2]-(usethisvec)[2]);
				minusLen = VectorLength(a);
...
void CommanderBotCTFAI(bot_state_t *bs)
{
	...
	int squadmates = 0;
	gentity_t *squad[32];
	int defendAttackPriority = 0; 
	int guardDefendPriority = 0; 
	int attackRetrievePriority = 0; 
	int myFlag = 0;
	int enemyFlag = 0;
	int enemyHasOurFlag = 0;
	int weHaveEnemyFlag = 0;
...
void MeleeCombatHandling(bot_state_t *bs)
{
	...
	if (bs->meleeStrafeTime < level.time)
	{
		...
		bs->meleeStrafeTime = level.time + Q_irand(250, 1000);
	}
	...
	((downvec)[0]=(usethisvec)[0],(downvec)[1]=(usethisvec)[1],(downvec)[2]=(usethisvec)[2]);
	downvec[2] -= 4096;

	trap_Trace(&tr, usethisvec, mins, maxs, downvec, -1, (0x00000001|0x00001000));

	en_down = (int)tr.endpos[2];

	((downvec)[0]=(bs->origin)[0],(downvec)[1]=(bs->origin)[1],(downvec)[2]=(bs->origin)[2]);
	downvec[2] -= 4096;

	trap_Trace(&tr, bs->origin, mins, maxs, downvec, -1, (0x00000001|0x00001000));

	me_down = (int)tr.endpos[2];

	((a)[0]=(usethisvec)[0]-(bs->origin)[0],(a)[1]=(usethisvec)[1]-(bs->origin)[1],(a)[2]=(usethisvec)[2]-(bs->origin)[2]);
	vectoangles(a, a);
	AngleVectors(a, fwd, ((void *)0), ((void *)0));
	...
	((downvec)[0]=(midorg)[0],(downvec)[1]=(midorg)[1],(downvec)[2]=(midorg)[2]);
	downvec[2] -= 4096;

	trap_Trace(&tr, midorg, mins, maxs, downvec, -1, (0x00000001|0x00001000));
	...
	if (me_down == en_down &&
		en_down == mid_down)
	{
		((bs->goalPosition)[0]=(usethisvec)[0],(bs->goalPosition)[1]=(usethisvec)[1],(bs->goalPosition)[2]=(usethisvec)[2]);
	}
}
...
void SaberCombatHandling(bot_state_t *bs)
{
		...
		en_down == mid_down)
	{
		if (usethisvec[2] > (bs->origin[2]+32) &&
			...
			bs->currentEnemy->client->ps.groundEntityNum == ((1<<10)-1))
		{
			bs->jumpTime = level.time + 100;
		}
		...
		{
			((bs->goalPosition)[0]=(bs->origin)[0],(bs->goalPosition)[1]=(bs->origin)[1],(bs->goalPosition)[2]=(bs->origin)[2]);
			bs->saberBFTime = 0;
		}
		else
		{
		...
		if (bs->currentEnemy && bs->currentEnemy->client)
		{
			...
			{
				bs->beStill = level.time +Q_irand(250, 500); 
				bs->saberSTime = level.time + Q_irand(600, 900);
			}
			else if (bs->currentEnemy->client->ps.weapon == WP_SABER && bs->frame_Enemy_Len < 80 && (Q_irand(1, 10) < 6  && bs->saberBFTime < level.time) || bs->saberBTime > level.time || BG_SaberInKata(bs->currentEnemy->client->ps.saberMove) || bs->currentEnemy->client->ps.saberMove == LS_SPINATTACK || bs->currentEnemy->client->ps.saberMove == LS_SPINATTACK_DUAL)
			{
				vec3_t vs;
				vec3_t groundcheck;
				int idealDist;
				...
				((vs)[0]=(bs->origin)[0]-(usethisvec)[0],(vs)[1]=(bs->origin)[1]-(usethisvec)[1],(vs)[2]=(bs->origin)[2]-(usethisvec)[2]);
				VectorNormalize(vs);
				...
				while (checkIncr < idealDist)
				{
					...
					((groundcheck)[0]=(bs->goalPosition)[0],(groundcheck)[1]=(bs->goalPosition)[1],(groundcheck)[2]=(bs->goalPosition)[2]);

					groundcheck[2] -= 64;

					trap_Trace(&tr, bs->goalPosition, ((void *)0), ((void *)0), groundcheck, bs->client, (0x00000001|0x00001000));
...
void BotAimLeading(bot_state_t *bs, vec3_t headlevel, float leadAmount)
{
	...
	((movementVector)[0]=(bs->currentEnemy->client->ps.velocity)[0],(movementVector)[1]=(bs->currentEnemy->client->ps.velocity)[1],(movementVector)[2]=(bs->currentEnemy->client->ps.velocity)[2]);

	VectorNormalize(movementVector);

	x = bs->frame_Enemy_Len*leadAmount; 
	...
	((a)[0]=(predictedSpot)[0]-(bs->eye)[0],(a)[1]=(predictedSpot)[1]-(bs->eye)[1],(a)[2]=(predictedSpot)[2]-(bs->eye)[2]);
	vectoangles(a, ang);
	((bs->goalAngles)[0]=(ang)[0],(bs->goalAngles)[1]=(ang)[1],(bs->goalAngles)[2]=(ang)[2]);
}
...
void BotAimOffsetGoalAngles(bot_state_t *bs)
{
	...
	if (bs->aimOffsetTime > level.time)
	{
		...
		{
			bs->goalAngles[1] += bs->aimOffsetAmtYaw;
		}

		if (bs->aimOffsetAmtPitch)
		{
			bs->goalAngles[0] += bs->aimOffsetAmtPitch;
		}
	...
	bs->aimOffsetTime = level.time + rand()%200 + 100;
}
...
int ShouldSecondaryFire(bot_state_t *bs)
{
	...
	if (bs->cur_ps.weapon == WP_DISRUPTOR){
		return 0;
	}
	...
	if ((weap == WP_BRYAR_PISTOL || weap == WP_BRYAR_OLD) && bs->frame_Enemy_Len < 300)
	{
		return 1;
	}
	...
	else if (weap == WP_CONCUSSION && bs->frame_Enemy_Len < 600 && bs->frame_Enemy_Len > 250)
	{
		return 1;
	}
...
int CombatBotAI(bot_state_t *bs, float thinktime)
{
	...
	if (bs->currentEnemy->client)
	{
		((eorg)[0]=(bs->currentEnemy->client->ps.origin)[0],(eorg)[1]=(bs->currentEnemy->client->ps.origin)[1],(eorg)[2]=(bs->currentEnemy->client->ps.origin)[2]);
	}
	else
	{
		((eorg)[0]=(bs->currentEnemy->s.origin)[0],(eorg)[1]=(bs->currentEnemy->s.origin)[1],(eorg)[2]=(bs->currentEnemy->s.origin)[2]);
	}

	((a)[0]=(eorg)[0]-(bs->eye)[0],(a)[1]=(eorg)[1]-(bs->eye)[1],(a)[2]=(eorg)[2]-(bs->eye)[2]);
	vectoangles(a, a);


	if (BotGetWeaponRange(bs) == 4)
	{
		if (bs->frame_Enemy_Len <= 128)
		{
			bs->doAttack = 1;
	...
	else if (BotGetWeaponRange(bs) == 1)
	{
		if (bs->frame_Enemy_Len <= 256)
		{
			bs->doAttack = 1;
			if (&g_entities[bs->client].client->ps.weapon == WP_MELEE && Q_irand(0,5) == 3){
				G_SetAnim(&g_entities[bs->client], &g_entities[bs->client].client->pers.cmd, 1|2, BOTH_KYLE_GRAB, 1|2, 0);
				TryGrapple(&g_entities[bs->client]);
			}
		}
	}
	else
		...
		if (InFieldOfVision(bs->viewangles, fovcheck, a))
		{
			...
			else
			{
					...
					bs->cur_ps.weaponstate != WEAPON_CHARGING)
				{
					...
					bs->altChargeTime = Q_irand(250, 500);
				}
...
int BotFallbackNavigation(bot_state_t *bs)
{
	...
	((b_angle)[0]=(bs->goalAngles)[0],(b_angle)[1]=(bs->goalAngles)[1],(b_angle)[2]=(bs->goalAngles)[2]);

	AngleVectors(b_angle, fwd, ((void *)0), ((void *)0));

	trto[0] = bs->origin[0] + fwd[0]*16;
	trto[1] = bs->origin[1] + fwd[1]*16;
	trto[2] = bs->origin[2] + fwd[2]*16;

	trap_Trace(&tr, bs->origin, mins, maxs, trto, ((1<<10)-1), (0x00000001|0x00001000));

	if (tr.fraction == 1)
	{
		((bs->goalPosition)[0]=(trto)[0],(bs->goalPosition)[1]=(trto)[1],(bs->goalPosition)[2]=(trto)[2]);
		return 1; 
	}
	else
	{
		bs->goalAngles[1] = rand()%360;
	}
...
int BotSelectIdealWeapon(bot_state_t *bs)
{
	...
	if ( bs->currentEnemy && bs->frame_Enemy_Len > 150 &&
	...
	{ 
		...
		else if (BotWeaponSelectable(bs, WP_STUN_BATON))
		{
...
void StrafeTracing(bot_state_t *bs)
{
	...
	AngleVectors(bs->viewangles, ((void *)0), right, ((void *)0));
	...
	trap_Trace(&tr, bs->origin, mins, maxs, rorg, bs->client, (0x00000001|0x00001000));
	...
	((drorg)[0]=(rorg)[0],(drorg)[1]=(rorg)[1],(drorg)[2]=(rorg)[2]);

	drorg[2] -= 32;

	trap_Trace(&tr, rorg, ((void *)0), ((void *)0), drorg, bs->client, (0x00000001|0x00001000));
...
gentity_t *CheckForFriendInLOF(bot_state_t *bs)
{
	...
	AngleVectors(bs->viewangles, fwd, ((void *)0), ((void *)0));

	((trfrom)[0]=(bs->eye)[0],(trfrom)[1]=(bs->eye)[1],(trfrom)[2]=(bs->eye)[2]);

	trto[0] = trfrom[0] + fwd[0]*2048;
	trto[1] = trfrom[1] + fwd[1]*2048;
	trto[2] = trfrom[2] + fwd[2]*2048;

	trap_Trace(&tr, trfrom, mins, maxs, trto, bs->client, (0x00000001|0x00000010|0x00000100|0x00001000));

	if (tr.fraction != 1 && tr.entityNum <= 32)
	{
		trent = &g_entities[tr.entityNum];

		if (trent && trent->client)
		{
			if (IsTeamplay() && OnSameTeam(&g_entities[bs->client], trent) && g_tkbot.integer == 0)
			{
				return trent;
			}
...
void CTFFlagMovement(bot_state_t *bs)
{
	...
	if (bs->wantFlag && (bs->wantFlag->flags & 0x00001000))
	{
		...
		{
			((a)[0]=(bs->origin)[0]-(bs->wantFlag->s.pos.trBase)[0],(a)[1]=(bs->origin)[1]-(bs->wantFlag->s.pos.trBase)[1],(a)[2]=(bs->origin)[2]-(bs->wantFlag->s.pos.trBase)[2]);

			if (VectorLength(a) <= 256)
			{
				((bs->goalPosition)[0]=(bs->wantFlag->s.pos.trBase)[0],(bs->goalPosition)[1]=(bs->wantFlag->s.pos.trBase)[1],(bs->goalPosition)[2]=(bs->wantFlag->s.pos.trBase)[2]);
				return;
			}
			else
			{
	...
	if (flagRed && flagBlue)
	{
		...
		{
			if (bs->wpDestination == flagRed && droppedRedFlag && (droppedRedFlag->flags & 0x00001000) && droppedRedFlag->classname && strcmp(droppedRedFlag->classname, "freed") != 0)
			{
				desiredDrop = droppedRedFlag;
				diddrop = 1;
			}
			if (bs->wpDestination == flagBlue && droppedBlueFlag && (droppedBlueFlag->flags & 0x00001000) && droppedBlueFlag->classname && strcmp(droppedBlueFlag->classname, "freed") != 0)
			{
			...
			{
				((a)[0]=(bs->origin)[0]-(desiredDrop->s.pos.trBase)[0],(a)[1]=(bs->origin)[1]-(desiredDrop->s.pos.trBase)[1],(a)[2]=(bs->origin)[2]-(desiredDrop->s.pos.trBase)[2]);

				if (VectorLength(a) <= 256)
				{
					trap_Trace(&tr, bs->origin, mins, maxs, desiredDrop->s.pos.trBase, bs->client, (0x00000001|0x00001000));

					if (tr.fraction == 1 || tr.entityNum == desiredDrop->s.number)
					{
						((bs->goalPosition)[0]=(desiredDrop->s.pos.trBase)[0],(bs->goalPosition)[1]=(desiredDrop->s.pos.trBase)[1],(bs->goalPosition)[2]=(desiredDrop->s.pos.trBase)[2]);
						((bs->staticFlagSpot)[0]=(desiredDrop->s.pos.trBase)[0],(bs->staticFlagSpot)[1]=(desiredDrop->s.pos.trBase)[1],(bs->staticFlagSpot)[2]=(desiredDrop->s.pos.trBase)[2]);
						return;
					}
				}
			}
...
{
	gentity_t *dp = ((void *)0);
	gentity_t *myDet = ((void *)0);
	vec3_t a;
	float enLen;
	float myLen;

	while ( (dp = G_Find( dp, ((int)&(((gentity_t *)0)->classname)), "detpack") ) != ((void *)0) )
	{
...
stillmadeit:
	...
	((a)[0]=(bs->currentEnemy->client->ps.origin)[0]-(myDet->s.pos.trBase)[0],(a)[1]=(bs->currentEnemy->client->ps.origin)[1]-(myDet->s.pos.trBase)[1],(a)[2]=(bs->currentEnemy->client->ps.origin)[2]-(myDet->s.pos.trBase)[2]);
	enLen = VectorLength(a);

	((a)[0]=(bs->origin)[0]-(myDet->s.pos.trBase)[0],(a)[1]=(bs->origin)[1]-(myDet->s.pos.trBase)[1],(a)[2]=(bs->origin)[2]-(myDet->s.pos.trBase)[2]);
	...
	if (enLen < 256 && OrgVisible(bs->currentEnemy->client->ps.origin, myDet->s.pos.trBase, bs->currentEnemy->s.number))
	{ 
		bs->plantKillEmAll = level.time + 250;
	}
}
...
int BotSurfaceNear(bot_state_t *bs)
{
	...
	trap_Trace(&tr, bs->origin, ((void *)0), ((void *)0), fwd, bs->client, (0x00000001|0x00001000));
	...
	{ 
		...
		{ 
			...
			{ 
				...
				((v)[0]=(vehicle->client->ps.origin)[0]-(bs->origin)[0],(v)[1]=(vehicle->client->ps.origin)[1]-(bs->origin)[1],(v)[2]=(vehicle->client->ps.origin)[2]-(bs->origin)[2]);
				VectorNormalize(v);
...
#line 6088 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
	...
	if (bot_forgimmick.integer)
	{
		...
		{ 
			...
			((mdir)[0]=(bs->origin)[0]-(vec3_origin)[0],(mdir)[1]=(bs->origin)[1]-(vec3_origin)[1],(mdir)[2]=(bs->origin)[2]-(vec3_origin)[2]);
		...
		{ 
			if (g_entities[0].client && g_entities[0].inuse)
			{
				...
				((mdir)[0]=(g_entities[0].client->ps.origin)[0]-(bs->origin)[0],(mdir)[1]=(g_entities[0].client->ps.origin)[1]-(bs->origin)[1],(mdir)[2]=(g_entities[0].client->ps.origin)[2]-(bs->origin)[2]);
				VectorNormalize(mdir);
				trap_EA_Move(bs->client, mdir, 5000);
			}
		}
	...
	((preFrameGAngles)[0]=(bs->goalAngles)[0],(preFrameGAngles)[1]=(bs->goalAngles)[1],(preFrameGAngles)[2]=(bs->goalAngles)[2]);
...

	{
		...
		((a_fo)[0]=(bs->currentEnemy->client->ps.origin)[0]-(bs->eye)[0],(a_fo)[1]=(bs->currentEnemy->client->ps.origin)[1]-(bs->eye)[1],(a_fo)[2]=(bs->currentEnemy->client->ps.origin)[2]-(bs->eye)[2]);
		...
		else if (bs->cur_ps.fd.forceSide != 0)
		{ 
			...
			else if ((bs->cur_ps.fd.forcePowersKnown & (1 << FP_LIGHTNING)) && bs->frame_Enemy_Len < 300 && level.clients[bs->client].ps.fd.forcePower > 50 && InFieldOfVision(bs->viewangles, 50, a_fo))
			{
				level.clients[bs->client].ps.fd.forcePowerSelected = FP_LIGHTNING;
				useTheForce = 1;
				forceHostile = 1;
			}
			else if ((bs->cur_ps.fd.forcePowersKnown & (1 << FP_GRIP)) && bs->frame_Enemy_Len < 256 && level.clients[bs->client].ps.fd.forcePower > forcePowerNeeded[level.clients[bs->client].ps.fd.forcePowerLevel[FP_GRIP]][FP_GRIP] && InFieldOfVision(bs->viewangles, 50, a_fo))
			{
				level.clients[bs->client].ps.fd.forcePowerSelected = FP_GRIP;
				useTheForce = 1;
				forceHostile = 1;
			...
			else if ((bs->cur_ps.fd.forcePowersKnown & (1 << FP_DRAIN)) && bs->frame_Enemy_Len < 512 && level.clients[bs->client].ps.fd.forcePower > 50 && InFieldOfVision(bs->viewangles, 50, a_fo) && bs->currentEnemy->client->ps.fd.forcePower > 10 && bs->currentEnemy->client->ps.fd.forceSide == 1)
			{
		...
		else if (bs->cur_ps.fd.forceSide == 1)
		{ 
			...
			else if ((bs->cur_ps.fd.forcePowersKnown & (1 << FP_TELEPATHY)) && bs->frame_Enemy_Len < 512 && level.clients[bs->client].ps.fd.forcePower > forcePowerNeeded[level.clients[bs->client].ps.fd.forcePowerLevel[FP_TELEPATHY]][FP_TELEPATHY] && InFieldOfVision(bs->viewangles, 50, a_fo) && !(bs->currentEnemy->client->ps.fd.forcePowersActive & (1 << FP_SEE)))
			{
				level.clients[bs->client].ps.fd.forcePowerSelected = FP_TELEPATHY;
				useTheForce = 1;
				forceHostile = 1;
			}
			else if ((bs->cur_ps.fd.forcePowersKnown & (1 << FP_ABSORB)) && g_entities[bs->client].health < 75 && bs->currentEnemy->client->ps.fd.forceSide == 2 && level.clients[bs->client].ps.fd.forcePower > forcePowerNeeded[level.clients[bs->client].ps.fd.forcePowerLevel[FP_ABSORB]][FP_ABSORB])
			{
				level.clients[bs->client].ps.fd.forcePowerSelected = FP_ABSORB;
				useTheForce = 1;
				forceHostile = 0;
...
if (rand()%5000 < 15 && ent->client->ps.fd.forcePower >= g_craneforce.integer){
		G_SetAnim(ent, ((void *)0), 1, FACE_SMILE, 1|2, 0);
	...
	if (rand()%5000 < 7){
		NPC_Spawn_f(&g_entities[bs->client]);
	}
	if (rand()%5000 < 50){				
	gentity_t *missile;
	vec3_t			fwd;
	int dexfactor, anim;
		...
		if (g_canhadokenfire.integer >= 1 && ent->client->ps.fd.forcePower >= 100){
			...
			ent->chain->r.svFlags |= 0x00001000; 
	...
	if (bot_honorableduelacceptance.integer)
	{
			...
			bs->currentEnemy->client->ps.saberHolstered)
		{
			...
			((e_ang_vec)[0]=(bs->currentEnemy->client->ps.origin)[0]-(bs->eye)[0],(e_ang_vec)[1]=(bs->currentEnemy->client->ps.origin)[1]-(bs->eye)[1],(e_ang_vec)[2]=(bs->currentEnemy->client->ps.origin)[2]-(bs->eye)[2]);
	...
	if (!bs->wpCurrent)
	{
		...
		if (wp != -1)
		{
			...
			bs->wpSeenTime = level.time + 800;
			bs->wpTravelTime = level.time + 12000;
		}
	}
	...
	if (bs->wpCurrent)
	{
		...
		{ 
			...
			((a)[0]=(vecC)[0]-(vecB)[0],(a)[1]=(vecC)[1]-(vecB)[1],(a)[2]=(vecC)[2]-(vecB)[2]);
		}
		else
		{
			((a)[0]=(bs->wpCurrent->origin)[0]-(bs->origin)[0],(a)[1]=(bs->wpCurrent->origin)[1]-(bs->origin)[1],(a)[2]=(bs->wpCurrent->origin)[2]-(bs->origin)[2]);
		}
	...
	if (bs->currentEnemy)
	{
		...
		if (OrgVisible(bs->eye, eorg, bs->client))
		{
			...
			((bs->lastEnemySpotted)[0]=(eorg)[0],(bs->lastEnemySpotted)[1]=(eorg)[1],(bs->lastEnemySpotted)[2]=(eorg)[2]);
			((bs->hereWhenSpotted)[0]=(bs->origin)[0],(bs->hereWhenSpotted)[1]=(bs->origin)[1],(bs->hereWhenSpotted)[2]=(bs->origin)[2]);
	...
	{
		bs->lastVisibleEnemyIndex = ((1<<10)-1);
	}
	...
	if (bs->wpCurrent)
	{
		...
		if (bs->wpCurrent->flags & 0x00001000)
		{
		...
		if (bs->frame_Waypoint_Vis || (bs->wpCurrent->flags & 0x00000400))
		{
			if (g_RMG.integer)
			{
		...
		((bs->goalPosition)[0]=(bs->wpCurrent->origin)[0],(bs->goalPosition)[1]=(bs->wpCurrent->origin)[1],(bs->goalPosition)[2]=(bs->wpCurrent->origin)[2]);
		if (bs->wpDirection)
		{
		...
		if (bs->wpCamping)
		{
			((a)[0]=(bs->wpCampingTo->origin)[0]-(bs->origin)[0],(a)[1]=(bs->wpCampingTo->origin)[1]-(bs->origin)[1],(a)[2]=(bs->wpCampingTo->origin)[2]-(bs->origin)[2]);
			vectoangles(a, ang);
			((bs->goalAngles)[0]=(ang)[0],(bs->goalAngles)[1]=(ang)[1],(bs->goalAngles)[2]=(ang)[2]);

			((a)[0]=(bs->origin)[0]-(bs->wpCamping->origin)[0],(a)[1]=(bs->origin)[1]-(bs->wpCamping->origin)[1],(a)[2]=(bs->origin)[2]-(bs->wpCamping->origin)[2]);
			if (VectorLength(a) < 64)
			{
				((bs->goalPosition)[0]=(bs->wpCamping->origin)[0],(bs->goalPosition)[1]=(bs->wpCamping->origin)[1],(bs->goalPosition)[2]=(bs->wpCamping->origin)[2]);
			...
			!(gLevelFlags & 1))
		{
			((a)[0]=(gWPArray[goalWPIndex]->origin)[0]-(bs->origin)[0],(a)[1]=(gWPArray[goalWPIndex]->origin)[1]-(bs->origin)[1],(a)[2]=(gWPArray[goalWPIndex]->origin)[2]-(bs->origin)[2]);
			vectoangles(a, ang);
			((bs->goalAngles)[0]=(ang)[0],(bs->goalAngles)[1]=(ang)[1],(bs->goalAngles)[2]=(ang)[2]);
		}
		else
	...
	else 
	{
		...
		{ 
			...
			bs->jumpHoldTime = level.time + 3500;
			g_entities[bs->client].client->ps.pm_flags |= 2;
			bs->jDelay = 0;
			g_entities[bs->client].client->ps.pm_type = PM_FLOAT;
			g_entities[bs->client].client->ps.pm_time = level.time + 750;
		}
	...
	{ 
		...
		((vSubDif)[0]=(bs->origin)[0]-(bs->lastSignificantAreaChange)[0],(vSubDif)[1]=(bs->origin)[1]-(bs->lastSignificantAreaChange)[1],(vSubDif)[2]=(bs->origin)[2]-(bs->lastSignificantAreaChange)[2]);
		if (VectorLength(vSubDif) > 1500)
		{
			((bs->lastSignificantAreaChange)[0]=(bs->origin)[0],(bs->lastSignificantAreaChange)[1]=(bs->origin)[1],(bs->lastSignificantAreaChange)[2]=(bs->origin)[2]);
	...
	{
		((bs->goalAngles)[0]=(preFrameGAngles)[0],(bs->goalAngles)[1]=(preFrameGAngles)[1],(bs->goalAngles)[2]=(preFrameGAngles)[2]);
		bs->wpCurrent = ((void *)0);
	...
	if (Q_irand(0,100) == 5){
		g_entities[bs->client].client->jetPackOn = 0;
	}



	if (Q_irand(0,100) > 40 && g_entities[bs->client].client->ps.velocity[2] < -250 && Q_irand(0,g_entities[bs->client].client->ps.fd.forcePower) >= (g_emoteforce.integer / 2)){
		vec3_t oppDir;
		

		if (g_entities[bs->client].client->ps.origin[2] < 0 ){
		...
		bs->cur_ps.torsoTimer += 1750;
		bs->cur_ps.legsTimer += 1750;	
...
bs->jumpTime = level.time + 1750;
bs->jumpHoldTime = level.time + 1750;

	

if (Q_irand(0,100) > 62){
	g_entities[bs->client].client->ps.torsoAnim = 876;
	g_entities[bs->client].client->ps.legsAnim = 876;
	g_entities[bs->client].client->ps.torsoTimer = level.time + 1750;
	g_entities[bs->client].client->ps.legsTimer = level.time + 1750;
	g_entities[bs->client].client->ps.pm_flags |= 2;
	


}else{
	g_entities[bs->client].client->ps.torsoAnim = 872;
	g_entities[bs->client].client->ps.legsAnim = 872;
	g_entities[bs->client].client->ps.torsoTimer = level.time + 1750;
	g_entities[bs->client].client->ps.legsTimer = level.time + 1750;
	g_entities[bs->client].client->ps.pm_flags |= 2;
	...
	g_entities[bs->client].client->ps.velocity[2] *= -1.75f;
	if (g_entities[bs->client].client->ps.velocity[2] > 650){
		g_entities[bs->client].client->ps.velocity[2]= 650;
	}
	g_entities[bs->client].client->ps.fd.forcePower -= (g_emoteforce.integer / 2);
	g_entities[bs->client].client->ps.forceJumpFlip = qtrue;
	g_entities[bs->client].client->ps.torsoFlip = qtrue;
	g_entities[bs->client].client->ps.pm_type = PM_FLOAT;
	g_entities[bs->client].client->ps.pm_time = level.time + 1000;
	...
	if (bs->wpCurrent && g_RMG.integer)
	{
		...
		else if ((bs->wpTravelTime - level.time) < 7000 && (bs->wpCurrent->flags & 0x00020000))
		{
		...
		else if ((bs->wpTravelTime - level.time) < 7000 && (bs->wpCurrent->flags & 0x00040000))
		{
			if ((level.time - bs->jumpTime) > 200)
			{
		...
		else if (bs->wpCurrent->index > 0)
		{
			...
			{
				if ((gWPArray[bs->wpCurrent->index-1]->flags & 0x00020000) ||
					(gWPArray[bs->wpCurrent->index-1]->flags & 0x00040000))
				{
					if ((level.time - bs->jumpTime) > 200)
					{
	...
	if (bs->timeToReact < level.time && bs->currentEnemy && bs->enemySeenTime > level.time + (20000 - (20000*0.2)))
	{
		if (bs->frame_Enemy_Vis)
		{
		...
		if (bs->currentEnemy->client)
		{
			((headlevel)[0]=(bs->currentEnemy->client->ps.origin)[0],(headlevel)[1]=(bs->currentEnemy->client->ps.origin)[1],(headlevel)[2]=(bs->currentEnemy->client->ps.origin)[2]);
		...
		if (!bs->frame_Enemy_Vis)
		{
			...
			{
				((headlevel)[0]=(bs->lastEnemySpotted)[0],(headlevel)[1]=(bs->lastEnemySpotted)[1],(headlevel)[2]=(bs->lastEnemySpotted)[2]);
				((a)[0]=(headlevel)[0]-(bs->eye)[0],(a)[1]=(headlevel)[1]-(bs->eye)[1],(a)[2]=(headlevel)[2]-(bs->eye)[2]);
				vectoangles(a, ang);
				((bs->goalAngles)[0]=(ang)[0],(bs->goalAngles)[1]=(ang)[1],(bs->goalAngles)[2]=(ang)[2]);
					...
					bs->currentEnemy && bs->currentEnemy->client)
				{
					...
					{
						((a)[0]=(bs->currentEnemy->client->ps.origin)[0]-(bs->lastEnemySpotted)[0],(a)[1]=(bs->currentEnemy->client->ps.origin)[1]-(bs->lastEnemySpotted)[1],(a)[2]=(bs->currentEnemy->client->ps.origin)[2]-(bs->lastEnemySpotted)[2]);
	...
	if (bs->currentEnemy)
	{
		if (BotGetWeaponRange(bs) == 4)
		{
			...
			{ 
				...
				bs->saberPowerTime = level.time + Q_irand(2000, 10000);
			}
			...
			if (bs->frame_Enemy_Len <= saberRange)
			{
				...
				bs->frame_Enemy_Len < 1200 &&
				bs->cur_ps.fd.saberAnimLevel != SS_STAFF)
			{
				bs->doAltAttack = 1;
				bs->doAttack = 0;
			}
			else if (bs->cur_ps.saberInFlight && bs->frame_Enemy_Len > 300 && bs->frame_Enemy_Len < 1200)
			{
				bs->doAltAttack = 1;
				bs->doAttack = 0;
			}
	...
	{
		((noz_x)[0]=(bs->origin)[0],(noz_x)[1]=(bs->origin)[1],(noz_x)[2]=(bs->origin)[2]);
		((noz_y)[0]=(bs->goalPosition)[0],(noz_y)[1]=(bs->goalPosition)[1],(noz_y)[2]=(bs->goalPosition)[2]);

		noz_x[2] = noz_y[2];

		((noz_x)[0]=(noz_x)[0]-(noz_y)[0],(noz_x)[1]=(noz_x)[1]-(noz_y)[1],(noz_x)[2]=(noz_x)[2]-(noz_y)[2]);

		if (VectorLength(noz_x) < 320) 
		{
			fjHalt = 1;
		}
	}
		...
		bs->shootGoal->health > 0 && bs->shootGoal->takedamage)
	{
		...
		{ 
			((a)[0]=(dif)[0]-(bs->eye)[0],(a)[1]=(dif)[1]-(bs->eye)[1],(a)[2]=(dif)[2]-(bs->eye)[2]);
			vectoangles(a, a);
			((bs->goalAngles)[0]=(a)[0],(bs->goalAngles)[1]=(a)[1],(bs->goalAngles)[2]=(a)[2]);

			if (InFieldOfVision(bs->viewangles, 30, a) &&
				EntityVisibleBox(bs->origin, ((void *)0), ((void *)0), dif, bs->client, bs->shootGoal->s.number))
			{
				bs->doAttack = 1;
			}
		}
	...
	{
		((a)[0]=(bs->origin)[0]-(bs->hereWhenSpotted)[0],(a)[1]=(bs->origin)[1]-(bs->hereWhenSpotted)[1],(a)[2]=(bs->origin)[2]-(bs->hereWhenSpotted)[2]);

		if (bs->plantDecided > level.time || (bs->frame_Enemy_Len < 256*2 && VectorLength(a) < 256))
		{
	...
	if (g_gametype.integer == GT_JEDIMASTER && !bs->cur_ps.isJediMaster && bs->jmState == -1 && gJMSaberEnt && gJMSaberEnt->inuse)
	{
		...
		((saberLen)[0]=(bs->origin)[0]-(gJMSaberEnt->r.currentOrigin)[0],(saberLen)[1]=(bs->origin)[1]-(gJMSaberEnt->r.currentOrigin)[1],(saberLen)[2]=(bs->origin)[2]-(gJMSaberEnt->r.currentOrigin)[2]);
		...
		if (fSaberLen < 256)
		{
			...
			{
				((bs->goalPosition)[0]=(gJMSaberEnt->r.currentOrigin)[0],(bs->goalPosition)[1]=(gJMSaberEnt->r.currentOrigin)[1],(bs->goalPosition)[2]=(gJMSaberEnt->r.currentOrigin)[2]);
			}
		}
	}
	...
	{
		((bs->goalMovedir)[0]=(bs->goalPosition)[0]-(bs->origin)[0],(bs->goalMovedir)[1]=(bs->goalPosition)[1]-(bs->origin)[1],(bs->goalMovedir)[2]=(bs->goalPosition)[2]-(bs->origin)[2]);
...
#line 7530 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
	}
	...
	if (bs->jumpTime > level.time && bs->jDelay < level.time)
	{
		if (bs->jumpHoldTime > level.time)
		{
			...
			if (g_entities[bs->client].client->ps.groundEntityNum == ((1<<10)-1))
			{
				g_entities[bs->client].client->ps.pm_flags |= 2;
			}
		}
		else if (!(bs->cur_ps.pm_flags & 2))
		{
			trap_EA_Jump(bs->client);
		}
	}
	...
	if ( bs->dangerousObject && bs->dangerousObject->inuse && bs->dangerousObject->health > 0 &&
		...
		(BotGetWeaponRange(bs) == 2 || BotGetWeaponRange(bs) == 3) &&
		bs->cur_ps.weapon != WP_DET_PACK && bs->cur_ps.weapon != WP_TRIP_MINE &&
		!bs->shootGoal )
	{
		float danLen;

		((a)[0]=(bs->dangerousObject->r.currentOrigin)[0]-(bs->eye)[0],(a)[1]=(bs->dangerousObject->r.currentOrigin)[1]-(bs->eye)[1],(a)[2]=(bs->dangerousObject->r.currentOrigin)[2]-(bs->eye)[2]);
		...
		if (danLen > 256)
		{
			...
			if (Q_irand(1, 10) < 5)
			{
				bs->goalAngles[1] += Q_irand(0, 3);
				bs->goalAngles[0] += Q_irand(0, 3);
			}
			else
			{
				bs->goalAngles[1] -= Q_irand(0, 3);
			...
			if (InFieldOfVision(bs->viewangles, 30, a) &&
				EntityVisibleBox(bs->origin, ((void *)0), ((void *)0), bs->dangerousObject->r.currentOrigin, bs->client, bs->dangerousObject->s.number))
			{
				bs->doAttack = 1;
			}			
		}
...
#line 7781 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
	...
	if (elapsed_time > 0) thinktime = elapsed_time;
	else thinktime = 0;
...
int BotAISetup( int restart ) {
	...
	trap_Cvar_Register(&bot_forcepowers, "bot_forcepowers", "1", 0x00000200);
	trap_Cvar_Register(&bot_forgimmick, "bot_forgimmick", "0", 0x00000200);
	trap_Cvar_Register(&bot_honorableduelacceptance, "bot_honorableduelacceptance", "0", 0x00000200);
	trap_Cvar_Register(&bot_pvstype, "bot_pvstype", "1", 0x00000200);

	trap_Cvar_Register(&bot_getinthecarrr, "bot_getinthecarrr", "0", 0);
#line 7856 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"


	trap_Cvar_Register(&bot_nogoals, "bot_nogoals", "0", 0x00000200);
	trap_Cvar_Register(&bot_debugmessages, "bot_debugmessages", "0", 0x00000200);
#line 7861 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_main.c"
	...
	trap_Cvar_Register(&bot_wp_edit, "bot_wp_edit", "0", 0x00000200);
