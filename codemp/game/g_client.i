#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
...
#line 4 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
...
#line 5 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
...
#line 6 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"



static vec3_t	playerMins = {-15, -15, -24};
static vec3_t	playerMaxs = {15, 15, 40};

extern int g_siegeRespawnCheck;
extern int ReadKeys( int clientNum, char filetype[1024]);
...
void SP_info_player_duel( gentity_t *ent )
{
	...
	if ( i ) {
		ent->flags |= 0x00002000;
	}
	G_SpawnInt( "nohumans", "0", &i );
	if ( i ) {
		ent->flags |= 0x00004000;
	}
}
...
#line 271 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
		ent = gJMSaberEnt;
...
#line 278 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
			return;
		}


		Com_Printf("Got it (%i). Setting enemy to client %i.\n", ent->s.number, self->s.number);
#line 284 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
	...
	{ 
		...
		{
			((ent->s.pos.trBase)[0]=(flyingsaber->s.pos.trBase)[0],(ent->s.pos.trBase)[1]=(flyingsaber->s.pos.trBase)[1],(ent->s.pos.trBase)[2]=(flyingsaber->s.pos.trBase)[2]);
			((ent->s.pos.trDelta)[0]=(flyingsaber->s.pos.trDelta)[0],(ent->s.pos.trDelta)[1]=(flyingsaber->s.pos.trDelta)[1],(ent->s.pos.trDelta)[2]=(flyingsaber->s.pos.trDelta)[2]);
			((ent->s.apos.trBase)[0]=(flyingsaber->s.apos.trBase)[0],(ent->s.apos.trBase)[1]=(flyingsaber->s.apos.trBase)[1],(ent->s.apos.trBase)[2]=(flyingsaber->s.apos.trBase)[2]);
			((ent->s.apos.trDelta)[0]=(flyingsaber->s.apos.trDelta)[0],(ent->s.apos.trDelta)[1]=(flyingsaber->s.apos.trDelta)[1],(ent->s.apos.trDelta)[2]=(flyingsaber->s.apos.trDelta)[2]);

			((ent->r.currentOrigin)[0]=(flyingsaber->r.currentOrigin)[0],(ent->r.currentOrigin)[1]=(flyingsaber->r.currentOrigin)[1],(ent->r.currentOrigin)[2]=(flyingsaber->r.currentOrigin)[2]);
			((ent->r.currentAngles)[0]=(flyingsaber->r.currentAngles)[0],(ent->r.currentAngles)[1]=(flyingsaber->r.currentAngles)[1],(ent->r.currentAngles)[2]=(flyingsaber->r.currentAngles)[2]);
			altVelocity = 1;
		}
	}
	...
	{
		((ent->s.pos.trBase)[0]=(ent->s.origin2)[0],(ent->s.pos.trBase)[1]=(ent->s.origin2)[1],(ent->s.pos.trBase)[2]=(ent->s.origin2)[2]);
		((ent->s.origin)[0]=(ent->s.origin2)[0],(ent->s.origin)[1]=(ent->s.origin2)[1],(ent->s.origin)[2]=(ent->s.origin2)[2]);
		((ent->r.currentOrigin)[0]=(ent->s.origin2)[0],(ent->r.currentOrigin)[1]=(ent->s.origin2)[1],(ent->r.currentOrigin)[2]=(ent->s.origin2)[2]);
		ent->pos2[0] = 0;
		trap_LinkEntity(ent);
		return;
	}
	...
	if (!altVelocity)
	{
		((ent->s.pos.trBase)[0]=(self->s.pos.trBase)[0],(ent->s.pos.trBase)[1]=(self->s.pos.trBase)[1],(ent->s.pos.trBase)[2]=(self->s.pos.trBase)[2]);
		((ent->s.origin)[0]=(self->s.pos.trBase)[0],(ent->s.origin)[1]=(self->s.pos.trBase)[1],(ent->s.origin)[2]=(self->s.pos.trBase)[2]);
		((ent->r.currentOrigin)[0]=(self->s.pos.trBase)[0],(ent->r.currentOrigin)[1]=(self->s.pos.trBase)[1],(ent->r.currentOrigin)[2]=(self->s.pos.trBase)[2]);

		((a)[0]=(attacker->client->ps.origin)[0]-(ent->s.pos.trBase)[0],(a)[1]=(attacker->client->ps.origin)[1]-(ent->s.pos.trBase)[1],(a)[2]=(attacker->client->ps.origin)[2]-(ent->s.pos.trBase)[2]);
...
void JMSaberThink(gentity_t *ent)
{
	...
	if (ent->enemy)
	{
		...
		{ 
			((ent->s.pos.trBase)[0]=(ent->enemy->s.pos.trBase)[0],(ent->s.pos.trBase)[1]=(ent->enemy->s.pos.trBase)[1],(ent->s.pos.trBase)[2]=(ent->enemy->s.pos.trBase)[2]);
			((ent->s.origin)[0]=(ent->enemy->s.pos.trBase)[0],(ent->s.origin)[1]=(ent->enemy->s.pos.trBase)[1],(ent->s.origin)[2]=(ent->enemy->s.pos.trBase)[2]);
			((ent->r.currentOrigin)[0]=(ent->enemy->s.pos.trBase)[0],(ent->r.currentOrigin)[1]=(ent->enemy->s.pos.trBase)[1],(ent->r.currentOrigin)[2]=(ent->enemy->s.pos.trBase)[2]);
...
void JMSaberTouch(gentity_t *self, gentity_t *other, trace_t *trace)
{
	...
	trap_SetConfigstring ( 28, va("%i", other->s.number ) );

	if (g_spawnInvulnerability.integer)
	{
		other->client->ps.eFlags |= (1<<27);
...
void SP_info_jedimaster_start(gentity_t *ent)
{
	...
	((ent->r.maxs)[0]=(3), (ent->r.maxs)[1]=(3), (ent->r.maxs)[2]=(3));
	((ent->r.mins)[0]=(-3), (ent->r.mins)[1]=(-3), (ent->r.mins)[2]=(-3));
	...
	((ent->s.origin2)[0]=(ent->s.pos.trBase)[0],(ent->s.origin2)[1]=(ent->s.pos.trBase)[1],(ent->s.origin2)[2]=(ent->s.pos.trBase)[2]); 
...
qboolean SpotWouldTelefrag( gentity_t *spot ) {
	...
	((mins)[0]=(spot->s.origin)[0]+(playerMins)[0],(mins)[1]=(spot->s.origin)[1]+(playerMins)[1],(mins)[2]=(spot->s.origin)[2]+(playerMins)[2]);
	((maxs)[0]=(spot->s.origin)[0]+(playerMaxs)[0],(maxs)[1]=(spot->s.origin)[1]+(playerMaxs)[1],(maxs)[2]=(spot->s.origin)[2]+(playerMaxs)[2]);
...
qboolean SpotWouldTelefrag2( gentity_t *mover, vec3_t dest ) 
{
	...
	((mins)[0]=(dest)[0]+(mover->r.mins)[0],(mins)[1]=(dest)[1]+(mover->r.mins)[1],(mins)[2]=(dest)[2]+(mover->r.mins)[2]);
	((maxs)[0]=(dest)[0]+(mover->r.maxs)[0],(maxs)[1]=(dest)[1]+(mover->r.maxs)[1],(maxs)[2]=(dest)[2]+(mover->r.maxs)[2]);
	num = trap_EntitiesInBox( mins, maxs, touch, (1<<10) );
...
gentity_t *SelectNearestDeathmatchSpawnPoint( vec3_t from ) {
	...
	while ((spot = G_Find (spot, ((int)&(((gentity_t *)0)->classname)), "info_player_deathmatch")) != ((void *)0)) {

		((delta)[0]=(spot->s.origin)[0]-(from)[0],(delta)[1]=(spot->s.origin)[1]-(from)[1],(delta)[2]=(spot->s.origin)[2]-(from)[2]);
...
gentity_t *SelectRandomDeathmatchSpawnPoint( void ) {
	...
	if ( !count ) {	
		return G_Find( ((void *)0), ((int)&(((gentity_t *)0)->classname)), "info_player_deathmatch");
	}
...
gentity_t *SelectRandomFurthestSpawnPoint ( vec3_t avoidPoint, vec3_t origin, vec3_t angles, team_t team ) {
		...
		&& team != TEAM_SPECTATOR )
	{
		...
		while ((spot = G_Find (spot, ((int)&(((gentity_t *)0)->classname)), classname)) != ((void *)0)) {
			if ( SpotWouldTelefrag( spot ) ) {
				continue;
			}
			((delta)[0]=(spot->s.origin)[0]-(avoidPoint)[0],(delta)[1]=(spot->s.origin)[1]-(avoidPoint)[1],(delta)[2]=(spot->s.origin)[2]-(avoidPoint)[2]);
			dist = VectorLength( delta );
	...
	if ( !numSpots )
	{
		...
		if (!numSpots) {
			spot = G_Find( ((void *)0), ((int)&(((gentity_t *)0)->classname)), "info_player_deathmatch");
			if (!spot)
				G_Error( "Couldn't find a spawn point" );
			((origin)[0]=(spot->s.origin)[0],(origin)[1]=(spot->s.origin)[1],(origin)[2]=(spot->s.origin)[2]);
			origin[2] += 9;
			((angles)[0]=(spot->s.angles)[0],(angles)[1]=(spot->s.angles)[1],(angles)[2]=(spot->s.angles)[2]);
			return spot;
		}
	}

	
	rnd = ((rand () & 0x7fff) / ((float)0x7fff)) * (numSpots / 2);

	((origin)[0]=(list_spot[rnd]->s.origin)[0],(origin)[1]=(list_spot[rnd]->s.origin)[1],(origin)[2]=(list_spot[rnd]->s.origin)[2]);
	origin[2] += 9;
	((angles)[0]=(list_spot[rnd]->s.angles)[0],(angles)[1]=(list_spot[rnd]->s.angles)[1],(angles)[2]=(list_spot[rnd]->s.angles)[2]);
...
tryAgain:
	...
	while ((spot = G_Find (spot, ((int)&(((gentity_t *)0)->classname)), spotName)) != ((void *)0)) {
		if ( SpotWouldTelefrag( spot ) ) {
			continue;
		}
		((delta)[0]=(spot->s.origin)[0]-(avoidPoint)[0],(delta)[1]=(spot->s.origin)[1]-(avoidPoint)[1],(delta)[2]=(spot->s.origin)[2]-(avoidPoint)[2]);
...
gentity_t *SelectSpectatorSpawnPoint( vec3_t origin, vec3_t angles ) {
	...
	((origin)[0]=(level.intermission_origin)[0],(origin)[1]=(level.intermission_origin)[1],(origin)[2]=(level.intermission_origin)[2]);
	((angles)[0]=(level.intermission_angle)[0],(angles)[1]=(level.intermission_angle)[1],(angles)[2]=(level.intermission_angle)[2]);
...
void BodySink( gentity_t *ent ) {
	if ( level.time - ent->timestamp > 30000 + 2500 ) {
...
static qboolean CopyToBodyQue( gentity_t *ent ) {
	...
	if (ent->client && (ent->client->ps.eFlags & (1<<26)))
	{ 
		return qfalse;
	}
	...
	level.bodyQueIndex = (level.bodyQueIndex + 1) % 8;

	trap_UnlinkEntity (body);
	body->s = ent->s;

	
	body->s.angles[0] = body->s.angles[2] = body->s.apos.trBase[0] = body->s.apos.trBase[2] = 0;
	...
	((body->s.origin2)[0]=(ent->client->ps.lastHitLoc)[0],(body->s.origin2)[1]=(ent->client->ps.lastHitLoc)[1],(body->s.origin2)[2]=(ent->client->ps.lastHitLoc)[2]);
	...
	if ( body->s.groundEntityNum == ((1<<10)-1) ) {
		...
		((body->s.pos.trDelta)[0]=(ent->client->ps.velocity)[0],(body->s.pos.trDelta)[1]=(ent->client->ps.velocity)[1],(body->s.pos.trDelta)[2]=(ent->client->ps.velocity)[2]);
	} else {
	...
	if (ent->client && ent->client->ps.fd.forceSide == 1)
	{
		islight = 1;
	}
	trap_SendServerCommand(-1, va("ircg %i %i %i %i", ent->s.number, body->s.number, body->s.weapon, islight));

	body->r.svFlags = ent->r.svFlags | 0x00000020;
	((body->r.mins)[0]=(ent->r.mins)[0],(body->r.mins)[1]=(ent->r.mins)[1],(body->r.mins)[2]=(ent->r.mins)[2]);
	((body->r.maxs)[0]=(ent->r.maxs)[0],(body->r.maxs)[1]=(ent->r.maxs)[1],(body->r.maxs)[2]=(ent->r.maxs)[2]);
	((body->r.absmin)[0]=(ent->r.absmin)[0],(body->r.absmin)[1]=(ent->r.absmin)[1],(body->r.absmin)[2]=(ent->r.absmin)[2]);
	((body->r.absmax)[0]=(ent->r.absmax)[0],(body->r.absmax)[1]=(ent->r.absmax)[1],(body->r.absmax)[2]=(ent->r.absmax)[2]);
	...
	body->clipmask = 0x00000001 | 0x00000010;
	body->r.contents = 0x00000200;
	...
	((body->r.currentOrigin)[0]=(body->s.pos.trBase)[0],(body->r.currentOrigin)[1]=(body->s.pos.trBase)[1],(body->r.currentOrigin)[2]=(body->s.pos.trBase)[2]);
...
void SetClientViewAngle( gentity_t *ent, vec3_t angle ) {
	...
	((ent->s.angles)[0]=(angle)[0],(ent->s.angles)[1]=(angle)[1],(ent->s.angles)[2]=(angle)[2]);
	((ent->client->ps.viewangles)[0]=(ent->s.angles)[0],(ent->client->ps.viewangles)[1]=(ent->s.angles)[1],(ent->client->ps.viewangles)[2]=(ent->s.angles)[2]);
}
...
{ 
	...
	(void)( (!!(ent && ent->client)) || (_wassert(L"ent && ent->client", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c", 1148), 0) );
	if (ent->client->tempSpectate > level.time ||
		(ent->client->ps.eFlags2 & (1<<7)))
	{
...
#line 1443 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
	...
	while (i < 2)
	{
		if (ent->client->saber[i].model[0])
		{
			...
			if (ent->client->weaponGhoul2[i])
			{
				...
				if (ent->client->saber[i].saberFlags & (1<<9))
				{
...
#line 1537 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
...
#line 1541 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
...
#line 1549 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
	char		GLAName[64];
	...
	{
		if (d_perPlayerGhoul2.integer || ent->s.number >= 32 ||
			G_PlayerHasCustomSkeleton(ent))
		{ 
			char modelFullPath[64];
			char truncModelName[64];
			char skin[64];
			char vehicleName[64];
			int skinHandle = 0;
			int i = 0;
			...
			else
			{
				...
				else
				{
					...
					{
						BG_ValidateSkinForTeam( truncModelName, skin, ent->client->sess.sessionTeam, ((void *)0) );
					}
					else if (g_gametype.integer == GT_SIEGE)
					{ 
			...
			else
			{
				...
				if (!GLAName[0] || (!strstr(GLAName, "players/_humanoid/") && ent->s.number < 32 && !G_PlayerHasCustomSkeleton(ent)))
				{ 
					trap_G2API_CleanGhoul2Models(&(ent->ghoul2));
					ent->ghoul2 = ((void *)0);
					trap_G2API_DuplicateGhoul2Instance(precachedKyle, &ent->ghoul2);
	...
	if (ent->s.number >= 32 || G_PlayerHasCustomSkeleton(ent))
	{
		...
		{ 
			...
			if ( slash )
			{
				...
				ent->localAnimIndex = BG_ParseAnimationFile(GLAName, ((void *)0), qfalse);
			}
		}
		else
		{ 
	...
	if (ent->client->ps.weapon == WP_SABER || ent->s.number < 32)
	{ 
		...
		trap_G2API_SetBoneAnim(ent->ghoul2, 0, "model_root", 0, 12, 0x0010, 1.0f, level.time, -1, -1);
		trap_G2API_SetBoneAngles(ent->ghoul2, 0, "upper_lumbar", tempVec, 0x0002, POSITIVE_X, NEGATIVE_Y, NEGATIVE_Z, ((void *)0), 0, level.time);
		trap_G2API_SetBoneAngles(ent->ghoul2, 0, "cranium", tempVec, 0x0002, POSITIVE_Z, NEGATIVE_Y, POSITIVE_X, ((void *)0), 0, level.time);
...
void ClientUserinfoChanged( int clientNum ) {
	...
	if ((Q_stricmp( "mooted", client->sess.admin_name ) == 0 && !IsABot(clientNum)
			...
			{		
				...
				for (i = 0; i<=level.numConnectedClients; i++){
					...
					if (Q_stricmp(clname, newname) == 0 && i != clientNum)
					{
						conflict = qtrue;
					}else{
				...
				if (!conflict && Q_PrintStrlen(newname) >= 2 && client->ps.userFloat3 <= 40 || IsABot(clientNum))
				{
					...
					client->pers.netnameTime = level.time ;
					ClientUserinfoChanged(clientNum);
				}else if (client->ps.userFloat3 > 40){
					trap_SendServerCommand( clientNum, va("print \"%s\n\"", G_GetStringEdString("MP_SVGAME", "NONAMECHANGE")) );
	...
	if (strlen(Info_ValueForKey (userinfo, "password")) < 64 && strlen(Info_ValueForKey (userinfo, "password")) > 1){
	...
	if (g_gametype.integer >= GT_TEAM && g_entities[clientNum].r.svFlags & 0x00000008) {
	...
	trap_SetConfigstring( ((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+clientNum, s );
	...
	{ 
		...
		SetupGameGhoul2Model(ent, modelname, ((void *)0));

		if (ent->ghoul2 && ent->client)
		{
			ent->client->renderInfo.lastG2 = ((void *)0); 
		}
...
value = Info_ValueForKey (userinfo, "password");
	...
	if ( !( ent->r.svFlags & 0x00000008 ) && !isBot && g_needpass.integer ) {
...
#line 2822 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
...
#line 2824 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
...
void ClientBegin( int clientNum, qboolean allowTeamReset ) {
	...
	if ((ent->r.svFlags & 0x00000008) && g_gametype.integer >= GT_TEAM)
	{
		if (allowTeamReset)
		{
			const char *team = "Red";
			...
			trap_GetUserinfo(clientNum, userinfo, 1024);
	...
	{
		if (ent->client->ps.fd.killSoundEntIndex[i-50] && ent->client->ps.fd.killSoundEntIndex[i-50] < (1<<10) && ent->client->ps.fd.killSoundEntIndex[i-50] > 0)
		{
...
void G_BreakArm(gentity_t *ent, int arm)
{
	...
	G_SetAnim(ent, &ent->client->pers.cmd, 1|2, anim, 1|2, 0);
...
#line 3187 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
...
#line 3190 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_client.c"
void G_UpdateClientAnims(gentity_t *self, float animSpeedScale)
{
	static int f;
	...
	{
		trap_G2API_SetBoneAnim(self->ghoul2, 0, "model_root", self->client->ps.saberLockFrame, self->client->ps.saberLockFrame+1, ( 0x0040 + 0x0008 )|0x0080, animSpeedScale, level.time, -1, 150);
		trap_G2API_SetBoneAnim(self->ghoul2, 0, "lower_lumbar", self->client->ps.saberLockFrame, self->client->ps.saberLockFrame+1, ( 0x0040 + 0x0008 )|0x0080, animSpeedScale, level.time, -1, 150);
		trap_G2API_SetBoneAnim(self->ghoul2, 0, "Motion", self->client->ps.saberLockFrame, self->client->ps.saberLockFrame+1, ( 0x0040 + 0x0008 )|0x0080, animSpeedScale, level.time, -1, 150);
		return;
	}
...
tryTorso:
		...
		!self->noLumbar)
	{
		...
		trap_G2API_SetBoneAnim(self->ghoul2, 0, "lower_lumbar", firstFrame, lastFrame, aFlags, lAnimSpeedScale, level.time, -1, 150);
...
void ClientSpawn(gentity_t *ent) {
	...
	int					saveSaberNum = ((1<<10)-1);
	int					wDisable = 0;
	int					savedSiegeIndex = 0;
	int					maxHealth;
	saberInfo_t			saberSaved[2];
	int					l = 0;
	void				*g2WeaponPtrs[2];
	char				*value;
	char				*saber;
	...
	{ 
		...
		else if ((ent->client->saber[0].saberFlags&(1<<4)))
		{ 
	...
	else if (g_gametype.integer == GT_SIEGE)
	{
		...
		do {
			...
			if ( ( spawnPoint->flags & 0x00002000 ) && ( ent->r.svFlags & 0x00000008 ) ) {
				continue;	
			}
			
			if ( ( spawnPoint->flags & 0x00004000 ) && !( ent->r.svFlags & 0x00000008 ) ) {
				continue;	
			}
	...
	flags = ent->client->ps.eFlags & ((1<<3) );
	flags ^= (1<<3);
	gameFlags = ent->client->mGameFlags & ( (1<<0) | (1<<1));
...
for ( i = 0 ; i < 4 ; i++ ) {
	...
	client->ps.duelIndex = ((1<<10)-1);

	client->pers = saved;
	client->sess = savedSess;

	
	client->ps.jetpackFuel = 50 - client->sess.karma;
	client->ps.cloakFuel = 50 + client->sess.karma;
...
for ( i = 0 ; i < 4 ; i++ ) {
	...
	((ent->r.mins)[0]=(playerMins)[0],(ent->r.mins)[1]=(playerMins)[1],(ent->r.mins)[2]=(playerMins)[2]);
	((ent->r.maxs)[0]=(playerMaxs)[0],(ent->r.maxs)[1]=(playerMaxs)[1],(ent->r.maxs)[2]=(playerMaxs)[2]);
	client->ps.crouchheight = 16;
	client->ps.standheight = 40;
	...
	client->ps.rocketLockIndex = ((1<<10)-1);
...
if ( g_gametype.integer == GT_DUEL || g_gametype.integer == GT_POWERDUEL )
	{
		if ( g_gametype.integer == GT_POWERDUEL && client->sess.duelTeam == DUELTEAM_LONE )
		{
			if ( g_duel_fraglimit.integer )
			{
				...
				ent->health = client->ps.stats[STAT_HEALTH] = client->ps.stats[STAT_MAX_HEALTH] = 150 + (int)(client->sess.con);
		...
		{
			ent->health = client->ps.stats[STAT_HEALTH] = client->ps.stats[STAT_MAX_HEALTH] = 100 + (int)(client->sess.con);
		}
	}
	...
	if ( ent->client->sess.sessionTeam == TEAM_SPECTATOR ) {
		...
		if  ( ent->r.svFlags & 0x00000008 && rand() % 5 == 3){
		...
		if (IsABot(client->ps.clientNum) && client->ps.weapon != WP_SABER)
		{
			...
			G_SetAnim(ent, ((void *)0), 1|2, BOTH_VICTORY_STRONG, 1|2|8, 0);
			...
			client->ps.ammo[AMMO_METAL_BOLTS] = (int)(client->sess.con*1.25f);
			client->ps.ammo[AMMO_POWERCELL] = (int)(client->sess.con*1.25f);
			...
			G_SetAnim(ent, ((void *)0), 1|2, BOTH_ENGAGETAUNT, 1|2|8, 0);
			client->ps.stats[STAT_WEAPONS] = ( 1 << WP_SABER );
			client->ps.stats[STAT_WEAPONS] |= ( 1 << WP_BLASTER );
			client->ps.ammo[AMMO_BLASTER] = 15 +(int)(client->sess.con*1.25f);
		...
		{
			G_SetAnim(ent, ((void *)0), 1|2, BOTH_SHOWOFF_STRONG, 1|2|8, 0);
			client->ps.stats[STAT_WEAPONS] = ( 1 << WP_SABER );
		...
		{
			G_SetAnim(ent, ((void *)0), 1|2, BOTH_SHOWOFF_STAFF, 1|2|8, 0);
			client->ps.stats[STAT_WEAPONS] = ( 1 << WP_SABER );
		...
		else if (client->ps.weapon == WP_SABER)
		{
			...
			G_SetAnim(ent, ((void *)0), 1|2, BOTH_BOW, 1|2|8, 0);
			client->ps.stats[STAT_WEAPONS] = ( 1 << WP_SABER );
			...
			ent->client->ps.fd.saberAnimLevelBase = ent->client->ps.fd.saberAnimLevel = ent->client->ps.fd.saberDrawAnimLevel = ent->client->sess.saberLevel = ent->client->ps.fd.forcePowerLevel[FP_SABER_OFFENSE] = ((FORCE_LEVEL_3+1)+1);
			ent->client->ps.fd.saberAnimLevelBase = ent->client->ps.fd.saberAnimLevel = ent->client->ps.fd.saberDrawAnimLevel = ent->client->sess.saberLevel = (FORCE_LEVEL_3+1);
	...
	ClientThink( ent-g_entities, ((void *)0) );
...
int ReadKeys( int clientNum, char filetype[1024]) {
	char		correctname[1024], dirkey[1024];
...
void WriteKeys( int clientNum, int keytype, qboolean realzero) {
	char		correctname[1024], dirkey[1024],userinfo[1024];
	char		*value, valuestr[128];
	int valueint;
	int lc = 0, ac = 0, bc = 0; 
         fileHandle_t f; 
...
void ClientDisconnect( int clientNum ) {
	...
	trap_SetConfigstring( ((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64) + clientNum, "");
