#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_arenas.c"
...
#line 8 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_arenas.c"
...
void UpdateTournamentInfo( void ) {
	...
	for (i = 0; i < level.maxclients; i++ ) {
		...
		if ( !( player->r.svFlags & 0x00000008 ) ) {
			break;
		}
	}
