#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
...
#line 5 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
...
#line 6 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"

extern void Jedi_Cloak( gentity_t *self );
extern void Jedi_Decloak( gentity_t *self );
extern void ShowRPGStats(int entNum, int clientNum);
extern void SetRPGStats(gentity_t *ent, int clientNum);
...
#line 13 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
...
#line 18 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
...
void P_DamageFeedback( gentity_t *player ) {
	...
	if ( client->damage_fromWorld ) {
		...
		client->ps.damagePitch = angles[0]/360.0 * 256;
		client->ps.damageYaw = angles[1]/360.0 * 256;
	...
	if ( (level.time > player->pain_debounce_time) && !(player->flags & 0x00000010) && !(player->s.eFlags & (1<<1)) ) {
		...
		{
			client->ps.damageType = 1; 
		}
		else if (client->damage_armor)
		{
			client->ps.damageType = 2; 
		}
		else
		{
			client->ps.damageType = 0; 
		}
	}
...
void P_WorldEffects( gentity_t *ent ) {
		...
		if ( ent->client->airOutTime < level.time) {
			...
			if ( ent->health > 0 ) {
				...
				G_Damage (ent, ((void *)0), ((void *)0), ((void *)0), ((void *)0), 
					ent->damage, 0x00000002, MOD_WATER);
			}
		}
	} else {
		ent->client->airOutTime = level.time + 12000;
	...
	if (waterlevel && 
		(ent->watertype&(0x00000002|0x00020000)) ) {
		if (ent->health > 0
			...
			if ( envirosuit ) {
				...
				if (ent->watertype & 0x00000002) {
					G_Damage (ent, ((void *)0), ((void *)0), ((void *)0), ((void *)0), 
						30*waterlevel, 0, MOD_LAVA);
				}

				if (ent->watertype & 0x00020000) {
					G_Damage (ent, ((void *)0), ((void *)0), ((void *)0), ((void *)0), 
...
void DoImpact( gentity_t *self, gentity_t *other, qboolean damageSelf )
{
	...
	if( self->client )
	{
		((velocity)[0]=(self->client->ps.velocity)[0],(velocity)[1]=(self->client->ps.velocity)[1],(velocity)[2]=(self->client->ps.velocity)[2]);
		if( !self->mass )
		{
			my_mass = 10;
		}
	...
	{
		((velocity)[0]=(self->s.pos.trDelta)[0],(velocity)[1]=(self->s.pos.trDelta)[1],(velocity)[2]=(self->s.pos.trDelta)[2]);
	...
	if ( other->material == MAT_GLASS 
		...
		|| ((other->flags&0x04000000)&&(other->spawnflags&8))
		|| (other->r.svFlags&0x08000000) )
	{
	...
	if ( !self->client || self->client->ps.lastOnGround+300<level.time || ( self->client->ps.lastOnGround+100 < level.time && easyBreakBrush ) )
	{
		...
		if ( magnitude >= 100 && other->s.number < ((1<<10)-2) )
		{
			((dir1)[0]=(velocity)[0],(dir1)[1]=(velocity)[1],(dir1)[2]=(velocity)[2]);
			...
			{
				((dir2)[0]=(other->r.currentOrigin)[0]-(self->r.currentOrigin)[0],(dir2)[1]=(other->r.currentOrigin)[1]-(self->r.currentOrigin)[1],(dir2)[2]=(other->r.currentOrigin)[2]-(self->r.currentOrigin)[2]);
			...
			if( ( force >= 1 && other->s.number != 0 ) || force >= 10)
			{
				...
				if ( other->r.svFlags & 0x08000000 )
				{
					other->splashRadius = (float)(self->r.maxs[0] - self->r.mins[0])/4.0f;
				}
				if ( other->takedamage )
				{
					G_Damage( other, self, self, velocity, self->r.currentOrigin, force, 0x00000002, MOD_CRUSH);
				}
				else
				{
		...
		if ( damageSelf && self->takedamage )
		{
			...
			if ( self->client && self->client->ps.fd.forceJumpZStart )
			{
				...
				{
					if ( (self->s.weapon == WP_SABER || self->s.number == 0) && self->client && self->client->ps.groundEntityNum < ((1<<10)-1) && magnitude < 1000 )
					{
					...
					if ( magnitude >= 1 )
					{
						...
						G_Damage( self, ((void *)0), ((void *)0), ((void *)0), self->r.currentOrigin, magnitude/2, 0x00000002, MOD_FALLING );
					}
				}
		}
...
void Client_CheckImpactBBrush( gentity_t *self, gentity_t *other )
{
	...
	if ( other->material == MAT_GLASS 
		...
		|| other->material == MAT_GRATE1
		|| ((other->flags&0x04000000)&&(other->spawnflags&8))
		|| ((other->flags&0x04000000)&&(other->health<=10))
		|| (other->r.svFlags&0x08000000) )
	{
...
void G_SetClientSound( gentity_t *ent ) {
	...
	else if (ent->waterlevel && (ent->watertype&(0x00000002|0x00020000)) ) {
...
void ClientImpacts( gentity_t *ent, pmove_t *pm ) {
	...
	for (i=0 ; i<pm->numtouch ; i++) {
		...
		if ( ( ent->r.svFlags & 0x00000008 ) && ( ent->touch ) ) {
...
void	G_TouchTriggers( gentity_t *ent ) {
	...
	((mins)[0]=(ent->client->ps.origin)[0]-(range)[0],(mins)[1]=(ent->client->ps.origin)[1]-(range)[1],(mins)[2]=(ent->client->ps.origin)[2]-(range)[2]);
	((maxs)[0]=(ent->client->ps.origin)[0]+(range)[0],(maxs)[1]=(ent->client->ps.origin)[1]+(range)[1],(maxs)[2]=(ent->client->ps.origin)[2]+(range)[2]);

	num = trap_EntitiesInBox( mins, maxs, touch, (1<<10) );

	
	((mins)[0]=(ent->client->ps.origin)[0]+(ent->r.mins)[0],(mins)[1]=(ent->client->ps.origin)[1]+(ent->r.mins)[1],(mins)[2]=(ent->client->ps.origin)[2]+(ent->r.mins)[2]);
	((maxs)[0]=(ent->client->ps.origin)[0]+(ent->r.maxs)[0],(maxs)[1]=(ent->client->ps.origin)[1]+(ent->r.maxs)[1],(maxs)[2]=(ent->client->ps.origin)[2]+(ent->r.maxs)[2]);
...
void G_MoverTouchPushTriggers( gentity_t *ent, vec3_t oldOrg ) 
{
	...
	((size)[0]=(ent->r.mins)[0]-(ent->r.maxs)[0],(size)[1]=(ent->r.mins)[1]-(ent->r.maxs)[1],(size)[2]=(ent->r.mins)[2]-(ent->r.maxs)[2]);
	...
	((dir)[0]=(ent->r.currentOrigin)[0]-(oldOrg)[0],(dir)[1]=(ent->r.currentOrigin)[1]-(oldOrg)[1],(dir)[2]=(ent->r.currentOrigin)[2]-(oldOrg)[2]);
	dist = VectorNormalize( dir );
	for ( step = 0; step <= dist; step += stepSize )
	{
		((checkSpot)[0]=(ent->r.currentOrigin)[0]+(dir)[0]*(step),(checkSpot)[1]=(ent->r.currentOrigin)[1]+(dir)[1]*(step),(checkSpot)[2]=(ent->r.currentOrigin)[2]+(dir)[2]*(step));
		((mins)[0]=(checkSpot)[0]-(range)[0],(mins)[1]=(checkSpot)[1]-(range)[1],(mins)[2]=(checkSpot)[2]-(range)[2]);
		((maxs)[0]=(checkSpot)[0]+(range)[0],(maxs)[1]=(checkSpot)[1]+(range)[1],(maxs)[2]=(checkSpot)[2]+(range)[2]);

		num = trap_EntitiesInBox( mins, maxs, touch, (1<<10) );

		
		((mins)[0]=(checkSpot)[0]+(ent->r.mins)[0],(mins)[1]=(checkSpot)[1]+(ent->r.mins)[1],(mins)[2]=(checkSpot)[2]+(ent->r.mins)[2]);
		((maxs)[0]=(checkSpot)[0]+(ent->r.maxs)[0],(maxs)[1]=(checkSpot)[1]+(ent->r.maxs)[1],(maxs)[2]=(checkSpot)[2]+(ent->r.maxs)[2]);
...
void SpectatorThink( gentity_t *ent, usercmd_t *ucmd ) {
	...
	if ( client->sess.spectatorState != SPECTATOR_FOLLOW ) {
		...
		pm.ps = &client->ps;
		pm.cmd = *ucmd;
		pm.tracemask = (0x00000001|0x00000010|0x00000100|0x00001000) & ~0x00000100;	
		pm.trace = trap_Trace;
		pm.pointcontents = trap_PointContents;

		pm.noSpecMove = g_noSpecMove.integer;

		pm.animations = ((void *)0);
		...
		((ent->s.origin)[0]=(client->ps.origin)[0],(ent->s.origin)[1]=(client->ps.origin)[1],(ent->s.origin)[2]=(client->ps.origin)[2]);
	...
	if (client->tempSpectate < level.time)
	{
		...
		if ( ( client->buttons & 1 ) && ! ( client->oldbuttons & 1 ) ) {
...
void ClientIntermissionThink( gclient_t *client ) {
	client->ps.eFlags &= ~(1<<13);
	client->ps.eFlags &= ~(1<<9);
	...
	if ( client->buttons & ( 1 | 4 ) & ( client->oldbuttons ^ client->buttons ) ) {
...
{
	if ( vehEnt && vehEnt->m_pVehicle && vehEnt->m_pVehicle->m_pDroidUnit != ((void *)0) )
	{
		...
		if ( droidEnt->client )
		{
			((droidEnt->client->ps.viewangles)[0]=(droidEnt->r.currentAngles)[0],(droidEnt->client->ps.viewangles)[1]=(droidEnt->r.currentAngles)[1],(droidEnt->client->ps.viewangles)[2]=(droidEnt->r.currentAngles)[2]);
			((droidEnt->client->ps.origin)[0]=(droidEnt->r.currentOrigin)[0],(droidEnt->client->ps.origin)[1]=(droidEnt->r.currentOrigin)[1],(droidEnt->client->ps.origin)[2]=(droidEnt->r.currentOrigin)[2]);
		}
		...
		if ( droidEnt->NPC )
		{
			NPC_SetAnim( droidEnt, 1|2, BOTH_STAND2, 1|2 );
		}
	}
}
...
#line 909 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
...
#line 911 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
...
void ClientEvents( gentity_t *ent, int oldEventSequence ) {
	...
	for ( i = oldEventSequence ; i < client->ps.eventSequence ; i++ ) {
		event = client->ps.events[ i & (2-1) ];

		switch ( event ) {
		case EV_FALL:
		case EV_ROLL:
			{
				int delta = client->ps.eventParms[ i & (2-1) ];
				...
				ent->pain_debounce_time = level.time + 200;	
				G_Damage (ent, ((void *)0), ((void *)0), ((void *)0), ((void *)0), damage, 0x00000002, MOD_FALLING);
...
static void G_UpdateForceSightBroadcasts ( gentity_t *self )
{
	...
	for ( i = 0; i < level.numConnectedClients; i ++ )
	{
		...
		((angles)[0]=(self->client->ps.origin)[0]-(ent->client->ps.origin)[0],(angles)[1]=(self->client->ps.origin)[1]-(ent->client->ps.origin)[1],(angles)[2]=(self->client->ps.origin)[2]-(ent->client->ps.origin)[2]);
		...
		if ( !InFieldOfVision ( ent->client->ps.viewangles, 135, angles ) )
		{
			break;
		}
...
void G_AddPushVecToUcmd( gentity_t *self, usercmd_t *ucmd )
{
	...
	AngleVectors(self->client->ps.viewangles, forward, right, ((void *)0));
	((moveDir)[0]=(forward)[0]*(ucmd->forwardmove/127.0f * self->client->ps.speed),(moveDir)[1]=(forward)[1]*(ucmd->forwardmove/127.0f * self->client->ps.speed),(moveDir)[2]=(forward)[2]*(ucmd->forwardmove/127.0f * self->client->ps.speed));
	((moveDir)[0]=(moveDir)[0]+(right)[0]*(ucmd->rightmove/127.0f * self->client->ps.speed),(moveDir)[1]=(moveDir)[1]+(right)[1]*(ucmd->rightmove/127.0f * self->client->ps.speed),(moveDir)[2]=(moveDir)[2]+(right)[2]*(ucmd->rightmove/127.0f * self->client->ps.speed));
	

	((moveDir)[0]=(moveDir)[0]+(self->client->pushVec)[0],(moveDir)[1]=(moveDir)[1]+(self->client->pushVec)[1],(moveDir)[2]=(moveDir)[2]+(self->client->pushVec)[2]);
	self->client->ps.speed = VectorNormalize(moveDir);
	

	fMove = 127.0 * ((forward)[0]*(moveDir)[0]+(forward)[1]*(moveDir)[1]+(forward)[2]*(moveDir)[2]);
	rMove = 127.0 * ((right)[0]*(moveDir)[0]+(right)[1]*(moveDir)[1]+(right)[2]*(moveDir)[2]);
	ucmd->forwardmove = floor(fMove);
	ucmd->rightmove = floor(rMove);

	if ( self->client->pushVecTime < level.time )
	{
		((self->client->pushVec)[0]=(self->client->pushVec)[1]=(self->client->pushVec)[2]=0);
	}
}
...
void G_CheckClientIdle( gentity_t *ent, usercmd_t *ucmd ) 
{
	...
	if ( !ent || !ent->client || ent->health <= 0 || ent->client->ps.stats[STAT_HEALTH] <= 0 ||
		ent->client->sess.sessionTeam == TEAM_SPECTATOR || (ent->client->ps.pm_flags & 4096))
	{
		return;
	}
	...
	if (ent->r.svFlags & 0x00000008)
	{ 
		buttons &= ~32;
	}
	actionPressed = G_ActionButtonPressed(buttons);

	((viewChange)[0]=(ent->client->ps.viewangles)[0]-(ent->client->idleViewAngles)[0],(viewChange)[1]=(ent->client->ps.viewangles)[1]-(ent->client->idleViewAngles)[1],(viewChange)[2]=(ent->client->ps.viewangles)[2]-(ent->client->idleViewAngles)[2]);
		...
		|| (ent->client->ps.weapon != ent->client->pers.cmd.weapon && ent->s.eType != ET_NPC))
	{
		...
		((ent->client->idleViewAngles)[0]=(ent->client->ps.viewangles)[0],(ent->client->idleViewAngles)[1]=(ent->client->ps.viewangles)[1],(ent->client->idleViewAngles)[2]=(ent->client->ps.viewangles)[2]);
	...
	else if ( level.time - ent->client->idleTime > 5000 )
	{
		...
		{
			G_SetAnim(ent, ucmd, 1|2, idleAnim, 1|2, 0);
...
static int NPC_GetWalkSpeed( gentity_t *ent )
{
	...
	if ( ( ent->client == ((void *)0) ) || ( ent->NPC == ((void *)0) ) )
		return 0;
...
static int NPC_GetRunSpeed( gentity_t *ent )
{
	...
	default:
		runSpeed = ent->NPC->stats.runSpeed*1.3f; 
		break;
	}
...
void G_CheckMovingLoopingSounds( gentity_t *ent, usercmd_t *ucmd )
{
	if ( ent->client )
	{
		if ( (ent->NPC&&!VectorCompare( vec3_origin, ent->client->ps.moveDir ))
			|| ucmd->forwardmove || ucmd->rightmove
			|| (ucmd->upmove&&FlyingCreature( ent ))
		...
		if ( monster && monster->client )
		{
			...
			if ( monster->s.NPC_class == CLASS_RANCOR )
			{
				BG_AttachToRancor( monster->ghoul2, 
					monster->r.currentAngles[1],
					monster->r.currentOrigin,
					level.time,
					((void *)0),
					monster->modelScale,
					(monster->client->ps.eFlags2&(1<<3)),
...
void G_SetTauntAnim( gentity_t *ent, int taunt )
{
		...
		&& ent->client->ps.saberLockTime < level.time )
	{
		...
		if ( anim != -1 )
		{
			if ( ent->client->ps.groundEntityNum != ((1<<10)-1) ) 
			{
...
void ClientThink_real( gentity_t *ent ) {
	...
	if (rand()%100 >= 66){
		if (ent->client && ent->chain && ent->chain->s.pos.trBase && ent->chain->r.svFlags & 0x00001000){
			...
			if (ent->client->sess.dex){
			
			
				ent->client->ps.userFloat1+=(ent->client->sess.dex*1.2f);
				
				((ent->chain->s.pos.trDelta)[0]=(ent->client->renderInfo.muzzleDir)[0]*(100+ent->client->ps.userFloat1),(ent->chain->s.pos.trDelta)[1]=(ent->client->renderInfo.muzzleDir)[1]*(100+ent->client->ps.userFloat1),(ent->chain->s.pos.trDelta)[2]=(ent->client->renderInfo.muzzleDir)[2]*(100+ent->client->ps.userFloat1));
			...
			if (ent->health <= 0 &&
				(!Q_stricmp(ent->NPC_type,"rancor")
				|| !Q_stricmp(ent->NPC_type,"mutant_rancor")
				|| !Q_stricmp(ent->NPC_type,"atst_vehicle")
				|| !Q_stricmp(ent->NPC_type,"atst")
				|| !Q_stricmp(ent->NPC_type,"wampa")
				|| !Q_stricmp(ent->NPC_type,"sand_creature")
				|| !Q_stricmp(ent->NPC_type,"howler")
				|| !Q_stricmp(ent->NPC_type,"hazardtrooper")
				))
			{
	...
	if ( ent->s.number < 32 && ent->client->ps.m_iVehicleNum )
	{
		if (g_entities[ent->client->ps.m_iVehicleNum].client)
		{
			...
			{ 
				...
				if ( veh->m_pVehicle->m_ucmd.buttons & 2 )
				{ 
					veh->m_pVehicle->m_ucmd.buttons = 2;
...
if (client->saber[0].model[0] && client->saber[1].model[0])
		{ 
			if ( client->ps.saberHolstered == 1 )
			{
				...
				client->ps.fd.saberAnimLevel = SS_DESANN;
	...
	if ( client && (client->ps.eFlags2&(1<<0)) )
	{
		G_HeldByMonster( ent, &ucmd );
	}

	
	if ( ucmd->serverTime > level.time + 250 ) {
		ucmd->serverTime = level.time + 250;
	...
	if ( pmove_msec.integer < 5 ) {
		trap_Cvar_Set("pmove_msec", "5");
	}
	...
	if (ent && ent->client && (ent->client->ps.eFlags & (1<<27)))
	{
	...
	{
		client->ps.eFlags &= ~(1<<11);
		client->ps.eFlags &= ~(1<<30);
	}




	if (client->bodyGrabIndex != ((1<<10)-1))
	{
		gentity_t *grabbed = &g_entities[client->bodyGrabIndex];

		if (!grabbed->inuse || grabbed->s.eType != ET_BODY ||
			(grabbed->s.eFlags & (1<<26)) ||
			(grabbed->s.eFlags & (1<<8)))
		{
			if (grabbed->inuse && grabbed->s.eType == ET_BODY)
			{
				grabbed->s.ragAttach = 0;
			}
			client->bodyGrabIndex = ((1<<10)-1);
		}
		else
		{
			mdxaBone_t rhMat;
			...
			((tAng)[0]=(0), (tAng)[1]=(ent->client->ps.viewangles[1]), (tAng)[2]=(0));
			trap_G2API_GetBoltMatrix(ent->ghoul2, 0, 0, &rhMat, tAng, ent->client->ps.origin, level.time,
				((void *)0), ent->modelScale); 
			BG_GiveMeVectorFromMatrix(&rhMat, ORIGIN, rhOrg);

			((bodyDir)[0]=(rhOrg)[0]-(grabbed->r.currentOrigin)[0],(bodyDir)[1]=(rhOrg)[1]-(grabbed->r.currentOrigin)[1],(bodyDir)[2]=(rhOrg)[2]-(grabbed->r.currentOrigin)[2]);
			...
			else if (bodyDist > 24.0f)
			{
				...
				((grabbed->epVelocity)[0]=(grabbed->epVelocity)[0]+(bodyDir)[0],(grabbed->epVelocity)[1]=(grabbed->epVelocity)[1]+(bodyDir)[1],(grabbed->epVelocity)[2]=(grabbed->epVelocity)[2]+(bodyDir)[2]);
	...
	if (ent->NPC && ent->s.NPC_class != CLASS_VEHICLE) 
	{
		...
		if ( ent->NPC->combatMove == qfalse )
		{
			...
			if (1)
			{
				qboolean Flying = (ucmd->upmove && (ent->client->ps.eFlags2&(1<<4)));
				qboolean Climbing = (ucmd->upmove && ent->watertype&0x00002000 );
				...
				if ( ucmd->forwardmove || ucmd->rightmove || Flying )
				{
					
					{
						...
						if ( ent->NPC->currentSpeed >= 80 && !controlledByPlayer )
						{
							...
							if ( ent->NPC->distToGoal < 128.0f && !(ent->NPC->aiFlags&0x00001000) )
							{
								if ( ent->NPC->desiredSpeed > 16.0f )
								{
									float slowdownSpeed = ((float)ent->NPC->desiredSpeed) * ent->NPC->distToGoal / 128.0f;

									ent->NPC->desiredSpeed = ceil(slowdownSpeed);
									if ( ent->NPC->desiredSpeed < 16.0f )
									{
										ent->NPC->desiredSpeed = 16.0f;
									}
								}
							}
						}
				...
				{
					client->ps.speed = ent->NPC->currentSpeed = 0;
					ucmd->forwardmove = 0;
					ucmd->rightmove = 0;
				}
				else
				{
					...
					if (1)
					{
						...
						if (0) 
						{	
							turndelta = (180 - fabs( AngleDelta( ent->r.currentAngles[1], ent->NPC->lockedDesiredYaw ) ))/180;
						}
						else
						{
							turndelta = (180 - fabs( AngleDelta( ent->r.currentAngles[1], ent->NPC->desiredYaw ) ))/180;
						}
		...
		{	
			ent->NPC->desiredSpeed = ( ucmd->buttons & 16 ) ? NPC_GetWalkSpeed( ent ) : NPC_GetRunSpeed( ent );
		...
		(!ent->NPC || ent->s.NPC_class != CLASS_VEHICLE)) 
	{
		...
		if (client->bodyGrabIndex != ((1<<10)-1))
		{ 
			client->ps.speed *= 0.33f;
		}

		client->ps.basespeed = client->ps.speed;
	}

	if ( !ent->NPC || !(ent->NPC->aiFlags&0x00200000) )
	{
		if (ent->NPC && ent->s.NPC_class == CLASS_VEHICLE &&
		...
		{
			if (ent->client->inSpaceIndex && ent->client->inSpaceIndex != ((1<<10)-1))
			{ 
				client->ps.gravity = 1.0f;
				if (ent->s.number < 32)
				{
					((client->ps.velocity)[0]=(client->ps.velocity)[0]*(0.8f),(client->ps.velocity)[1]=(client->ps.velocity)[1]*(0.8f),(client->ps.velocity)[2]=(client->ps.velocity)[2]*(0.8f));
				}
			}
			else
			{
				if (client->ps.eFlags2 & (1<<7))
				{ 
					((client->ps.velocity)[0]=(client->ps.velocity)[1]=(client->ps.velocity)[2]=0);
					client->ps.gravity = 1.0f;
				}
				else
				{
	...
	if (ent->client->ps.duelInProgress)
	{
			...
			duelAgainst->client->ps.duelIndex != ent->s.number)
		{
			...
			|| duelAgainst->client->iAmALoser 
			|| duelAgainst->client->ps.fallingToDeath
			...
			)
		{
			...
			if (ent->health > 0 && ent->client->ps.stats[STAT_HEALTH] > 0)
			{
				...
				G_Damage(duelAgainst,ent,ent,((void *)0),ent->client->ps.origin,9999,0x00000008,MOD_UNKNOWN);
		...
		else
		{
			...
			((vSub)[0]=(ent->client->ps.origin)[0]-(duelAgainst->client->ps.origin)[0],(vSub)[1]=(ent->client->ps.origin)[1]-(duelAgainst->client->ps.origin)[1],(vSub)[2]=(ent->client->ps.origin)[2]-(duelAgainst->client->ps.origin)[2]);
	...
	if (ent->client->doingThrow > level.time)
	{
		...
		if (!throwee->inuse || !throwee->client || throwee->health < 1 ||
			...
			(throwee->client->ps.pm_flags & 4096) ||
	...
	if (ent->client->beingThrown > level.time)
	{
		...
		if (!thrower->inuse || !thrower->client || thrower->health < 1 ||
			...
			(thrower->client->ps.pm_flags & 4096) ||
...
#line 2731 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
			{
				float pDif = 40.0f;
				...
				((entDir)[0]=(thrower->client->ps.origin)[0]-(ent->client->ps.origin)[0],(entDir)[1]=(thrower->client->ps.origin)[1]-(ent->client->ps.origin)[1],(entDir)[2]=(thrower->client->ps.origin)[2]-(ent->client->ps.origin)[2]);
				((otherAngles)[0]=(ent->client->ps.viewangles)[0],(otherAngles)[1]=(ent->client->ps.viewangles)[1],(otherAngles)[2]=(ent->client->ps.viewangles)[2]);
				otherAngles[1] = vectoyaw( entDir );
				SetClientViewAngle( ent, otherAngles );

				((tAngles)[0]=(thrower->client->ps.viewangles)[0],(tAngles)[1]=(thrower->client->ps.viewangles)[1],(tAngles)[2]=(thrower->client->ps.viewangles)[2]);
...
#line 2762 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
				((pBoltOrg)[0]=(thrower->client->ps.origin)[0],(pBoltOrg)[1]=(thrower->client->ps.origin)[1],(pBoltOrg)[2]=(thrower->client->ps.origin)[2]);
...
#line 2768 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
				

				((vDif)[0]=(ent->client->ps.origin)[0]-(boltOrg)[0],(vDif)[1]=(ent->client->ps.origin)[1]-(boltOrg)[1],(vDif)[2]=(ent->client->ps.origin)[2]-(boltOrg)[2]);
				...
				{ 
					...
					((vDif)[0]=(boltOrg)[0]-(pBoltOrg)[0],(vDif)[1]=(boltOrg)[1]-(pBoltOrg)[1],(vDif)[2]=(boltOrg)[2]-(pBoltOrg)[2]);
					...
					trap_Trace(&tr2, ent->client->ps.origin, ent->r.mins, ent->r.maxs, intendedOrigin, ent->s.number, 0x00000001);

					if (tr.fraction == 1.0 && !tr.startsolid && tr2.fraction == 1.0 && !tr2.startsolid)
					{
						((ent->client->ps.origin)[0]=(intendedOrigin)[0],(ent->client->ps.origin)[1]=(intendedOrigin)[1],(ent->client->ps.origin)[2]=(intendedOrigin)[2]);
	...
	if ( ent->flags & 0x00008000 ) {
		ent->flags &= ~0x00008000;
		ent->client->pers.cmd.buttons |= 8;
	}

	if (ent->client && ent->client->ps.fallingToDeath &&
		(level.time - g_fallfadetime.integer) > ent->client->ps.fallingToDeath)
	{ 
		if (ent->health > 0)
		{
			...
			if (ent->client->ps.otherKillerTime > (level.time - 5000) &&
				ent->client->ps.otherKiller != ((1<<10)-1))
			{
			...
			G_Damage(ent, otherKiller, otherKiller, ((void *)0), ent->client->ps.origin, 9999, 0x00000008, MOD_FALLING);
			...
			G_Sound( ent, CHAN_AUTO, G_SoundIndex( "sound/player/lava_land.mp3" ) );
		}
	}
	...
	else if ( ent->r.svFlags & 0x00000008 ) {
		pm.tracemask = (0x00000001|0x00000010|0x00000100|0x00001000) | 0x00000020;
	}
	else {
		pm.tracemask = (0x00000001|0x00000010|0x00000100|0x00001000);
	}
	pm.trace = trap_Trace;
	pm.pointcontents = trap_PointContents;
	pm.debugLevel = g_debugMove.integer;
	pm.noFootsteps = ( g_dmflags.integer & 32 ) > 0;
...
#line 3017 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
	if (ent->ghoul2)
	{
...
#line 3047 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"

	
	((pm.modelScale)[0]=(ent->modelScale)[0],(pm.modelScale)[1]=(ent->modelScale)[1],(pm.modelScale)[2]=(ent->modelScale)[2]);
	...
	pm.nonHumanoid = (ent->localAnimIndex > 0);
			...
			{
				((client->oldOrigin)[0]=(client->ps.origin)[0],(client->oldOrigin)[1]=(client->ps.origin)[1],(client->oldOrigin)[2]=(client->ps.origin)[2]);
			}
	...
	if (ent->client->ps.saberLockTime > level.time)
	{
		...
		if (blockOpp && blockOpp->inuse && blockOpp->client)
		{
			...
			((lockDir)[0]=(blockOpp->r.currentOrigin)[0]-(ent->r.currentOrigin)[0],(lockDir)[1]=(blockOpp->r.currentOrigin)[1]-(ent->r.currentOrigin)[1],(lockDir)[2]=(blockOpp->r.currentOrigin)[2]-(ent->r.currentOrigin)[2]);
		...
		{
			ent->client->ps.saberLockHitCheckTime = level.time;
			if ( ( ent->client->buttons & 1 ) && ! ( ent->client->oldbuttons & 1 ) )
			{
	...
	if (ent->s.number >= 32)
	{
		((pm.mins)[0]=(ent->r.mins)[0],(pm.mins)[1]=(ent->r.mins)[1],(pm.mins)[2]=(ent->r.mins)[2]);
		((pm.maxs)[0]=(ent->r.maxs)[0],(pm.maxs)[1]=(ent->r.maxs)[1],(pm.maxs)[2]=(ent->r.maxs)[2]);
			...
			ent->m_pVehicle )
		{
			...
			{ 
				...
				(void)( (!!(g_entities[ent->m_pVehicle->m_pPilot->s.number].client)) || (_wassert(L"g_entities[ent->m_pVehicle->m_pPilot->s.number].client", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c", 3209), 0) );
				pm.cmd.buttons = (g_entities[ent->m_pVehicle->m_pPilot->s.number].client->pers.cmd.buttons&(1|128));
			}
			if ( ent->m_pVehicle->m_pVehicleInfo->type == VH_WALKER )
			{
				if ( ent->client->ps.groundEntityNum != ((1<<10)-1) )
				{
					...
					if ( under && under->health && under->takedamage )
					{
						...
						G_Damage( under, ent, ent, down, under->r.currentOrigin, 10, 0, MOD_CRUSH );
					}
				}
			}
		}
#line 3227 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
	}
	...
	if ( ent->NPC )
	{
		((ent->r.currentAngles)[0]=(ent->client->ps.viewangles)[0],(ent->r.currentAngles)[1]=(ent->client->ps.viewangles)[1],(ent->r.currentAngles)[2]=(ent->client->ps.viewangles)[2]);
	}

	if (pm.checkDuelLoss)
	{
		if (pm.checkDuelLoss > 0 && (pm.checkDuelLoss <= 32 || (pm.checkDuelLoss < ((1<<10)-1) && g_entities[pm.checkDuelLoss-1].s.eType == ET_NPC) ) )
		{
			...
			{
				vec3_t attDir;
				((attDir)[0]=(ent->client->ps.origin)[0]-(clientLost->client->ps.origin)[0],(attDir)[1]=(ent->client->ps.origin)[1]-(clientLost->client->ps.origin)[1],(attDir)[2]=(ent->client->ps.origin)[2]-(clientLost->client->ps.origin)[2]);
				VectorNormalize(attDir);

				((clientLost->client->ps.velocity)[0]=(clientLost->client->ps.velocity)[1]=(clientLost->client->ps.velocity)[2]=0);
				clientLost->client->ps.forceHandExtend = HANDEXTEND_NONE;
				clientLost->client->ps.forceHandExtendTime = 0;

				gGAvoidDismember = 1;
				G_Damage(clientLost, ent, ent, attDir, clientLost->client->ps.origin, 9999, 0x00000008, MOD_SABER);
		...
		(pm.cmd.generic_cmd != ent->client->lastGenCmd || ent->client->lastGenCmdTime < level.time))
	{
		...
		{ 
			ent->client->lastGenCmdTime = level.time + 1200; 
		}
	...
	if ( !( ent->client->ps.eFlags & (1<<9) ) ) {
		client->fireHeld = qfalse;		
	}

	
	((ent->r.currentOrigin)[0]=(ent->s.pos.trBase)[0],(ent->r.currentOrigin)[1]=(ent->s.pos.trBase)[1],(ent->r.currentOrigin)[2]=(ent->s.pos.trBase)[2]);
	...
	{ 
		((ent->r.mins)[0]=(pm.mins)[0],(ent->r.mins)[1]=(pm.mins)[1],(ent->r.mins)[2]=(pm.mins)[2]);
		((ent->r.maxs)[0]=(pm.maxs)[0],(ent->r.maxs)[1]=(pm.maxs)[1],(ent->r.maxs)[2]=(pm.maxs)[2]);
	}
	...
	if ((ent->client->pers.cmd.buttons & 32) && ent->client->ps.useDelay < level.time)
	{
		TryUse(ent);
	...
	((ent->r.currentOrigin)[0]=(ent->client->ps.origin)[0],(ent->r.currentOrigin)[1]=(ent->client->ps.origin)[1],(ent->r.currentOrigin)[2]=(ent->client->ps.origin)[2]);
	...
	if (client->ps.forceKickFlip && g_flipkickvelocity.integer > 0)
	{
		...
		{int xpgain;
			if ( faceKicked && faceKicked->client && faceKicked->health 
				...
				&& ent->client->ps.fd.forcePower > g_flipkickforce.integer 
				&& (faceKicked->client->ps.torsoAnim != FACE_SMILE 
				) )
			{
				vec3_t oppDir;
				int strength = (int)VectorNormalize2( client->ps.velocity, oppDir );
				
				strength *= (0.04 * ent->client->saber[0].damageScale * 
					(1/faceKicked->client->saber[0].damageScale));
				strength *= (g_flipkickvelocity.integer/20.0f);
				((oppDir)[0]=(oppDir)[0]*(-1),(oppDir)[1]=(oppDir)[1]*(-1),(oppDir)[2]=(oppDir)[2]*(-1));

				G_Damage( faceKicked, ent, ent, oppDir, client->ps.origin, strength*(g_flipkickdamage.integer/20.0f), 0x00000040, MOD_MELEE );
				if (g_cancloak.integer > 0 && faceKicked->client && faceKicked->client->sess.karma >= -32){
					Jedi_Cloak( faceKicked );
				}


				ent->client->ps.fd.forcePower = ent->client->ps.fd.forcePower - g_flipkickforce.integer;
					 ...
					 (!BG_SaberInAttack(faceKicked->client->ps.saberMove) && !PM_SaberInStart(faceKicked->client->ps.saberMove) && !PM_SaberInReturn(faceKicked->client->ps.saberMove) && !PM_SaberInTransition(faceKicked->client->ps.saberMove)) )
				{
						...
						faceKicked->client->ps.forceHandExtend != HANDEXTEND_KNOCKDOWN)
					{
						if (BG_KnockDownable(&faceKicked->client->ps) 
							&& (Q_irand(0,50) > faceKicked->client->sess.dex))
						{ 
							...
							faceKicked->client->ps.forceHandExtend = HANDEXTEND_KNOCKDOWN;
							faceKicked->client->ps.forceHandExtendTime = level.time + 950 + Q_irand(1,300);
							faceKicked->client->ps.forceDodgeAnim = 0; 
						}else if (ent->client && faceKicked->client){

							if (!BG_KnockDownable(&faceKicked->client->ps) ){
								trap_SendServerCommand( -1, va("print \"^2Position save!\n%s ^5resisted knockdown.\n\"",faceKicked->client->pers.netname) );
							...
							if (faceKicked->client && faceKicked->client->pers.netname[1] > 0){
			...
			}else if (faceKicked && faceKicked->client->ps.torsoAnim == FACE_SMILE && ent->client->ps.legsAnim != 900){
			...
			G_SetAnim(faceKicked, ((void *)0), 1|2, BOTH_KYLE_GRAB, 1|2|8, 0);
			faceKicked->client->ps.torsoTimer += 350; 
			if (faceKicked->client->ps.legsAnim == faceKicked->client->ps.torsoAnim)
			{
				faceKicked->client->ps.legsTimer = faceKicked->client->ps.torsoTimer;
			}
			faceKicked->client->ps.weaponTime = faceKicked->client->ps.torsoTimer;
			...
			faceKicked->client->ps.saberLockEnemy = ent->s.number;
			ent->client->ps.saberLockEnemy = faceKicked->s.number;

			faceKicked->client->ps.saberLockTime = level.time + 1000;
			ent->client->ps.saberLockTime = level.time + 1000;
			faceKicked->client->ps.saberLockAdvance = 1;

			ent->client->ps.otherKiller = faceKicked->s.number;
			ent->client->ps.otherKillerTime = level.time + 5000;

			trap_SendServerCommand( -1, va("print \"%s ^5counter KD'd!\n\"",faceKicked->client->pers.netname) );
...
void ClientThink( int clientNum,usercmd_t *ucmd ) {
	...
	if ( !(ent->r.svFlags & 0x00000008) && !g_synchronousClients.integer ) {
		ClientThink_real( ent );
	}
	
	
	else if ( clientNum >= 32 ) {
		ClientThink_real( ent );
	}
...
extern void SetRPGStats(gentity_t *ent, int clientNum)
{
	int percpoints, birthstr, birthdex, birthcon;
	float percpct;

	gclient_t *cl = &level.clients[clientNum];
	char		correctname[1024], dirkey[1024];
	char		valuestr[128],val[128];
	int valueint;
	int lc = 0, ac = 0, bc = 0; 
         fileHandle_t f; 
         int i, j; 
	...
	cl->saber[0].maxChain = (ent->client->sess.dex / 2);

	
	

	
	cl->ps.iModelScale = 120-(ent->client->sess.con*1.1f);
	
	((ent->modelScale)[0]=(1.20f-((ent->client->sess.con/100.0f)*1.1f)), (ent->modelScale)[1]=(1.20f-((ent->client->sess.con/100.0f)*1.1f)), (ent->modelScale)[2]=(1.20f-((ent->client->sess.con/100.0f)*1.1f)));
	
	cl->saber[0].moveSpeedScale = .76f+((ent->client->sess.dex/100.0f)*1.12f);
	
	cl->saber[0].animSpeedScale = .76f+((ent->client->sess.dex/100.0f)*1.12f);
	
	cl->saber[0].damageScale =  0.76f+((ent->client->sess.str/100.0f)*1.12f);
	
	cl->saber[0].damageScale2 =  0.76f+((ent->client->sess.str/100.0f)*1.12f);
	
	
	cl->saber[0].knockbackScale = 2.50f-(((ent->client->sess.dex)/100.0f)*8.0f);
	cl->saber[0].knockbackScale2 = 2.50f-(((ent->client->sess.dex)/100.0f)*8.0f);


	if (cl->ps.iModelScale < 50){
		cl->ps.iModelScale = 50;
		((ent->modelScale)[0]=(0.50f), (ent->modelScale)[1]=(0.50f), (ent->modelScale)[2]=(0.50f));
	}	
	if (cl->ps.iModelScale > 220){
		cl->ps.iModelScale = 220;
		((ent->modelScale)[0]=(2.2f), (ent->modelScale)[1]=(2.2f), (ent->modelScale)[2]=(2.2f));
	}
	if (cl->saber[0].damageScale < 0.40f){
		cl->saber[0].damageScale = 0.40f;
		cl->saber[0].damageScale2 = 0.40f;
	}	
	if (cl->saber[0].damageScale > 2.5f){
		cl->saber[0].damageScale = 2.5f;
		cl->saber[0].damageScale2 = 2.5f;
	}

	if (cl->saber[0].animSpeedScale < 0.40f){
		cl->saber[0].animSpeedScale = 0.40f;
		cl->saber[0].moveSpeedScale = 0.40f;
	}
	if (cl->saber[0].animSpeedScale > 2.5f){
		cl->saber[0].animSpeedScale = 2.5f;
		cl->saber[0].moveSpeedScale = 2.5f;
	}
...
extern void ShowRPGStats(int entNum, int clientNum)
{
	...
	qboolean	firstTime;
	int str, dex, con;
	int strmod, dexmod, conmod;
	int karma;
	char strcolor[64], dexcolor[64], concolor[64];
	char strmodcolor[64], dexmodcolor[64], conmodcolor[64];
	char strmodfix[64], dexmodfix[64], conmodfix[64];
	gentity_t *ent = &g_entities[entNum];
	gclient_t *cl = &level.clients[clientNum];
	char		userinfo[1024];
	char		lastip[1024],correctname[1024], dirkey[1024];
	char		*value, valuestr[128], *smallvalue, *smallcnf;
	int valueint;
int lc = 0, ac = 0, bc = 0; 
         fileHandle_t f; 
         int i, j; 
  ...
  if (!cl || !ent){
		...
		len = trap_FS_FOpenFile(va("ranks/sum/%s.sum",correctname), &f, FS_READ) ;  
        if(len < 0) { 
		
		
		cnf = malloc(25);
		strcpy(cnf, "^1Rank not found.");
	...
	if (entNum == clientNum){
		...
		len = trap_FS_FOpenFile(va("ranks/aln/%s.aln",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			
			cl->sess.karma = atoi(cnf);
			
			
		}trap_FS_FCloseFile(f); 

		
			len = trap_FS_FOpenFile(va("ranks/str/%s.str",correctname), &f, FS_READ) ;  
			if(len > 0) { 
				char *cnf;
				cnf = malloc(len); 
				trap_FS_Read(cnf, len, f); 
				
				cl->sess.str = atoi(cnf);
			...
			len = trap_FS_FOpenFile(va("ranks/dex/%s.dex",correctname), &f, FS_READ) ;  
			if(len > 0) { 
				char *cnf;
				cnf = malloc(len); 
				trap_FS_Read(cnf, len, f); 
				
				cl->sess.dex = atoi(cnf);
		...
		len = trap_FS_FOpenFile(va("ranks/cn/%s.con",correctname), &f, FS_READ) ;  
			if(len > 0) { 
				char *cnf;
				cnf = malloc(len); 
				trap_FS_Read(cnf, len, f); 
				
				cl->sess.con = atoi(cnf);
		...
		len = trap_FS_FOpenFile(va("ranks/gold/%s.gold",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			
			cl->sess.admin_number = atoi(cnf);
			
			
		}trap_FS_FCloseFile(f); 

		len = trap_FS_FOpenFile(va("ranks/lvl/%s.lvl",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			
			cl->sess.wins = atoi(cnf);
			
			
		}trap_FS_FCloseFile(f); 


	len = trap_FS_FOpenFile(va("ranks/xp/%s.xp",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
	...
	len = trap_FS_FOpenFile(va("ranks/pw/%s.pw",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			*(cnf + len) = '\0'; 
			strcpy(cl->sess.admin_name,cnf);
			
			
		}trap_FS_FCloseFile(f); 

	len = trap_FS_FOpenFile(va("ranks/style/%s.style",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			*(cnf + len) = '\0'; 
			...
			if (atoi(cnf) > 0){
			cl->sess.saberLevel = atoi(cnf);
			
			}
		}trap_FS_FCloseFile(f); 

	len = trap_FS_FOpenFile(va("ranks/ip/%s.ip",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			*(cnf + len) = '\0'; 
			...
			if (strlen(value)<=2){
				value=malloc(24);
				strcpy(value,cl->sess.ip);
			}

			smallvalue = malloc(5);
			smallcnf = malloc(5);
			Q_strncpyz(smallvalue,value,5);
			Q_strncpyz(smallcnf,cnf,5);

			if (Q_stricmp (smallvalue,smallcnf) != 0  && smallvalue[0] >= "0" &&  smallvalue[0] <= "9"   && smallcnf[0] >= "0" &&  smallcnf[0] <= "9"){

				if (Q_stricmp (cl->pers.netname, "Padawan") != 0 && Q_stricmp (cl->pers.netname, "Player") != 0 && !IsABot(clientNum)){
					trap_SendServerCommand( -1, va("print \"%s ^1subnet mismatch [before: %sxxxx after: %sxxxx]\n\"",cl->pers.netname,smallcnf,smallvalue) );
					...
					level.clients[i].mGameFlags &= ~(1<<0);
					}
					

					trap_SetConfigstring( 8, va("%i", level.voteTime ) );
					trap_SetConfigstring( 9, va("%s", level.voteDisplayString) );	
					trap_SetConfigstring( 10, va("%i", level.voteYes ) );
					trap_SetConfigstring( 11, va("%i", level.voteNo ) );
					trap_SendServerCommand( -1, va("print \"^7Fake %s? (before: %sxxxx after: %sxxxx)\n\"", cl->pers.netname,smallcnf,smallvalue ) );
					trap_SendServerCommand( -1, va("cp \"^7Fake %s?\n(before: %sxxxx after: %sxxxx)\n\"", cl->pers.netname,smallcnf,smallvalue ) );
				}

				if (Q_stricmp (cl->pers.netname, "Padawan") != 0 && Q_stricmp (cl->pers.netname, "Player") != 0 && 
					(Q_stricmp (cl->sess.admin_name, "sub") == 0 
					|| Q_stricmp (cl->sess.admin_name, "tsub") == 0 
					|| Q_stricmp (cl->sess.admin_name, "rsub") == 0) && !IsABot(clientNum)){
			...
			}else if (Q_stricmp (smallvalue,smallcnf) == 0){
				
								
				if ((Q_stricmp (cl->sess.admin_name, "sub") == 0 || Q_stricmp (cl->sess.admin_name, "tsub") == 0 || Q_stricmp (cl->sess.admin_name, "rsub") == 0)){
					
				}
					
			}
		}else if (!IsABot(clientNum)){

			
				if ((Q_stricmp (cl->sess.admin_name, "sub") == 0 || Q_stricmp (cl->sess.admin_name, "tsub") == 0 || Q_stricmp (cl->sess.admin_name, "rsub") == 0)){
					strcpy(cl->sess.admin_name,"");
	...
	len = trap_FS_FOpenFile(va("ranks/stype/%s.stype",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			*(cnf + len) = '\0'; 
			strcpy(cl->sess.saberType,cnf);
			...
			len = trap_FS_FOpenFile(va("ranks/stype/%s.stype2",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			*(cnf + len) = '\0'; 
			strcpy(cl->sess.saber2Type,cnf);
			
		}trap_FS_FCloseFile(f); 

		len = trap_FS_FOpenFile(va("ranks/so/%s.so",correctname), &f, FS_READ) ;  
        if(len > 0) { 
			char *cnf;
			cnf = malloc(len); 
			trap_FS_Read(cnf, len, f); 
			*(cnf + len) = '\0'; 
			...
			ent->client->ps.fd.forcePowerLevel[FP_SABER_OFFENSE] = atoi(cnf);
	...
	if (cl->pers.connected == CON_CONNECTED
		&& !ReadKeys(clientNum,va("%s","str")) 
		&& !ReadKeys(clientNum,va("%s","dex")) 
		&& !ReadKeys(clientNum,va("%s","con"))	){
			
			cl->sess.str = -3 + Q_irand(0,27);
			cl->sess.dex = -3 + Q_irand(0,27);
			cl->sess.con = 40 - (cl->sess.str + cl->sess.dex) ;

			WriteKeys(clientNum,1,qtrue);
			WriteKeys(clientNum,2,qtrue);
			WriteKeys(clientNum,3,qtrue);

			trap_SendServerCommand(-1, va("print \"^3Birth roll (%s): %i STR, %i DEX, %i CON\n\""
			, cl->pers.netname
			, cl->sess.str
			, cl->sess.dex
			, cl->sess.con
	...
	if ((cl->sess.str + cl->sess.dex + cl->sess.con > 99)&&ReadKeys(clientNum,va("%s","dex"))){
			...
			trap_SendServerCommand(-1, va("print \"^3Rebirth roll (%s): %i STR, %i DEX, %i CON\n\""
			, cl->pers.netname
			, cl->sess.str
			, cl->sess.dex
			, cl->sess.con
	...
	percpoints = cl->sess.wins;

	if (percpoints <= -10){
		strcpy(foo,"^1The Damned");
	}else if (percpoints <= -5){
		strcpy(foo,"^1Wretch");
	}else if (percpoints <= 0){
		strcpy(foo,"^4Padawannabe");
	}else if (percpoints <= 2){
		strcpy(foo,"^4Padawan");
	}else if (percpoints <= 5){
		strcpy(foo,"^4Lt. Padawan");
	}else if (percpoints <= 8){
		strcpy(foo,"^6Wooty Youngling");
	}else if (percpoints <= 12){
		strcpy(foo,"^6Wooty Adept");
	}else if (percpoints <= 15){
		strcpy(foo,"^6Wooty Miser");
	}else if (percpoints <= 20){
		strcpy(foo,"^6Wooty Master");
	}else if (percpoints <= 24){
		strcpy(foo,"^7Grand Muff");
	}else if (percpoints <= 30){
		strcpy(foo,"^7Wooty Grandmaster");
	}else if (percpoints <= 38){
		strcpy(foo,"^0Pride of Wooty");
	}else if (percpoints <= 45){
		strcpy(foo,"^0Minor Deity");
	}else{
		strcpy(foo,"^0Wooty");
	}
	...
	if (karma <= -2048){
		strcpy(karmastr,"^0Unrepentant");
	}else if (karma <= -1024){
		strcpy(karmastr,"^0Nihilist");
	}else if (karma <= -512){
		strcpy(karmastr,"^0Amoral");
	}else if (karma <= -256){
		strcpy(karmastr,"^1Evil Inchoate");
	}else if (karma <= -128){
		strcpy(karmastr,"^1Evil");
	}else if (karma <= -64){
		strcpy(karmastr,"^1Useful Idiot");
	}else if(karma <= -48){
		strcpy(karmastr,"^1Evil Tendencies");
	}else if(karma <= -32){
		strcpy(karmastr,"^1Evil Sympathizer");
	}else if(karma <= -16){
		strcpy(karmastr,"^1Potentially Evil");
	}else if(karma <= -8){
		strcpy(karmastr,"^4Scofflawingly Neutral");
	}else if(karma < 0){
		strcpy(karmastr,"^4Barely Neutral");
	}else if(karma == 0){
		strcpy(karmastr,"^4Truly Neutral");
	}else if(karma <= 7){
		strcpy(karmastr,"^4Passably Neutral");
	}else if(karma < 16){
		strcpy(karmastr,"^4Respectably Neutral");
	}else if(karma < 32){
		strcpy(karmastr,"^3Good Intentions");
	}else if(karma < 48){
		strcpy(karmastr,"^3Good Leaning");
	}else if(karma < 64){
		strcpy(karmastr,"^3Mainly Good");
	}else if(karma < 128){
		strcpy(karmastr,"^3Good");
	}else if (karma < 256){
		strcpy(karmastr,"^5Magnificent");
	}else if (karma < 512){
		strcpy(karmastr,"^5Resplendent");
	}else{
		strcpy(karmastr,"^0Chaotic?");
	}
	...
	if (str <= 6){
		strcpy(foostr,"^1Runty ");
	}else if(str <= 17){
		strcpy(foostr,"");
	}else if(str <= 24){
		strcpy(foostr,"^7Full ");
	}else{
		strcpy(foostr,"^4Gargantuan ");
	}


	if (dex <= 6){
		strcpy(foodex,"^1Gimpy ");
	}else if(dex <= 17){
		strcpy(foodex,"");
	}else if(dex <= 24){
		strcpy(foodex,"^5Fast ");
	}else{
		strcpy(foodex,"^0Shadow ");
	}

	if (con <= 6){
		strcpy(foocon,"^1Pissant ");
	}else if(con <= 17){
		strcpy(foocon,"");
	}else if(con <= 24){
		strcpy(foocon,"^4Firm ");
...
if(  Q_stricmp ("sub", ent->client->sess.admin_name) ==  0 ||
	...
	if(entNum == clientNum){
		trap_SendServerCommand(entNum, va("print \"^7Name: %s^7\n^5Level %i %s%s%s%s ^5(%i XP)\n^3%i gold ^7$$ %s%i ^5STR, %s%i ^5DEX, %s%i ^5CON\n^0Align: %s ^0(%i)\n^7%s\n\"", 
		cl->pers.netname,
		percpoints, 
		foostr,
		foodex,
		...
		trap_SendServerCommand(entNum, va("cp \"^5Level %i %s%s%s%s ^5(%i XP)\n%s%i ^5STR] %s%i ^5DEX [%s%i ^5CON\n^0Align: %s ^0(%i)^7%s ^3%i gold\n^7%s\"", 
		percpoints, 
		foostr,
		foodex,
		foocon,
...
void SpectatorClientEndFrame( gentity_t *ent ) {
	...
	if (ent->s.eType == ET_NPC)
	{
		(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c", 4847), 0) );
		return;
	}
	...
	if ( ent->client->sess.spectatorState == SPECTATOR_FOLLOW ) {
		...
		if ( clientNum >= 0 ) {
			...
			if (ent->client->sess.siegeDesiredTeam != clientNum + 1)
			{
				ent->client->sess.siegeDesiredTeam = clientNum + 1;
				ShowRPGStats(ent->s.number, cl->ps.clientNum);
			}
...
#line 4949 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_active.c"
	...
	if ( level.time - ent->client->lastCmdTime > 2000 ) {
		ent->s.eFlags |= (1<<14);
	} else {
		ent->s.eFlags &= ~(1<<14);
	}
