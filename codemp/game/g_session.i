#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_session.c"
...
#line 4 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_session.c"
...
void G_WriteClientSessionData( gclient_t *client ) {
	...
	s = va("%i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %s %s %s %s %s", 
		...
		saberType,
		saber2Type,
		client->sess.admin_name,
		client->sess.pass_name
...
void G_ReadSessionData( gclient_t *client ) {
	...
	sscanf( s, "%i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %s %s %s %s %s",
		&sessionTeam,                 
		&client->sess.spectatorTime,
		&spectatorState,              
		&client->sess.spectatorClient,
