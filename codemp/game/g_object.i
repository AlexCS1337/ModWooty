#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_object.c"
...
#line 2 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_object.c"
...
void G_BounceObject( gentity_t *ent, trace_t *trace ) 
{
	...
	((ent->s.pos.trDelta)[0]=(velocity)[0]+(trace->plane.normal)[0]*(-2*dot*bounceFactor),(ent->s.pos.trDelta)[1]=(velocity)[1]+(trace->plane.normal)[1]*(-2*dot*bounceFactor),(ent->s.pos.trDelta)[2]=(velocity)[2]+(trace->plane.normal)[2]*(-2*dot*bounceFactor));

	
	if ( ent->flags & 0x00200000 ) 
	{
		((ent->s.pos.trDelta)[0]=(ent->s.pos.trDelta)[0]*(0.5),(ent->s.pos.trDelta)[1]=(ent->s.pos.trDelta)[1]*(0.5),(ent->s.pos.trDelta)[2]=(ent->s.pos.trDelta)[2]*(0.5));

		
		if ( ((trace->plane.normal[2] > 0.7&&g_gravity.value>0) || (trace->plane.normal[2]<-0.7&&g_gravity.value<0)) && ((ent->s.pos.trDelta[2]<40&&g_gravity.value>0)||(ent->s.pos.trDelta[2]>-40&&g_gravity.value<0)) ) 
		{
			...
			((ent->r.currentOrigin)[0]=(trace->endpos)[0],(ent->r.currentOrigin)[1]=(trace->endpos)[1],(ent->r.currentOrigin)[2]=(trace->endpos)[2]);
			((ent->s.pos.trBase)[0]=(trace->endpos)[0],(ent->s.pos.trBase)[1]=(trace->endpos)[1],(ent->s.pos.trBase)[2]=(trace->endpos)[2]);
	...
	((ent->pos1)[0]=(trace->plane.normal)[0],(ent->pos1)[1]=(trace->plane.normal)[1],(ent->pos1)[2]=(trace->plane.normal)[2]);
}
...
void G_RunObject( gentity_t *ent ) 
{
	...
	if ( tr.fraction == 1 ) 
	{
		...
		if ( !g_gravity.value )
		{
			...
			((ent->s.pos.trDelta)[0]=(ent->s.pos.trDelta)[0]*(friction),(ent->s.pos.trDelta)[1]=(ent->s.pos.trDelta)[1]*(friction),(ent->s.pos.trDelta)[2]=(ent->s.pos.trDelta)[2]*(friction));
			((ent->s.pos.trBase)[0]=(ent->r.currentOrigin)[0],(ent->s.pos.trBase)[1]=(ent->r.currentOrigin)[1],(ent->s.pos.trBase)[2]=(ent->r.currentOrigin)[2]);
			ent->s.pos.trTime = level.time;
		}
		return;
	...
	if ( ent->s.pos.trType == TR_GRAVITY )
	{
		...
		{
			if ( ent->flags&(0x00100000|0x00200000) )
			{
				if ( tr.fraction <= 0.0f )
				{
					((ent->r.currentOrigin)[0]=(tr.endpos)[0],(ent->r.currentOrigin)[1]=(tr.endpos)[1],(ent->r.currentOrigin)[2]=(tr.endpos)[2]);
					((ent->s.pos.trBase)[0]=(tr.endpos)[0],(ent->s.pos.trBase)[1]=(tr.endpos)[1],(ent->s.pos.trBase)[2]=(tr.endpos)[2]);
...
void G_StopObjectMoving( gentity_t *object )
{
	...
	((object->s.origin)[0]=(object->r.currentOrigin)[0],(object->s.origin)[1]=(object->r.currentOrigin)[1],(object->s.origin)[2]=(object->r.currentOrigin)[2]);
	((object->s.pos.trBase)[0]=(object->r.currentOrigin)[0],(object->s.pos.trBase)[1]=(object->r.currentOrigin)[1],(object->s.pos.trBase)[2]=(object->r.currentOrigin)[2]);
	((object->s.pos.trDelta)[0]=(object->s.pos.trDelta)[1]=(object->s.pos.trDelta)[2]=0);
...
void G_StartObjectMoving( gentity_t *object, vec3_t dir, float speed, trType_t trType )
{
	...
	((object->s.pos.trBase)[0]=(object->r.currentOrigin)[0],(object->s.pos.trBase)[1]=(object->r.currentOrigin)[1],(object->s.pos.trBase)[2]=(object->r.currentOrigin)[2]);
	((object->s.pos.trDelta)[0]=(dir)[0]*(speed),(object->s.pos.trDelta)[1]=(dir)[1]*(speed),(object->s.pos.trDelta)[2]=(dir)[2]*(speed));
	...
	if ( object->think == ((void *)0) )
	{
		object->nextthink = level.time + 50;
