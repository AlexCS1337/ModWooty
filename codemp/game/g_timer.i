#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_timer.c"
...
#line 6 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_timer.c"
...
typedef struct gtimer_s
{
	const char *name;
	int time;
	struct gtimer_s *next;	
} gtimer_t;

gtimer_t g_timerPool[ 16384 ];
gtimer_t *g_timers[ (1<<10) ];
...
void TIMER_Clear( void )
{
	...
	g_timerPool[16384-1].next = ((void *)0);
...
void TIMER_Clear2( gentity_t *ent )
{
	...
	if ( ent && ent->s.number > 0 && ent->s.number < (1<<10) )
	{
