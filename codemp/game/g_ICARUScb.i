#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
#line 8 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
#line 9 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
#line 10 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
#line 11 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\icarus\\q3_registers.h"
...
#line 37 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\icarus\\q3_registers.h"
#line 12 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
#line 13 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
#line 15 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
#line 19 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
#line 46 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
#line 47 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"

#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\icarus\\interpreter.h"
...
#line 225 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\icarus\\interpreter.h"
#line 49 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
...
void G_DebugPrint( int level, const char *format, ... )
{
	...
	( argptr = (va_list)( &(format) ) + ( (sizeof(format) + sizeof(int) - 1) & ~(sizeof(int) - 1) ) );
	...
	{
		case WL_ERROR:
			Com_Printf ( "^1""ERROR: %s", text );
			break;
		
		case WL_WARNING:
			Com_Printf ( "^3""WARNING: %s", text );
			break;
		...
		case WL_DEBUG:
			{
				...
				if ( ( entNum < 0 ) || ( entNum > (1<<10) ) )
					entNum = 0;

				Com_Printf ( "^4""DEBUG: %s(%d): %s\n", g_entities[entNum].script_targetname, entNum, buffer );
				break;
			}
		default:
		case WL_VERBOSE:
			Com_Printf ( "^2""INFO: %s", text );
			break;
	}
}
...
#line 395 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
	}
...
int Q3_PlaySound( int taskID, int entID, const char *name, const char *channel )
{
	...
	char			finalName[64];
	soundChannel_t	voice_chan = CHAN_VOICE; 
	qboolean		type_voice = qfalse;
	int				soundHandle;
	qboolean		bBroadcast;

	Q_strncpyz( finalName, name, 64 );
	Q_strupr(finalName);
...
void Q3_Play( int taskID, int entID, const char *type, const char *name )
{
	...
	if ( !Q_stricmp( type, "PLAY_ROFF" ) )
	{
		...
		if ( ent->roffid )
		{
			...
			((ent->s.origin2)[0]=(ent->r.currentOrigin)[0],(ent->s.origin2)[1]=(ent->r.currentOrigin)[1],(ent->s.origin2)[2]=(ent->r.currentOrigin)[2]);
			((ent->s.angles2)[0]=(ent->r.currentAngles)[0],(ent->s.angles2)[1]=(ent->r.currentAngles)[1],(ent->s.angles2)[2]=(ent->r.currentAngles)[2]);
...
void anglerCallback( gentity_t *ent )
{
	...
	((ent->r.currentAngles)[0]=(ent->s.apos.trBase)[0]+(ent->s.apos.trDelta)[0]*((ent->s.apos.trDuration*0.001f)),(ent->r.currentAngles)[1]=(ent->s.apos.trBase)[1]+(ent->s.apos.trDelta)[1]*((ent->s.apos.trDuration*0.001f)),(ent->r.currentAngles)[2]=(ent->s.apos.trBase)[2]+(ent->s.apos.trDelta)[2]*((ent->s.apos.trDuration*0.001f)));
	((ent->s.apos.trBase)[0]=(ent->r.currentAngles)[0],(ent->s.apos.trBase)[1]=(ent->r.currentAngles)[1],(ent->s.apos.trBase)[2]=(ent->r.currentAngles)[2]);
...
void Blocked_Mover( gentity_t *ent, gentity_t *other )
{
	...
	else if ( other->s.number && (!other->client || (other->client && other->health <= 0 && other->r.contents == 0x00000200 && !other->message)) )
	{
...
void Q3_Lerp2Start( int entID, int taskID, float duration )
{
	...
	ent->s.pos.trDuration = duration * 10;	
...
void Q3_Lerp2Pos( int taskID, int entID, vec3_t origin, vec3_t angles, float duration )
{
	...
	{
		((ent->pos1)[0]=(ent->r.currentOrigin)[0],(ent->pos1)[1]=(ent->r.currentOrigin)[1],(ent->pos1)[2]=(ent->r.currentOrigin)[2]);
		((ent->pos2)[0]=(origin)[0],(ent->pos2)[1]=(origin)[1],(ent->pos2)[2]=(origin)[2]);

		moverState = MOVER_1TO2;
	}
	else
	{
		((ent->pos2)[0]=(ent->r.currentOrigin)[0],(ent->pos2)[1]=(ent->r.currentOrigin)[1],(ent->pos2)[2]=(ent->r.currentOrigin)[2]);
		((ent->pos1)[0]=(origin)[0],(ent->pos1)[1]=(origin)[1],(ent->pos1)[2]=(origin)[2]);
...
int	Q3_GetTag( int entID, const char *name, int lookup, vec3_t info )
{
	...
	if (!ent->inuse)
	{
		(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c", 954), 0) );
		return 0;
	}
...
void Q3_Kill( int entID, const char *name )
{
	...
	{
		victim = G_Find (((void *)0), ((int)&(((gentity_t *)0)->targetname)), (char *) name );
	}
	...
	if ( victim->client )
	{
		victim->flags |= 0x00000800;
	}
	
	if( victim->die != ((void *)0) )	
	{
		
		victim->die(victim, victim, victim, o_health, MOD_TELEFRAG);
	}
}
...
void Q3_RemoveEnt( gentity_t *victim )
{
	if( victim->client )
	{
		if ( victim->s.eType != ET_NPC )
		{
			...
			(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c", 1069), 0) ); 
		}
		else
		{
...
void Q3_Remove( int entID, const char *name )
{
	...
	else
	{
		...
		{
			Q3_RemoveEnt( victim );
			victim = G_Find( victim, ((int)&(((gentity_t *)0)->targetname)), (char *) name );
		}
	}
}
...
int Q3_GetFloat( int entID, int type, const char *name, float *value )
{
	...
	toGet = GetIDForString( setTable, name );	
	...
	case SET_PLAYER_USABLE:
		*value = (ent->r.svFlags&0x00000010);
		break;
	case SET_LOOP_ANIM:
		return 0;
		break;
...
int Q3_GetVector( int entID, int type, const char *name, vec3_t value )
{
	...
	case SET_ORIGIN:
		((value)[0]=(ent->r.currentOrigin)[0],(value)[1]=(ent->r.currentOrigin)[1],(value)[2]=(ent->r.currentOrigin)[2]);
		break;

	case SET_ANGLES:
		((value)[0]=(ent->r.currentAngles)[0],(value)[1]=(ent->r.currentAngles)[1],(value)[2]=(ent->r.currentAngles)[2]);
		break;
...
static qboolean Q3_SetTeleportDest( int entID, vec3_t org )
{
	...
	if ( teleEnt )
	{
		if ( SpotWouldTelefrag2( teleEnt, org ) )
		{
			...
			teleporter->nextthink = level.time + 50;
...
static void Q3_SetOrigin( int entID, vec3_t origin )
{
	...
	if(ent->client)
	{
		((ent->client->ps.origin)[0]=(origin)[0],(ent->client->ps.origin)[1]=(origin)[1],(ent->client->ps.origin)[2]=(origin)[2]);
		...
		ent->client->ps.pm_time = 160;		
		ent->client->ps.pm_flags |= 64;
		
		ent->client->ps.eFlags ^= (1<<3);
...
{
	gentity_t	*found = G_Find( ((void *)0), ((int)&(((gentity_t *)0)->targetname)), (char *) name);
...
{	
	...
	((origin)[0]=(ent->s.origin)[0],(origin)[1]=(ent->s.origin)[1],(origin)[2]=(ent->s.origin)[2]);
	origin[axis] += offset;
	duration = 0;
	if ( ent->speed )
	{
...
static void Q3_SetEnemy( int entID, const char *name )
{
	...
	{
		gentity_t	*enemy = G_Find( ((void *)0), ((int)&(((gentity_t *)0)->targetname)), (char *) name);
...
static void Q3_SetLeader( int entID, const char *name )
{
	...
	if( !Q_stricmp("NONE", name) || !Q_stricmp("NULL", name))
	{
		ent->client->leader = ((void *)0);
	}
	else
	{
		gentity_t	*leader = G_Find( ((void *)0), ((int)&(((gentity_t *)0)->targetname)), (char *) name);
...
static qboolean Q3_SetNavGoal( int entID, const char *name )
{
	...
	else
	{
		...
		if ( TAG_GetOrigin2( ((void *)0), name, goalPos ) == qfalse )
		{
			gentity_t	*targ = G_Find(((void *)0), ((int)&(((gentity_t *)0)->targetname)), (char*)name);
			if ( !targ )
			{
			...
			else
			{
				...
				ent->NPC->aiFlags &= ~0x00000008;
			}
		}
		else
		{
			int	goalRadius = TAG_GetRadius( ((void *)0), name );
			NPC_SetMoveGoal( ent, goalPos, goalRadius, qtrue, -1, ((void *)0) );
			
			ent->NPC->goalEntity->lastWaypoint = -1;
			ent->NPC->aiFlags &= ~0x00000008;
	
			
			ent->NPC->tempGoal->target = G_NewString( name );
	#line 2316 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_icaruscb.c"
		return qtrue;
		}
	}
	return qfalse;
...
static void SetLowerAnim( int entID, int animID)
{
	...
	G_SetAnim(ent,((void *)0),2,animID,4|2|1,0);
}
...
static void SetUpperAnim ( int entID, int animID)
{
	...
	G_SetAnim(ent,((void *)0),1,animID,4|2|1,0);
}
...
static qboolean Q3_SetBState( int entID, const char *bs_name )
{
	...
	if ( bSID > -1 )
	{
		if ( bSID == BS_SEARCH || bSID == BS_WANDER )
		{
			...
			{
				ent->waypoint = NAV_FindClosestWaypointForEnt( ent, -1 );
		...
		ent->NPC->tempBehavior = BS_DEFAULT;
...
{
	gentity_t	*self  = G_Find( ((void *)0), ((int)&(((gentity_t *)0)->targetname)), name );
	if ( !self )
	{
		self = G_Find( ((void *)0), ((int)&(((gentity_t *)0)->script_targetname)), name );
	}
...
static void Q3_SetWalking( int entID, qboolean add)
{
	...
	if(add)
	{
		ent->NPC->scriptFlags |= 0x00000002;
	}
	else
	{
		ent->NPC->scriptFlags &= ~0x00000002;
...
static qboolean Q3_SetSolid( int entID, qboolean solid)
{
	...
	if ( solid )
	{
		...
		if ( SpotWouldTelefrag2( ent, ent->r.currentOrigin ) )
		{
			...
			solidifier->nextthink = level.time + 50;
			
			ent->r.contents = oldContents;
			return qfalse;
		}
		ent->clipmask |= 0x00000100;
	}
	else
	{
		if ( ent->s.eFlags & (1<<8) )
...
static qboolean Q3_SetBehaviorSet( int entID, int toSet, const char *scriptname)
{
	...
	{
		if ( ent->behaviorSet[bSet] != ((void *)0) )
		{

		}

		ent->behaviorSet[bSet] = ((void *)0);
	...
	else
	{
		if ( scriptname )
		{
			...
			ent->behaviorSet[bSet] = G_NewString( (char *) scriptname );	
		}
...
qboolean Q3_Set( int taskID, int entID, const char *type_name, const char *data )
{
	...
	case SET_ORIGIN:
		...
		{
			((ent->s.origin)[0]=(vector_data)[0],(ent->s.origin)[1]=(vector_data)[1],(ent->s.origin)[2]=(vector_data)[2]);
		}
		break;
	...
	case SET_ANIM_UPPER:
		...
		{
			Q3_TaskIDClear( &ent->taskID[TID_ANIM_BOTH] );
