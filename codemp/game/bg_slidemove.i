#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
#line 6 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
#line 7 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
#line 8 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
#line 11 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
#line 12 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
extern void G_FlyVehicleSurfaceDestruction(gentity_t *veh, trace_t *trace, int magnitude, qboolean force ); 
extern qboolean G_CanBeEnemy(gentity_t *self, gentity_t *enemy); 
#line 28 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
#line 32 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
#line 44 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
void PM_VehicleImpact(bgEntity_t *pEnt, trace_t *trace)
{
	...
	gentity_t *hitEnt = trace!=((void *)0)?&g_entities[trace->entityNum]:((void *)0);
		...
		&& pSelfVeh->m_iRemovedSurfaces )
	{
		if ( hitEnt->s.NPC_class == CLASS_VEHICLE )
		{
			...
			G_Damage( (gentity_t *)pEnt, killer, killer, ((void *)0), pm->ps->origin, 999999, 0x00000002, MOD_FALLING );
			return;
		}
		else if ( !VectorCompare( trace->plane.normal, vec3_origin )
			&& (trace->entityNum == ((1<<10)-2) || hitEnt->r.bmodel ) )
		{
			vec3_t	moveDir;
			float	impactDot;
			((moveDir)[0]=(pm->ps->velocity)[0],(moveDir)[1]=(pm->ps->velocity)[1],(moveDir)[2]=(pm->ps->velocity)[2]);
			VectorNormalize( moveDir );
			impactDot = ((moveDir)[0]*(trace->plane.normal)[0]+(moveDir)[1]*(trace->plane.normal)[1]+(moveDir)[2]*(trace->plane.normal)[2]);
			if ( impactDot <= -0.7f )
			{
	...
	if ( trace->entityNum < ((1<<10)-2)
		...
		&& hitEnt->s.apos.trType != TR_STATIONARY
		&& (hitEnt->spawnflags&16) 
...
#line 132 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
#line 158 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
		{
			return;
		}
	}
		...
		(magnitude >= 100||forceSurfDestruction) )
	{
			...
			|| forceSurfDestruction )
		{
			...
			if ( trace && !pSelfVeh->m_iRemovedSurfaces && !forceSurfDestruction )
			{
				...
				if ( (trace->entityNum == ((1<<10)-2) || hitEnt->s.solid == 0xffffff)
					 && !VectorCompare(trace->plane.normal, vec3_origin) )
				{ 
					if (pSelfVeh->m_pVehicleInfo->type == VH_SPEEDER)
					{
						pm->ps->speed *= pml.frametime;
						((bounceDir)[0]=(trace->plane.normal)[0],(bounceDir)[1]=(trace->plane.normal)[1],(bounceDir)[2]=(trace->plane.normal)[2]);
					}
					else if ( trace->plane.normal[2] >= 0.8f
						&& pSelfVeh->m_LandTrace.fraction < 1.0f 
						&& pm->ps->speed <= 200 )
					{
						return;
					}
				...
				else if ( pSelfVeh->m_pVehicleInfo->type == VH_FIGHTER )
				{
						...
						&& hitEnt->m_pVehicle->m_pVehicleInfo->type == VH_FIGHTER )
					{
						...
						((bounceDir)[0]=(pm->ps->origin)[0]-(hitEnt->r.currentOrigin)[0],(bounceDir)[1]=(pm->ps->origin)[1]-(hitEnt->r.currentOrigin)[1],(bounceDir)[2]=(pm->ps->origin)[2]-(hitEnt->r.currentOrigin)[2]);
#line 224 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
				...
				if ( turnFromImpact )
				{
					...
					if ( !turnHitEnt )
					{
						((pushDir)[0]=(bounceDir)[0]*((pm->ps->speed*0.25f/pSelfVeh->m_pVehicleInfo->mass)),(pushDir)[1]=(bounceDir)[1]*((pm->ps->speed*0.25f/pSelfVeh->m_pVehicleInfo->mass)),(pushDir)[2]=(bounceDir)[2]*((pm->ps->speed*0.25f/pSelfVeh->m_pVehicleInfo->mass)));
					}
					else
					{
						...
						if ( hitEnt->client )
						{
							((pushDir)[0]=(bounceDir)[0]*((pm->ps->speed+hitEnt->client->ps.speed)*0.5f),(pushDir)[1]=(bounceDir)[1]*((pm->ps->speed+hitEnt->client->ps.speed)*0.5f),(pushDir)[2]=(bounceDir)[2]*((pm->ps->speed+hitEnt->client->ps.speed)*0.5f));
						}
						else
						{
							((pushDir)[0]=(bounceDir)[0]*((pm->ps->speed+hitEnt->s.speed)*0.5f),(pushDir)[1]=(bounceDir)[1]*((pm->ps->speed+hitEnt->s.speed)*0.5f),(pushDir)[2]=(bounceDir)[2]*((pm->ps->speed+hitEnt->s.speed)*0.5f));
						}
#line 252 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
						((pushDir)[0]=(pushDir)[0]*((l/pSelfVeh->m_pVehicleInfo->mass)),(pushDir)[1]=(pushDir)[1]*((l/pSelfVeh->m_pVehicleInfo->mass)),(pushDir)[2]=(pushDir)[2]*((l/pSelfVeh->m_pVehicleInfo->mass)));
						((pushDir)[0]=(pushDir)[0]*(0.1f),(pushDir)[1]=(pushDir)[1]*(0.1f),(pushDir)[2]=(pushDir)[2]*(0.1f));
					}
					VectorNormalize2( pm->ps->velocity, moveDir );
					bounceDot = ((moveDir)[0]*(bounceDir)[0]+(moveDir)[1]*(bounceDir)[1]+(moveDir)[2]*(bounceDir)[2])*-1;
					if ( bounceDot < 0.1f )
					{
						bounceDot = 0.1f;
					}
					((pushDir)[0]=(pushDir)[0]*(bounceDot),(pushDir)[1]=(pushDir)[1]*(bounceDot),(pushDir)[2]=(pushDir)[2]*(bounceDot));
					((pm->ps->velocity)[0]=(pm->ps->velocity)[0]+(pushDir)[0],(pm->ps->velocity)[1]=(pm->ps->velocity)[1]+(pushDir)[1],(pm->ps->velocity)[2]=(pm->ps->velocity)[2]+(pushDir)[2]);
					...
					{
						pitchTurnStrength = turnStrength*turnDelta[0];
						if ( pitchTurnStrength > 45.0f )
						{
							pitchTurnStrength = 45.0f;
						}
						else if ( pitchTurnStrength < -45.0f )
						{
							pitchTurnStrength = -45.0f;
						}
						
						pSelfVeh->m_vFullAngleVelocity[0] = AngleNormalize180(pSelfVeh->m_vOrientation[0]+pitchTurnStrength/turnDivider*pSelfVeh->m_fTimeModifier);
					}
					...
					{
						yawTurnStrength = turnStrength*turnDelta[1];
						if ( yawTurnStrength > 45.0f )
						{
							yawTurnStrength = 45.0f;
						}
						else if ( yawTurnStrength < -45.0f )
						{
							yawTurnStrength = -45.0f;
						}
						
						pSelfVeh->m_vFullAngleVelocity[2] = AngleNormalize180(pSelfVeh->m_vOrientation[2]-yawTurnStrength/turnDivider*pSelfVeh->m_fTimeModifier);
					}
						...
						&& !(hitEnt->spawnflags&2) )
					{
						...
						((bounceDir)[0]=(bounceDir)[0]*(-1),(bounceDir)[1]=(bounceDir)[1]*(-1),(bounceDir)[2]=(bounceDir)[2]*(-1));
						
						((pushDir)[0]=(bounceDir)[0]*((pm->ps->speed+l)*0.5f),(pushDir)[1]=(bounceDir)[1]*((pm->ps->speed+l)*0.5f),(pushDir)[2]=(bounceDir)[2]*((pm->ps->speed+l)*0.5f));
						((pushDir)[0]=(pushDir)[0]*((l*0.5f/hitEnt->m_pVehicle->m_pVehicleInfo->mass)),(pushDir)[1]=(pushDir)[1]*((l*0.5f/hitEnt->m_pVehicle->m_pVehicleInfo->mass)),(pushDir)[2]=(pushDir)[2]*((l*0.5f/hitEnt->m_pVehicle->m_pVehicleInfo->mass)));
						...
						((pushDir)[0]=(pushDir)[0]*(bounceDot),(pushDir)[1]=(pushDir)[1]*(bounceDot),(pushDir)[2]=(pushDir)[2]*(bounceDot));
						((hitEnt->client->ps.velocity)[0]=(hitEnt->client->ps.velocity)[0]+(pushDir)[0],(hitEnt->client->ps.velocity)[1]=(hitEnt->client->ps.velocity)[1]+(pushDir)[1],(hitEnt->client->ps.velocity)[2]=(hitEnt->client->ps.velocity)[2]+(pushDir)[2]);
						...
						else
						{
							...
							hitEnt->m_pVehicle->m_vFullAngleVelocity[0] = AngleNormalize180(hitEnt->m_pVehicle->m_vOrientation[0]+pitchTurnStrength/turnDivider*pSelfVeh->m_fTimeModifier);
						}
						...
						else
						{
							...
							hitEnt->m_pVehicle->m_vFullAngleVelocity[2] = AngleNormalize180(hitEnt->m_pVehicle->m_vOrientation[2]-yawTurnStrength/turnDivider*pSelfVeh->m_fTimeModifier);
						}
...
#line 421 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
				}
			}
			...
			AngleVectors( pSelfVeh->m_vOrientation, ((void *)0), ((void *)0), vehUp );
			...
			{ 
				if (pSelfVeh->m_pVehicleInfo->type == VH_FIGHTER)
				{ 
					float mult = (pSelfVeh->m_vOrientation[0]*0.1f);
					if (mult < 1.0f)
					{
						mult = 1.0f;
					}
				...
				G_Damage( (gentity_t *)pEnt, ((void *)0), ((void *)0), ((void *)0), pm->ps->origin, magnitude*5, 0x00000002, MOD_FALLING );
			...
			{ 
				...
				if ( (hitEnt->s.eType == ET_PLAYER && hitEnt->s.number < 32) ||
				...
				{ 
					...
					{ 
						...
						((hitEnt->client->ps.velocity)[0]=(hitEnt->client->ps.velocity)[0]+(pm->ps->velocity)[0],(hitEnt->client->ps.velocity)[1]=(hitEnt->client->ps.velocity)[1]+(pm->ps->velocity)[1],(hitEnt->client->ps.velocity)[2]=(hitEnt->client->ps.velocity)[2]+(pm->ps->velocity)[2]);
				...
				G_Damage( hitEnt, attackEnt, attackEnt, ((void *)0), pm->ps->origin, finalD, 0, MOD_MELEE );
			}
...
#line 550 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
		}
	}
}
...
qboolean PM_ClientImpact( trace_t *trace )
{
	...
	if (
		(pm->ps->torsoAnim == BOTH_FORCEWALLRUNFLIP_START 
		|| pm->ps->torsoAnim == BOTH_FORCEWALLRUNFLIP_END 
		|| pm->ps->torsoAnim == BOTH_FORCEWALLRUNFLIP_ALT 
		)
		&& traceEnt->client 
		...
		if ((pm->ps->velocity[2] >= 100 || pm->ps->velocity[2] <= -100) && Q_irand(0,3)==2){
...

		{
			...
			((otherDir)[0]=(other->client->ps.origin)[0]-(ent->client->ps.origin)[0],(otherDir)[1]=(other->client->ps.origin)[1]-(ent->client->ps.origin)[1],(otherDir)[2]=(other->client->ps.origin)[2]-(ent->client->ps.origin)[2]);
			((entAngles)[0]=(ent->client->ps.viewangles)[0],(entAngles)[1]=(ent->client->ps.viewangles)[1],(entAngles)[2]=(ent->client->ps.viewangles)[2]);
			entAngles[1] = vectoyaw( otherDir );
			SetClientViewAngle( ent, entAngles );

			ent->client->ps.forceHandExtend = HANDEXTEND_PRETHROW;
			ent->client->ps.forceHandExtendTime = level.time + (3300+(1277* (1/ent->client->saber[0].damageScale * (other->client->saber[0].damageScale))));

			ent->client->throwingIndex = other->s.number;
			ent->client->doingThrow = level.time + (3300+(1277* (1/ent->client->saber[0].damageScale * (other->client->saber[0].damageScale))));
			ent->client->beingThrown = 0;
		
			((entDir)[0]=(ent->client->ps.origin)[0]-(other->client->ps.origin)[0],(entDir)[1]=(ent->client->ps.origin)[1]-(other->client->ps.origin)[1],(entDir)[2]=(ent->client->ps.origin)[2]-(other->client->ps.origin)[2]);
			((otherAngles)[0]=(other->client->ps.viewangles)[0],(otherAngles)[1]=(other->client->ps.viewangles)[1],(otherAngles)[2]=(other->client->ps.viewangles)[2]);
			otherAngles[1] = vectoyaw( entDir );
			SetClientViewAngle( other, otherAngles );

			other->client->ps.forceHandExtend = HANDEXTEND_PRETHROWN;
			other->client->ps.forceHandExtendTime = level.time + (3300+(1277* (1/ent->client->saber[0].damageScale * (other->client->saber[0].damageScale))));

			other->client->throwingIndex = ent->s.number;
			other->client->beingThrown = level.time + (3300+(1277* (1/ent->client->saber[0].damageScale * (other->client->saber[0].damageScale))));
			...
			((tAngles)[0]=(tAngles)[1]=(tAngles)[2]=0);
			tAngles[1] = ent->client->ps.viewangles[1];
			((pBoltOrg)[0]=(ent->client->ps.origin)[0],(pBoltOrg)[1]=(ent->client->ps.origin)[1],(pBoltOrg)[2]=(ent->client->ps.origin)[2]);
			...
			((other->client->ps.velocity)[0]=(other->client->ps.velocity)[1]=(other->client->ps.velocity)[2]=0);
				...
				&& (Q_irand(0,10) < (other->client->ps.iModelScale/12.0f)) )
			{
				...
				if (ent->client 
					...
					if (ent->client->sess.admin_number >= 5){
						...
						((oppDir)[0]=(other->client->ps.origin)[0]-(ent->client->ps.origin)[0],(oppDir)[1]=(other->client->ps.origin)[1]-(ent->client->ps.origin)[1],(oppDir)[2]=(other->client->ps.origin)[2]-(ent->client->ps.origin)[2]);
						...
						((oppDir)[0]=(ent->client->ps.origin)[0]-(other->client->ps.origin)[0],(oppDir)[1]=(ent->client->ps.origin)[1]-(other->client->ps.origin)[1],(oppDir)[2]=(ent->client->ps.origin)[2]-(other->client->ps.origin)[2]);
						VectorNormalize(oppDir);
				...
				((other->client->ps.origin)[0]=(intendedOrigin)[0],(other->client->ps.origin)[1]=(intendedOrigin)[1],(other->client->ps.origin)[2]=(intendedOrigin)[2]);
		...
		G_SetAnim(other, ((void *)0), 1|2, 894, 3, 0);
	...
	if (
		...
		traceEnt->client->ps.forceHandExtendTime = level.time + 300;
		return qfalse;

	}else if (		(pm->ps->legsAnim == 894 
		|| pm->ps->legsAnim == 1243 
		)&& traceEnt->client 
		&& traceEnt->client->ps.torsoAnim == FACE_SMILE){
...
#line 1106 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
...
qboolean	PM_SlideMove( qboolean gravity ) {
	...
	((primal_velocity)[0]=(pm->ps->velocity)[0],(primal_velocity)[1]=(pm->ps->velocity)[1],(primal_velocity)[2]=(pm->ps->velocity)[2]);

	if ( gravity ) {
		((endVelocity)[0]=(pm->ps->velocity)[0],(endVelocity)[1]=(pm->ps->velocity)[1],(endVelocity)[2]=(pm->ps->velocity)[2]);
	...
	if ( pml.groundPlane ) {
		numplanes = 1;
		((planes[0])[0]=(pml.groundTrace.plane.normal)[0],(planes[0])[1]=(pml.groundTrace.plane.normal)[1],(planes[0])[2]=(pml.groundTrace.plane.normal)[2]);
	...
	for ( bumpcount=0 ; bumpcount < numbumps ; bumpcount++ ) {
		...
		((end)[0]=(pm->ps->origin)[0]+(pm->ps->velocity)[0]*(time_left),(end)[1]=(pm->ps->origin)[1]+(pm->ps->velocity)[1]*(time_left),(end)[2]=(pm->ps->origin)[2]+(pm->ps->velocity)[2]*(time_left));
		...
		if (trace.fraction > 0) {
			...
			((pm->ps->origin)[0]=(trace.endpos)[0],(pm->ps->origin)[1]=(trace.endpos)[1],(pm->ps->origin)[2]=(trace.endpos)[2]);
...
#line 1228 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
		...
		((normal)[0]=(trace.plane.normal)[0],(normal)[1]=(trace.plane.normal)[1],(normal)[2]=(trace.plane.normal)[2]);
		...
		if ( !PM_GroundSlideOkay( normal[2] ) )
		{
			...
			for ( i = 0 ; i < numplanes ; i++ ) {
				if ( VectorCompare( normal, planes[i] ) ) {
					((pm->ps->velocity)[0]=(normal)[0]+(pm->ps->velocity)[0],(pm->ps->velocity)[1]=(normal)[1]+(pm->ps->velocity)[1],(pm->ps->velocity)[2]=(normal)[2]+(pm->ps->velocity)[2]);
					break;
				}
			}
			if ( i < numplanes ) {
		...
		((planes[numplanes])[0]=(normal)[0],(planes[numplanes])[1]=(normal)[1],(planes[numplanes])[2]=(normal)[2]);
		numplanes++;
		...
		for ( i = 0 ; i < numplanes ; i++ ) {
			...
			PM_ClipVelocity (pm->ps->velocity, planes[i], clipVelocity, 1.001f );

			
			PM_ClipVelocity (endVelocity, planes[i], endClipVelocity, 1.001f );
			...
			for ( j = 0 ; j < numplanes ; j++ ) {
				...
				if ( ((clipVelocity)[0]*(planes[j])[0]+(clipVelocity)[1]*(planes[j])[1]+(clipVelocity)[2]*(planes[j])[2]) >= 0.1 ) {
					continue;		
				}

				
				PM_ClipVelocity( clipVelocity, planes[j], clipVelocity, 1.001f );
				PM_ClipVelocity( endClipVelocity, planes[j], endClipVelocity, 1.001f );

				
				if ( ((clipVelocity)[0]*(planes[i])[0]+(clipVelocity)[1]*(planes[i])[1]+(clipVelocity)[2]*(planes[i])[2]) >= 0 ) {
					continue;
				}
				...
				((clipVelocity)[0]=(dir)[0]*(d),(clipVelocity)[1]=(dir)[1]*(d),(clipVelocity)[2]=(dir)[2]*(d));

				CrossProduct (planes[i], planes[j], dir);
				VectorNormalize( dir );
				d = ((dir)[0]*(endVelocity)[0]+(dir)[1]*(endVelocity)[1]+(dir)[2]*(endVelocity)[2]);
				((endClipVelocity)[0]=(dir)[0]*(d),(endClipVelocity)[1]=(dir)[1]*(d),(endClipVelocity)[2]=(dir)[2]*(d));
				...
				for ( k = 0 ; k < numplanes ; k++ ) {
					...
					if ( ((clipVelocity)[0]*(planes[k])[0]+(clipVelocity)[1]*(planes[k])[1]+(clipVelocity)[2]*(planes[k])[2]) >= 0.1 ) {
						continue;		
					}
			...
			((pm->ps->velocity)[0]=(clipVelocity)[0],(pm->ps->velocity)[1]=(clipVelocity)[1],(pm->ps->velocity)[2]=(clipVelocity)[2]);
			((endVelocity)[0]=(endClipVelocity)[0],(endVelocity)[1]=(endClipVelocity)[1],(endVelocity)[2]=(endClipVelocity)[2]);
			break;
		}
	}

	if ( gravity ) {
		((pm->ps->velocity)[0]=(endVelocity)[0],(pm->ps->velocity)[1]=(endVelocity)[1],(pm->ps->velocity)[2]=(endVelocity)[2]);
	}

	
	if ( pm->ps->pm_time ) {
		((pm->ps->velocity)[0]=(primal_velocity)[0],(pm->ps->velocity)[1]=(primal_velocity)[1],(pm->ps->velocity)[2]=(primal_velocity)[2]);
	}
...
void PM_StepSlideMove( qboolean gravity ) { 
	...
	((start_o)[0]=(pm->ps->origin)[0],(start_o)[1]=(pm->ps->origin)[1],(start_o)[2]=(pm->ps->origin)[2]);
	((start_v)[0]=(pm->ps->velocity)[0],(start_v)[1]=(pm->ps->velocity)[1],(start_v)[2]=(pm->ps->velocity)[2]);
	...
	((down)[0]=(start_o)[0],(down)[1]=(start_o)[1],(down)[2]=(start_o)[2]);
	down[2] -= 18;
	pm->trace (&trace, start_o, pm->mins, pm->maxs, down, pm->ps->clientNum, pm->tracemask);
	((up)[0]=(0), (up)[1]=(0), (up)[2]=(1));
	
	if ( pm->ps->velocity[2] > 0 && (trace.fraction == 1.0 ||
										((trace.plane.normal)[0]*(up)[0]+(trace.plane.normal)[1]*(up)[1]+(trace.plane.normal)[2]*(up)[2]) < 0.7))
	{
		return;
	}

	((down_o)[0]=(pm->ps->origin)[0],(down_o)[1]=(pm->ps->origin)[1],(down_o)[2]=(pm->ps->origin)[2]);
	((down_v)[0]=(pm->ps->velocity)[0],(down_v)[1]=(pm->ps->velocity)[1],(down_v)[2]=(pm->ps->velocity)[2]);

	((up)[0]=(start_o)[0],(up)[1]=(start_o)[1],(up)[2]=(start_o)[2]);
	...
	((pm->ps->origin)[0]=(trace.endpos)[0],(pm->ps->origin)[1]=(trace.endpos)[1],(pm->ps->origin)[2]=(trace.endpos)[2]);
	((pm->ps->velocity)[0]=(start_v)[0],(pm->ps->velocity)[1]=(start_v)[1],(pm->ps->velocity)[2]=(start_v)[2]);
	...
	if ( pm->stepSlideFix )
	{
			...
			&& trace.plane.normal[2] < 0.7f )
		{
			...
			((stepVec)[0]=(trace.endpos)[0]-(down_o)[0],(stepVec)[1]=(trace.endpos)[1]-(down_o)[1],(stepVec)[2]=(trace.endpos)[2]-(down_o)[2]);
			VectorNormalize( stepVec ); 
			if ( stepVec[2] > (1.0f-0.7f) )
			{
				skipStep = qtrue;
			}
		}
	...
	{ 
			...
			&& pEnt->s.NPC_class == CLASS_RANCOR )
		{
			if ( pm->stepSlideFix )
			{
				((pm->ps->origin)[0]=(down_o)[0],(pm->ps->origin)[1]=(down_o)[1],(pm->ps->origin)[2]=(down_o)[2]);
				((pm->ps->velocity)[0]=(down_v)[0],(pm->ps->velocity)[1]=(down_v)[1],(pm->ps->velocity)[2]=(down_v)[2]);
			}
			else
			{
				((pm->ps->origin)[0]=(start_o)[0],(pm->ps->origin)[1]=(start_o)[1],(pm->ps->origin)[2]=(start_o)[2]);
				((pm->ps->velocity)[0]=(start_v)[0],(pm->ps->velocity)[1]=(start_v)[1],(pm->ps->velocity)[2]=(start_v)[2]);
			}
		}
		...
		else
		{
			...
			if ( pm->stepSlideFix )
			{
				if ( trace.fraction < 1.0 ) {
					PM_ClipVelocity( pm->ps->velocity, trace.plane.normal, pm->ps->velocity, 1.001f );
				}
			}
		}
	}
...
#line 1548 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
	{
...
#line 1571 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_slidemove.c"
