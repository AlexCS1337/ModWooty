#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
...
#line 4 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
...
#line 5 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\q_shared.h"
...
#line 6 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
...
void ShieldGoSolid(gentity_t *self)
{
	...
	trap_Trace (&tr, self->r.currentOrigin, self->r.mins, self->r.maxs, self->r.currentOrigin, self->s.number, 0x00000100 );
	if(tr.startsolid)
	{	
...
void CreateShield(gentity_t *ent)
{
	...
	((end)[0]=(ent->r.currentOrigin)[0],(end)[1]=(ent->r.currentOrigin)[1],(end)[2]=(ent->r.currentOrigin)[2]);
	end[2] += 254;
	trap_Trace (&tr, ent->r.currentOrigin, ((void *)0), ((void *)0), end, ent->s.number, (0x00000001|0x00000100|0x00000200|0x00001000) );
	height = (int)(254 * tr.fraction);

	
	((mins)[0]=(-4), (mins)[1]=(-4), (mins)[2]=(0));
	((maxs)[0]=(4), (maxs)[1]=(4), (maxs)[2]=(height));
	((posTraceEnd)[0]=(ent->r.currentOrigin)[0],(posTraceEnd)[1]=(ent->r.currentOrigin)[1],(posTraceEnd)[2]=(ent->r.currentOrigin)[2]);
	((negTraceEnd)[0]=(ent->r.currentOrigin)[0],(negTraceEnd)[1]=(ent->r.currentOrigin)[1],(negTraceEnd)[2]=(ent->r.currentOrigin)[2]);

	if ((int)(ent->s.angles[1]) == 0) 
	{
		posTraceEnd[1]+=255;
		negTraceEnd[1]-=255;
		xaxis = qfalse;
	...
	start[2] += (height>>1);
	trap_Trace (&tr, start, 0, 0, posTraceEnd, ent->s.number, (0x00000001|0x00000100|0x00000200|0x00001000) );
	posWidth = 255 * tr.fraction;
	
	trap_Trace (&tr, start, 0, 0, negTraceEnd, ent->s.number, (0x00000001|0x00000100|0x00000200|0x00001000) );
	negWidth = 255 * tr.fraction;
	...
	if (xaxis)
	{
		((ent->r.mins)[0]=(-halfWidth), (ent->r.mins)[1]=(-4), (ent->r.mins)[2]=(-(height>>1)));
		((ent->r.maxs)[0]=(halfWidth), (ent->r.maxs)[1]=(4), (ent->r.maxs)[2]=(height>>1));
	}
	else
	{
		((ent->r.mins)[0]=(-4), (ent->r.mins)[1]=(-halfWidth), (ent->r.mins)[2]=(-(height>>1)));
		((ent->r.maxs)[0]=(4), (ent->r.maxs)[1]=(halfWidth), (ent->r.maxs)[2]=(height));
	}
	ent->clipmask = (0x00000001|0x00000100|0x00000200|0x00001000);
	...
	if ( g_gametype.integer == GT_SIEGE )
	{
		ent->health = ceil((float)(2000*1));
	}
	else
	{
		ent->health = ceil((float)(250*1));
	}
	...
	trap_Trace (&tr, ent->r.currentOrigin, ent->r.mins, ent->r.maxs, ent->r.currentOrigin, ent->s.number, 0x00000100 ); 
	...
	{	
		ent->r.contents = 0x00000010|0x00000080;
...
{
	static const gitem_t *shieldItem = ((void *)0);
	gentity_t	*shield = ((void *)0);
	trace_t		tr;
	...
	AngleVectors (playerent->client->ps.viewangles, fwd, ((void *)0), ((void *)0));
	fwd[2] = 0;
	((dest)[0]=(playerent->client->ps.origin)[0]+(fwd)[0]*(64),(dest)[1]=(playerent->client->ps.origin)[1]+(fwd)[1]*(64),(dest)[2]=(playerent->client->ps.origin)[2]+(fwd)[2]*(64));
	trap_Trace (&tr, playerent->client->ps.origin, mins, maxs, dest, playerent->s.number, (0x00000001|0x00000100|0x00000200|0x00001000) );
	if (tr.fraction > 0.9)
	{
		((pos)[0]=(tr.endpos)[0],(pos)[1]=(tr.endpos)[1],(pos)[2]=(tr.endpos)[2]);
		
		((dest)[0]=(pos[0]), (dest)[1]=(pos[1]), (dest)[2]=(pos[2] - 4096));
		trap_Trace( &tr, pos, mins, maxs, dest, playerent->s.number, (0x00000001|0x00001000) );
		if ( !tr.startsolid && !tr.allsolid )
		{
			...
			shield->s.modelindex =  HI_SHIELD;	
			shield->classname = shieldItem->classname;

			shield->r.contents = 0x00000400;
...

{
	...
	((myOrg)[0]=(ent->r.currentOrigin)[0],(myOrg)[1]=(ent->r.currentOrigin)[1],(myOrg)[2]=(ent->r.currentOrigin)[2]);
	myOrg[2] += 24;

	((enOrg)[0]=(ent->enemy->client->ps.origin)[0],(enOrg)[1]=(ent->enemy->client->ps.origin)[1],(enOrg)[2]=(ent->enemy->client->ps.origin)[2]);
	enOrg[2] += 24;

	((fwd)[0]=(enOrg)[0]-(myOrg)[0],(fwd)[1]=(enOrg)[1]-(myOrg)[1],(fwd)[2]=(enOrg)[2]-(myOrg)[2]);
	VectorNormalize(fwd);
...

{
	...
	int			count, i;
	float		bestDist = 800*800;
	float		enemyDist;
	vec3_t		enemyDir, org, org2;
	gentity_t	*entity_list[(1<<10)], *target;
	trace_t		tr;
	...
	((org2)[0]=(self->s.pos.trBase)[0],(org2)[1]=(self->s.pos.trBase)[1],(org2)[2]=(self->s.pos.trBase)[2]);

	count = G_RadiusList( org2, 800, self, qtrue, entity_list );
	...
	for ( i = 0; i < count; i++ )
	{
		...
		if ( target == self || !target->takedamage || target->health <= 0 || ( target->flags & 0x00000020 ))
		{
			continue;
		}
		...
		if ( target->client )
		{
			((org)[0]=(target->client->ps.origin)[0],(org)[1]=(target->client->ps.origin)[1],(org)[2]=(target->client->ps.origin)[2]);
		}
		else
		{
			((org)[0]=(target->r.currentOrigin)[0],(org)[1]=(target->r.currentOrigin)[1],(org)[2]=(target->r.currentOrigin)[2]);
		}

		trap_Trace( &tr, org2, ((void *)0), ((void *)0), org, self->s.number, (0x00000001|0x00000100|0x00000200|0x00001000) );

		if ( !tr.allsolid && !tr.startsolid && ( tr.fraction == 1.0 || tr.entityNum == target->s.number ))
		{
			
			((enemyDir)[0]=(target->r.currentOrigin)[0]-(self->r.currentOrigin)[0],(enemyDir)[1]=(target->r.currentOrigin)[1]-(self->r.currentOrigin)[1],(enemyDir)[2]=(target->r.currentOrigin)[2]-(self->r.currentOrigin)[2]);
			...
			if ( enemyDist < bestDist )
			{
				if ( self->attackDebounceTime + 100 < level.time )
				{
					...
					self->attackDebounceTime = level.time + 900 + ((rand () & 0x7fff) / ((float)0x7fff)) * 200;
				}
...

{
	...
	else
	{
		...
		((org2)[0]=(ent->s.pos.trBase)[0],(org2)[1]=(ent->s.pos.trBase)[1],(org2)[2]=(ent->s.pos.trBase)[2]);

		if ( ent->enemy->client )
		{
			((org)[0]=(ent->enemy->client->ps.origin)[0],(org)[1]=(ent->enemy->client->ps.origin)[1],(org)[2]=(ent->enemy->client->ps.origin)[2]);
			org[2] -= 15;
		}
		else
		{
		...
		trap_Trace( &tr, org2, ((void *)0), ((void *)0), org, ent->s.number, (0x00000001|0x00000100|0x00000200|0x00001000) );
	...
	else if ( ent->bounceCount < level.time && ent->enemy ) 
	{
		ent->enemy = ((void *)0);
		
		G_Sound( ent, CHAN_BODY, G_SoundIndex( "sound/chars/turret/shutdown.wav" ));
	
		ent->bounceCount = level.time + 500 + ((rand () & 0x7fff) / ((float)0x7fff)) * 150;
...

{
	...
	numListedEntities = trap_EntitiesInBox( testMins, testMaxs, iEntityList, (1<<10) );
	...
	while (i < numListedEntities)
	{
		...
		{ 
			...
			numListedEntities = trap_EntitiesInBox( g_entities[clNum].r.absmin, g_entities[clNum].r.absmax, iEntityList, (1<<10) );
	...
	if ((ent->genericValue8+60000) < level.time)
	{
		G_Sound( ent, CHAN_BODY, G_SoundIndex( "sound/chars/turret/shutdown.wav" ));
		ent->s.bolt2 = ((1<<10)-1);
		ent->s.fireflag = 2;
	...
	if ( ent->enemy )
	{
		...
		((enemyDir)[0]=(org)[0]-(ent->r.currentOrigin)[0],(enemyDir)[1]=(org)[1]-(ent->r.currentOrigin)[1],(enemyDir)[2]=(org)[2]-(ent->r.currentOrigin)[2]);
		vectoangles( enemyDir, desiredAngles );

		diffYaw = AngleSubtract( ent->speed, desiredAngles[1] );
		diffPitch = AngleSubtract( ent->random, desiredAngles[0] );
	}
	else
	{
	...
	((frontAngles)[0]=(-ent->random), (frontAngles)[1]=(0.0f), (frontAngles)[2]=(0.0f));
	((backAngles)[0]=(0.0f), (backAngles)[1]=(0.0f), (backAngles)[2]=(ent->speed));
...

{
	...
	((self->s.angles)[0]=(0), (self->s.angles)[1]=(0), (self->s.angles)[2]=(1));
...

{
	...
	((base->r.mins)[0]=(-8), (base->r.mins)[1]=(-8), (base->r.mins)[2]=(0));
	((base->r.maxs)[0]=(8), (base->r.maxs)[1]=(8), (base->r.maxs)[2]=(24));
...

{
	...
	yawonly[2] = 0;
	yawonly[0] = 0;
	yawonly[1] = ent->client->ps.viewangles[1];
	...
	sentry->s.modelindex = G_ModelIndex("models/items/psgun.glm"); 
	...
	sentry->parent = ent;
	sentry->r.contents = 0x00000001;
	sentry->s.solid = 2;
	sentry->clipmask = (0x00000001|0x00001000);
	((sentry->r.mins)[0]=(mins)[0],(sentry->r.mins)[1]=(mins)[1],(sentry->r.mins)[2]=(mins)[2]);
	((sentry->r.maxs)[0]=(maxs)[0],(sentry->r.maxs)[1]=(maxs)[1],(sentry->r.maxs)[2]=(maxs)[2]);
	sentry->genericValue3 = ent->s.number;
	sentry->genericValue2 = ent->client->sess.sessionTeam; 
	...
	sentry->genericValue4 = ent->client->lasthurt_client; 
...
void ItemUse_Seeker(gentity_t *ent)
{
	...
	{
		gentity_t *remote = NPC_SpawnType( ent, "remote", ((void *)0), qfalse );
...
void Jetpack_Off(gentity_t *ent)
{ 
	(void)( (!!(ent && ent->client)) || (_wassert(L"ent && ent->client", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c", 1167), 0) );
...
void Jetpack_On(gentity_t *ent)
{ 
	(void)( (!!(ent && ent->client)) || (_wassert(L"ent && ent->client", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c", 1179), 0) );
...
void ItemUse_Jetpack( gentity_t *ent )
{
	(void)( (!!(ent && ent->client)) || (_wassert(L"ent && ent->client", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c", 1203), 0) );
	...
	ent->client->jetPackToggleTime = level.time + 1000;
}
...
void ItemUse_UseCloak( gentity_t *ent )
{
	(void)( (!!(ent && ent->client)) || (_wassert(L"ent && ent->client", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c", 1241), 0) );
	...
	ent->client->cloakToggleTime = level.time + 1000;
}
...
void SpecialItemThink(gentity_t *ent)
{
	...
	G_RunExPhys(ent, gravity, mass, bounce, qfalse, ((void *)0), 0);
	((ent->s.origin)[0]=(ent->r.currentOrigin)[0],(ent->s.origin)[1]=(ent->r.currentOrigin)[1],(ent->s.origin)[2]=(ent->r.currentOrigin)[2]);
	ent->nextthink = level.time + 50;
}
...
void G_SpecialSpawnItem(gentity_t *ent, gitem_t *item)
{
	...
	ent->genericValue5 = level.time + 20000;
	ent->think = SpecialItemThink;
	ent->nextthink = level.time + 50;
	ent->clipmask = (0x00000001|0x00001000);

	ent->physicsBounce = 0.50;		
	((ent->r.mins)[0]=(-8), (ent->r.mins)[1]=(-8), (ent->r.mins)[2]=(-0));
	((ent->r.maxs)[0]=(8), (ent->r.maxs)[1]=(8), (ent->r.maxs)[2]=(16));

	ent->s.eType = ET_ITEM;
	ent->s.modelindex = ent->item - bg_itemlist;		

	ent->r.contents = 0x00000400;
	ent->touch = Touch_Item;

	
	ent->genericValue11 = ent->r.ownerNum;
	ent->genericValue10 = level.time + 1000;
...
void G_PrecacheDispensers(void)
{
	...
	item = BG_FindItem("item_medpak_instant");
	if (item)
	{
		RegisterItem(item);
	}

	item = BG_FindItem("ammo_all");
	if (item)
	{
		RegisterItem(item);
	}
...
void ItemUse_UseDisp(gentity_t *ent, int type)
{
	...
	ent->client->tossableItemDebounce = level.time + 5000;
	...
	if (item)
	{
		...
		((pos)[0]=(ent->client->ps.origin)[0],(pos)[1]=(ent->client->ps.origin)[1],(pos)[2]=(ent->client->ps.origin)[2]);
		pos[2] += ent->client->ps.viewheight;

		G_SetOrigin(eItem, pos);
		((eItem->s.origin)[0]=(eItem->r.currentOrigin)[0],(eItem->s.origin)[1]=(eItem->r.currentOrigin)[1],(eItem->s.origin)[2]=(eItem->r.currentOrigin)[2]);
		trap_LinkEntity(eItem);

		G_SpecialSpawnItem(eItem, item);

		AngleVectors(ent->client->ps.viewangles, fwd, ((void *)0), ((void *)0));
		((eItem->epVelocity)[0]=(fwd)[0]*(128.0f),(eItem->epVelocity)[1]=(fwd)[1]*(128.0f),(eItem->epVelocity)[2]=(fwd)[2]*(128.0f));
...
#line 1446 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
extern void BG_CycleInven(playerState_t *ps, int direction); 
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\namespace_end.h"
...
#line 1448 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
...
void EWeb_SetBoneAngles(gentity_t *ent, char *bone, vec3_t angles)
{
	...
	int *firstFree = ((void *)0);
#line 1508 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
	int i = 0;
	int boneIndex = G_BoneIndex(bone);
	int flags, up, right, forward;
	vec3_t *boneVector = &ent->s.boneAngles1;
	vec3_t *freeBoneVec = ((void *)0);
	...
	((*boneVector)[0]=(angles)[0],(*boneVector)[1]=(angles)[1],(*boneVector)[2]=(angles)[2]);
...
void EWeb_SetBoneAnim(gentity_t *eweb, int startFrame, int endFrame)
{
	...
	(void)( (!!(eweb->ghoul2)) || (_wassert(L"eweb->ghoul2", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c", 1617), 0) );
	trap_G2API_SetBoneAnim(eweb->ghoul2, 0, "model_root", startFrame, endFrame,
		(( 0x0040 + 0x0008 )|0x0080), 1.0f, level.time, -1, 100);
}
...
void EWebFire(gentity_t *owner, gentity_t *eweb)
{
	...
	{ 
		(void)( (!!(!"Bad e-web bolt")) || (_wassert(L"!\"Bad e-web bolt\"", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c", 1632), 0) );
		return;
	}

	
	trap_G2API_GetBoltMatrix(eweb->ghoul2, 0, eweb->genericValue10, &boltMatrix, eweb->s.apos.trBase, eweb->r.currentOrigin, level.time, ((void *)0), eweb->modelScale);
	BG_GiveMeVectorFromMatrix(&boltMatrix, ORIGIN, p);
	BG_GiveMeVectorFromMatrix(&boltMatrix, NEGATIVE_Y, d);

	
	((bPoint)[0]=(p)[0]+(d)[0]*(-16.0f),(bPoint)[1]=(p)[1]+(d)[1]*(-16.0f),(bPoint)[2]=(p)[2]+(d)[2]*(-16.0f));
...
void EWebPositionUser(gentity_t *owner, gentity_t *eweb)
{
	...
	trap_G2API_GetBoltMatrix(eweb->ghoul2, 0, eweb->genericValue9, &boltMatrix, eweb->s.apos.trBase, eweb->r.currentOrigin, level.time, ((void *)0), eweb->modelScale);
	BG_GiveMeVectorFromMatrix(&boltMatrix, ORIGIN, p);
	BG_GiveMeVectorFromMatrix(&boltMatrix, NEGATIVE_X, d);

	((p)[0]=(p)[0]+(d)[0]*(32.0f),(p)[1]=(p)[1]+(d)[1]*(32.0f),(p)[2]=(p)[2]+(d)[2]*(32.0f));
	p[2] = eweb->r.currentOrigin[2];

	p[2] += 4.0f;

	trap_Trace(&tr, owner->client->ps.origin, owner->r.mins, owner->r.maxs, p, owner->s.number, (0x00000001|0x00000010|0x00000100|0x00001000));

	if (!tr.startsolid && !tr.allsolid && tr.fraction == 1.0f)
	{ 
		vec3_t pDown;

		((pDown)[0]=(p)[0],(pDown)[1]=(p)[1],(pDown)[2]=(p)[2]);
		pDown[2] -= 7.0f;
		trap_Trace(&tr, p, owner->r.mins, owner->r.maxs, pDown, owner->s.number, (0x00000001|0x00000010|0x00000100|0x00001000));

		if (!tr.startsolid && !tr.allsolid)
		{
			((d)[0]=(owner->client->ps.origin)[0]-(tr.endpos)[0],(d)[1]=(owner->client->ps.origin)[1]-(tr.endpos)[1],(d)[2]=(owner->client->ps.origin)[2]-(tr.endpos)[2]);
			...
			{ 
				...
				vectoangles(d, dAng);
				dAng[1] = AngleSubtract(owner->client->ps.viewangles[1], dAng[1]);
				if (dAng[1] > 0.0f)
				{
					...
					G_SetAnim(owner, &owner->client->pers.cmd, 2, BOTH_STRAFE_LEFT1, aFlags, 0);
				}
				else
				{
					...
					G_SetAnim(owner, &owner->client->pers.cmd, 2, BOTH_STRAFE_RIGHT1, aFlags, 0);
				}
			}
			...
			((owner->client->ps.origin)[0]=(tr.endpos)[0],(owner->client->ps.origin)[1]=(tr.endpos)[1],(owner->client->ps.origin)[2]=(tr.endpos)[2]);
		}
	}
	else
	{ 
...
void EWebUpdateBoneAngles(gentity_t *owner, gentity_t *eweb)
{
	...
	float ideal;
	float incr;
	const float turnCap = 4.0f; 
	
	((yAng)[0]=(yAng)[1]=(yAng)[2]=0);
	ideal = AngleSubtract(owner->client->ps.viewangles[1], eweb->s.angles[1]);
	...
	((yAng)[0]=(yAng)[1]=(yAng)[2]=0);
	yAng[2] = AngleSubtract(owner->client->ps.viewangles[0], eweb->s.angles[0])*0.8f;
...
#line 1773 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
...
#line 1775 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_items.c"
...
void EWebThink(gentity_t *self)
{
	...
	else
	{
		...
		if (!killMe)
		{
			...
			{
				owner->client->ps.viewangles[1] = yaw;
			}
			...
			{ 
				...
				if (owner->client->pers.cmd.buttons & 1)
				{
	...
	G_RunExPhys(self, gravity, mass, bounce, qfalse, ((void *)0), 0);
...
gentity_t *EWeb_Create(gentity_t *spawner)
{
	...
	((mins)[0]=(-32), (mins)[1]=(-32), (mins)[2]=(-24));
	((maxs)[0]=(32), (maxs)[1]=(32), (maxs)[2]=(24));

	((fAng)[0]=(0), (fAng)[1]=(spawner->client->ps.viewangles[1]), (fAng)[2]=(0));
	AngleVectors(fAng, fwd, 0, 0);

	((s)[0]=(spawner->client->ps.origin)[0],(s)[1]=(spawner->client->ps.origin)[1],(s)[2]=(spawner->client->ps.origin)[2]);
	
	s[2] += 12.0f;

	((pos)[0]=(s)[0]+(fwd)[0]*(48.0f),(pos)[1]=(s)[1]+(fwd)[1]*(48.0f),(pos)[2]=(s)[2]+(fwd)[2]*(48.0f));

	trap_Trace(&tr, s, mins, maxs, pos, spawner->s.number, (0x00000001|0x00000010|0x00000100|0x00001000));
	...
	ent->clipmask = (0x00000001|0x00000010|0x00000100|0x00001000);
	ent->r.contents = (0x00000001|0x00000010|0x00000100|0x00001000);
	...
	((downPos)[0]=(pos)[0],(downPos)[1]=(pos)[1],(downPos)[2]=(pos)[2]);
	downPos[2] -= 18.0f;
	trap_Trace(&tr, pos, mins, maxs, downPos, spawner->s.number, (0x00000001|0x00000010|0x00000100|0x00001000));

	if (tr.startsolid || tr.allsolid || tr.fraction == 1.0f || tr.entityNum < ((1<<10)-2))
	{ 
		G_FreeEntity(ent);
		G_Sound(spawner, CHAN_AUTO, failSound);
		return ((void *)0);
	...
	((ent->s.apos.trBase)[0]=(fAng)[0],(ent->s.apos.trBase)[1]=(fAng)[1],(ent->s.apos.trBase)[2]=(fAng)[2]);
	((ent->r.currentAngles)[0]=(fAng)[0],(ent->r.currentAngles)[1]=(fAng)[1],(ent->r.currentAngles)[2]=(fAng)[2]);
	...
	ent->genericValue10 = trap_G2API_AddBolt(ent->ghoul2, 0, "*cannonflash"); 
	ent->genericValue9 = trap_G2API_AddBolt(ent->ghoul2, 0, "cannon_Yrot"); 

	
	ent->s.origin2[0] = 360.0f; 

	((ent->s.angles)[0]=(fAng)[0],(ent->s.angles)[1]=(fAng)[1],(ent->s.angles)[2]=(fAng)[2]); 
	...
	((ent->r.mins)[0]=(mins)[0],(ent->r.mins)[1]=(mins)[1],(ent->r.mins)[2]=(mins)[2]);
	((ent->r.maxs)[0]=(maxs)[0],(ent->r.maxs)[1]=(maxs)[1],(ent->r.maxs)[2]=(maxs)[2]);
...
void ItemUse_UseEWeb(gentity_t *ent)
{
	...
	ent->client->ewebTime = level.time + 1000;
}
...
int Pickup_Powerup( gentity_t *ent, gentity_t *other ) {
	...
	for ( i = 0 ; i < level.maxclients ; i++ ) {
      ...
      continue;
		...
		((delta)[0]=(ent->s.pos.trBase)[0]-(client->ps.origin)[0],(delta)[1]=(ent->s.pos.trBase)[1]-(client->ps.origin)[1],(delta)[2]=(ent->s.pos.trBase)[2]-(client->ps.origin)[2]);
		...
		if ( ((delta)[0]*(forward)[0]+(delta)[1]*(forward)[1]+(delta)[2]*(forward)[2]) < 0.4 ) {
			continue;
		}

		
		trap_Trace( &tr, client->ps.origin, ((void *)0), ((void *)0), ent->s.pos.trBase, ((1<<10)-1), 0x00000001 );
		if ( tr.fraction != 1.0 ) {
			continue;
		}

		
		client->ps.persistant[PERS_PLAYEREVENTS] ^= 0x0001;
	}
	return 120;
}
...
int Pickup_Holdable( gentity_t *ent, gentity_t *other ) {
	...
	return adjustRespawnTime(60, ent->item->giType, ent->item->giTag);
}
...
int Pickup_Ammo (gentity_t *ent, gentity_t *other)
{
	...
	return adjustRespawnTime(40, ent->item->giType, ent->item->giTag);
}
...
int Pickup_Weapon (gentity_t *ent, gentity_t *other) {
	...
	if ( ent->count < 0 ) {
		...
		if ( ! (ent->flags & 0x00001000) && g_gametype.integer != GT_TEAM ) {
	...
	if ( g_gametype.integer == GT_TEAM ) 
	{
		return adjustRespawnTime(30, ent->item->giType, ent->item->giTag);
	}
...
int Pickup_Armor( gentity_t *ent, gentity_t *other ) 
{
	...
	return adjustRespawnTime(20, ent->item->giType, ent->item->giTag);
}
...
{
	if ( (item->flags&0x00001000) 
		&& item->activator != &g_entities[0] 
		&& pickerupper->s.number 
		
		&& pickerupper->enemy 
		&& pickerupper->painDebounceTime < level.time
		&& pickerupper->NPC && pickerupper->NPC->surrenderTime < level.time 
		&& !(pickerupper->NPC->scriptFlags&0x00010000) 
		 )
	{
...
void Touch_Item (gentity_t *ent, gentity_t *other, trace_t *trace) {
		...
		(ent->item->giTag == PW_FORCE_ENLIGHTENED_LIGHT || ent->item->giTag == PW_FORCE_ENLIGHTENED_DARK))
	{
		...
		{
			if (other->client->ps.fd.forceSide != 1)
			{
				return;
			}
		}
		...
		{
			if (other->client->ps.fd.forceSide != 2)
			{
				return;
			}
		}
	...
	if ( ent->random ) {
		respawn += (2.0 * (((rand () & 0x7fff) / ((float)0x7fff)) - 0.5)) * ent->random;
		if ( respawn < 1 ) {
			respawn = 1;
		}
	}
	...
	if (!(ent->flags & 0x00001000) && (ent->item->giType==IT_WEAPON || ent->item->giType==IT_POWERUP))
	{
		ent->s.eFlags |= (1<<23);
		ent->s.eFlags &= ~(1<<8);
	}
...
gentity_t *LaunchItem( gitem_t *item, vec3_t origin, vec3_t velocity ) {
	...
	dropped->item = item;
	((dropped->r.mins)[0]=(-15), (dropped->r.mins)[1]=(-15), (dropped->r.mins)[2]=(-15));
	((dropped->r.maxs)[0]=(15), (dropped->r.maxs)[1]=(15), (dropped->r.maxs)[2]=(15));

	dropped->r.contents = 0x00000400;
	...
	((dropped->s.pos.trDelta)[0]=(velocity)[0],(dropped->s.pos.trDelta)[1]=(velocity)[1],(dropped->s.pos.trDelta)[2]=(velocity)[2]);

	dropped->flags |= 0x00200000;
	if ((g_gametype.integer == GT_CTF || g_gametype.integer == GT_CTY) && item->giType == IT_TEAM) { 
...
gentity_t *Drop_Item( gentity_t *ent, gitem_t *item, float angle ) {
	...
	((angles)[0]=(ent->s.apos.trBase)[0],(angles)[1]=(ent->s.apos.trBase)[1],(angles)[2]=(ent->s.apos.trBase)[2]);
	angles[1] += angle;
	angles[0] = 0;	

	AngleVectors( angles, velocity, ((void *)0), ((void *)0) );
	((velocity)[0]=(velocity)[0]*(150),(velocity)[1]=(velocity)[1]*(150),(velocity)[2]=(velocity)[2]*(150));
	velocity[2] += 200 + (2.0 * (((rand () & 0x7fff) / ((float)0x7fff)) - 0.5)) * 50;
...
void FinishSpawningItem( gentity_t *ent ) {
	...
	if ( ent->spawnflags & 1 ) {
		...
		((dest)[0]=(ent->s.origin[0]), (dest)[1]=(ent->s.origin[1]), (dest)[2]=(ent->s.origin[2] - 4096));
		trap_Trace( &tr, ent->s.origin, ent->r.mins, ent->r.maxs, dest, ent->s.number, (0x00000001|0x00001000) );
		if ( tr.startsolid ) {
	...
	if ( ( ent->flags & 0x00000400 ) || ent->targetname ) {
		ent->s.eFlags |= (1<<8);
		ent->r.contents = 0;
		return;
	}
...
void G_CheckTeamItems( void ) {
	...
	if( g_gametype.integer == GT_CTF || g_gametype.integer == GT_CTY ) {
		...
		if ( !item || !itemRegistered[ item - bg_itemlist ] ) {
			G_Printf( "^3" "WARNING: No team_CTF_redflag in map" );
		}
		item = BG_FindItem( "team_CTF_blueflag" );
		if ( !item || !itemRegistered[ item - bg_itemlist ] ) {
			G_Printf( "^3" "WARNING: No team_CTF_blueflag in map" );
		}
	}
}
...
void SaveRegisteredItems( void ) {
	...
	trap_SetConfigstring(27, string);
}
...
void G_BounceItem( gentity_t *ent, trace_t *trace ) {
	...
	dot = ((velocity)[0]*(trace->plane.normal)[0]+(velocity)[1]*(trace->plane.normal)[1]+(velocity)[2]*(trace->plane.normal)[2]);
	((ent->s.pos.trDelta)[0]=(velocity)[0]+(trace->plane.normal)[0]*(-2*dot),(ent->s.pos.trDelta)[1]=(velocity)[1]+(trace->plane.normal)[1]*(-2*dot),(ent->s.pos.trDelta)[2]=(velocity)[2]+(trace->plane.normal)[2]*(-2*dot));

	
	((ent->s.pos.trDelta)[0]=(ent->s.pos.trDelta)[0]*(ent->physicsBounce),(ent->s.pos.trDelta)[1]=(ent->s.pos.trDelta)[1]*(ent->physicsBounce),(ent->s.pos.trDelta)[2]=(ent->s.pos.trDelta)[2]*(ent->physicsBounce));
	...
	((ent->r.currentOrigin)[0]=(ent->r.currentOrigin)[0]+(trace->plane.normal)[0],(ent->r.currentOrigin)[1]=(ent->r.currentOrigin)[1]+(trace->plane.normal)[1],(ent->r.currentOrigin)[2]=(ent->r.currentOrigin)[2]+(trace->plane.normal)[2]);
...
void G_RunItem( gentity_t *ent ) {
	...
	if ( ent->clipmask ) {
		...
		mask = (0x00000001|0x00000010|0x00000100|0x00001000) & ~0x00000100;
	}
	trap_Trace( &tr, ent->r.currentOrigin, ent->r.mins, ent->r.maxs, origin, 
		ent->r.ownerNum, mask );

	((ent->r.currentOrigin)[0]=(tr.endpos)[0],(ent->r.currentOrigin)[1]=(tr.endpos)[1],(ent->r.currentOrigin)[2]=(tr.endpos)[2]);
