...
#line 13 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"

stringID_table_t TeamTable[] =
{
	"NPCTEAM_FREE",NPCTEAM_FREE,			
	"NPCTEAM_PLAYER",NPCTEAM_PLAYER,
	"NPCTEAM_ENEMY",NPCTEAM_ENEMY,
	"NPCTEAM_NEUTRAL",NPCTEAM_NEUTRAL,	
	"",	-1
};
...
stringID_table_t ClassTable[] =
{
	...
	"CLASS_ATST",CLASS_ATST,				
	"CLASS_BARTENDER",CLASS_BARTENDER,
	"CLASS_BESPIN_COP",CLASS_BESPIN_COP,		
	"CLASS_CLAW",CLASS_CLAW,
	"CLASS_COMMANDO",CLASS_COMMANDO,
	"CLASS_DESANN",CLASS_DESANN,			
	"CLASS_FISH",CLASS_FISH,
	"CLASS_FLIER2",CLASS_FLIER2,
	"CLASS_GALAK",CLASS_GALAK,
	"CLASS_GLIDER",CLASS_GLIDER,
	"CLASS_GONK",CLASS_GONK,				
	"CLASS_GRAN",CLASS_GRAN,
	"CLASS_HOWLER",CLASS_HOWLER,

	"CLASS_IMPERIAL",CLASS_IMPERIAL,
	"CLASS_IMPWORKER",CLASS_IMPWORKER,
	"CLASS_INTERROGATOR",CLASS_INTERROGATOR,		
	"CLASS_JAN",CLASS_JAN,				
	"CLASS_JEDI",CLASS_JEDI,				
	"CLASS_KYLE",CLASS_KYLE,
	"CLASS_LANDO",CLASS_LANDO,			
	"CLASS_LIZARD",CLASS_LIZARD,
	"CLASS_LUKE",CLASS_LUKE,				
	"CLASS_MARK1",CLASS_MARK1,			
	"CLASS_MARK2",CLASS_MARK2,			
	"CLASS_GALAKMECH",CLASS_GALAKMECH,		
	"CLASS_MINEMONSTER",CLASS_MINEMONSTER,
	"CLASS_MONMOTHA",CLASS_MONMOTHA,			
	"CLASS_MORGANKATARN",CLASS_MORGANKATARN,
	"CLASS_MOUSE",CLASS_MOUSE,			
	"CLASS_MURJJ",CLASS_MURJJ,
	"CLASS_PRISONER",CLASS_PRISONER,
	"CLASS_PROBE",CLASS_PROBE,			
	"CLASS_PROTOCOL",CLASS_PROTOCOL,			
	"CLASS_R2D2",CLASS_R2D2,				
	"CLASS_R5D2",CLASS_R5D2,				
	"CLASS_REBEL",CLASS_REBEL,
	"CLASS_REBORN",CLASS_REBORN,
	"CLASS_REELO",CLASS_REELO,
	"CLASS_REMOTE",CLASS_REMOTE,
	"CLASS_RODIAN",CLASS_RODIAN,
	"CLASS_SEEKER",CLASS_SEEKER,			
	"CLASS_SENTRY",CLASS_SENTRY,
	"CLASS_SHADOWTROOPER",CLASS_SHADOWTROOPER,
	"CLASS_STORMTROOPER",CLASS_STORMTROOPER,
	"CLASS_SWAMP",CLASS_SWAMP,
	"CLASS_SWAMPTROOPER",CLASS_SWAMPTROOPER,
	"CLASS_TAVION",CLASS_TAVION,
	"CLASS_TRANDOSHAN",CLASS_TRANDOSHAN,
	"CLASS_UGNAUGHT",CLASS_UGNAUGHT,
	"CLASS_JAWA",CLASS_JAWA,
	"CLASS_WEEQUAY",CLASS_WEEQUAY,
	"CLASS_BOBAFETT",CLASS_BOBAFETT,
	
	
	"CLASS_VEHICLE",CLASS_VEHICLE,
	"CLASS_RANCOR",CLASS_RANCOR,
	"CLASS_WAMPA",CLASS_WAMPA,
	"",	-1
};
...
stringID_table_t BSTable[] =
{
	...
	"BS_ADVANCE_FIGHT",BS_ADVANCE_FIGHT,
	"BS_SLEEP",BS_SLEEP,
	"BS_FOLLOW_LEADER",BS_FOLLOW_LEADER,
	"BS_JUMP",BS_JUMP,
	"BS_SEARCH",BS_SEARCH,
	"BS_WANDER",BS_WANDER,
	"BS_NOCLIP",BS_NOCLIP,
	"BS_REMOVE",BS_REMOVE,
	"BS_CINEMATIC",BS_CINEMATIC,
...
{
	"BSET_SPAWN",BSET_SPAWN,
	"BSET_USE",BSET_USE,
	"BSET_AWAKE",BSET_AWAKE,
	"BSET_ANGER",BSET_ANGER,
	"BSET_ATTACK",BSET_ATTACK,
	"BSET_VICTORY",BSET_VICTORY,
	"BSET_LOSTENEMY",BSET_LOSTENEMY,
	"BSET_PAIN",BSET_PAIN,
	"BSET_FLEE",BSET_FLEE,
	"BSET_DEATH",BSET_DEATH,
	"BSET_DELAYED",BSET_DELAYED,
	"BSET_BLOCKED",BSET_BLOCKED,
	"BSET_BUMPED",BSET_BUMPED,
	"BSET_STUCK",BSET_STUCK,
	"BSET_FFIRE",BSET_FFIRE,
	"BSET_FFDEATH",BSET_FFDEATH,
	"", BSET_INVALID, "BSET_INVALID",BSET_INVALID,
	"",				-1,
};
...
#line 129 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
...
#line 132 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
...
#line 230 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
...
#line 232 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"





char	NPCParms[0x20000];
char	NPCFile[64];
...
#line 333 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
...
#line 335 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
...
{
	*animFileIndex = BG_ParseAnimationFile(filename, ((void *)0), qfalse);
...
#line 548 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
}
...
#line 592 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
}
...
void NPC_Precache ( gentity_t *spawner )
{
	...
	while ( 1 ) 
	{
		...
		if ( !token[0] ) 
		{
			Com_Printf( "^1""ERROR: unexpected EOF while parsing '%s'\n", spawner->NPC_type );
			return;
		}
		...
		if ( !Q_stricmp( token, "snd" ) ) {
			...
			if ( !(spawner->r.svFlags&0x10000000) )
			{
		...
		if ( !Q_stricmp( token, "sndcombat" ) ) {
			...
			if ( !(spawner->r.svFlags&0x20000000) )
			{
		...
		if ( !Q_stricmp( token, "sndextra" ) ) {
			...
			if ( !(spawner->r.svFlags&0x40000000) )
			{
...
#line 973 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
...
qboolean NPC_ParseParms( const char *NPCName, gentity_t *NPC ) 
{
	...
	if ( !NPC->s.number && NPC->client != ((void *)0) )
	{
		parsingPlayer = qtrue;
	}
	...
	((NPC->r.mins)[0]=(playerMins)[0],(NPC->r.mins)[1]=(playerMins)[1],(NPC->r.mins)[2]=(playerMins)[2]);
	((NPC->r.maxs)[0]=(playerMaxs)[0],(NPC->r.maxs)[1]=(playerMaxs)[1],(NPC->r.maxs)[2]=(playerMaxs)[2]);
	NPC->client->ps.crouchheight = 16;
	NPC->client->ps.standheight = 40;
	...
	else
	{
		...
		while ( 1 ) 
		{
			...
			if ( !Q_stricmp( token, "headYawRangeLeft" ) ) 
			{
				...
				if ( n < 0 ) 
				{
					Com_Printf( "^3""WARNING: bad %s in NPC '%s'\n", token, NPCName );
					continue;
				}
			...
			if ( !Q_stricmp( token, "class" ) ) 
			{
				...
				if ( NPC->client->NPC_class == CLASS_VEHICLE )
				{
					if ( !NPC->m_pVehicle )
					{
						Com_Printf ( "^1" "ERROR: Tried to spawn a vehicle NPC (%s) without using NPC_Vehicle or 'NPC spawn vehicle <vehiclename>'!!!  Bad, bad, bad!  Shame on you!\n", NPCName );
						return qfalse;
					}
					md3Model = qfalse;
				}
			...
			if ( !Q_stricmp( token, "height" ) ) 
			{
					...
					&& NPC->m_pVehicle->m_pVehicleInfo->type == VH_FIGHTER )
				{
					...
					NPC->s.origin[2] += (-24-NPC->r.mins[2])+0.125f;
					((NPC->client->ps.origin)[0]=(NPC->s.origin)[0],(NPC->client->ps.origin)[1]=(NPC->s.origin)[1],(NPC->client->ps.origin)[2]=(NPC->s.origin)[2]);
					((NPC->r.currentOrigin)[0]=(NPC->s.origin)[0],(NPC->r.currentOrigin)[1]=(NPC->s.origin)[1],(NPC->r.currentOrigin)[2]=(NPC->s.origin)[2]);
				...
				{
					NPC->r.mins[2] = -24;
					NPC->r.maxs[2] = NPC->client->ps.standheight = n + -24;
				}
				NPC->radius = n;
				continue;
			}
			...
			if ( !Q_stricmp( token, "crouchheight" ) ) 
			{
				...
				NPC->client->ps.crouchheight = n + -24;
				continue;
			}
			...
			if ( !parsingPlayer )
			{
				...
				if ( !Q_stricmp( token, "altFire" ) ) 
				{
					...
					if ( NPC->NPC )
					{
						if ( n != 0 )
						{
							NPC->NPC->scriptFlags |= 0x00000040;
						}
					}
					continue;
				}
...
char npcParseBuffer[0x20000];
#line 3243 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_stats.c"
