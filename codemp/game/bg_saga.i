#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
...
#line 13 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
...
#line 14 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
...
#line 15 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
...
#line 16 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
...
#line 21 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
...
char		siege_info[16384];
int			siege_valid = 0;

siegeTeam_t *team1Theme = ((void *)0);
siegeTeam_t *team2Theme = ((void *)0);

siegeClass_t bgSiegeClasses[128];
int bgNumSiegeClasses = 0;

siegeTeam_t bgSiegeTeams[16];
int bgNumSiegeTeams = 0;


stringID_table_t bgSiegeClassFlagNames[] =
{
	"CFL_MORESABERDMG",CFL_MORESABERDMG,
	"CFL_STRONGAGAINSTPHYSICAL",CFL_STRONGAGAINSTPHYSICAL,
	"CFL_FASTFORCEREGEN",CFL_FASTFORCEREGEN,
	"CFL_STATVIEWER",CFL_STATVIEWER,
	"CFL_HEAVYMELEE",CFL_HEAVYMELEE,
	"CFL_SINGLE_ROCKET",CFL_SINGLE_ROCKET,
	"CFL_CUSTOMSKEL",CFL_CUSTOMSKEL,
	"CFL_EXTRA_AMMO",CFL_EXTRA_AMMO,
	"", -1
};
...
stringID_table_t WPTable[] =
{
	...
	"WP_STUN_BATON",WP_STUN_BATON,
	"WP_MELEE",WP_MELEE,
	"WP_SABER",WP_SABER,
	"WP_BRYAR_PISTOL",WP_BRYAR_PISTOL,
	"WP_BLASTER_PISTOL", WP_BRYAR_PISTOL,
	"WP_BLASTER",WP_BLASTER,
	"WP_DISRUPTOR",WP_DISRUPTOR,
	"WP_BOWCASTER",WP_BOWCASTER,
	"WP_REPEATER",WP_REPEATER,
	"WP_DEMP2",WP_DEMP2,
	"WP_FLECHETTE",WP_FLECHETTE,
	"WP_ROCKET_LAUNCHER",WP_ROCKET_LAUNCHER,
	"WP_THERMAL",WP_THERMAL,
	"WP_TRIP_MINE",WP_TRIP_MINE,
	"WP_DET_PACK",WP_DET_PACK,
	"WP_CONCUSSION",WP_CONCUSSION,
	"WP_BRYAR_OLD",WP_BRYAR_OLD,
	"WP_EMPLACED_GUN",WP_EMPLACED_GUN,
	"WP_TURRET",WP_TURRET,
	"", 0
};
...
stringID_table_t FPTable[] =
{
	...
	"FP_ABSORB",FP_ABSORB,
	"FP_TEAM_HEAL",FP_TEAM_HEAL,
	"FP_TEAM_FORCE",FP_TEAM_FORCE,
	"FP_DRAIN",FP_DRAIN,
	"FP_SEE",FP_SEE,
...
stringID_table_t HoldableTable[] =
{
	...
	"HI_SHIELD",HI_SHIELD,
	"HI_MEDPAC",HI_MEDPAC,
	"HI_MEDPAC_BIG",HI_MEDPAC_BIG,
	"HI_BINOCULARS",HI_BINOCULARS,
	"HI_SENTRY_GUN",HI_SENTRY_GUN,
	"HI_JETPACK",HI_JETPACK,
	"HI_HEALTHDISP",HI_HEALTHDISP,
	"HI_AMMODISP",HI_AMMODISP,
	"HI_EWEB",HI_EWEB,
	"HI_CLOAK",HI_CLOAK,
...
stringID_table_t PowerupTable[] =
{
	"PW_NONE",PW_NONE,
	"PW_QUAD",PW_QUAD,
	"PW_BATTLESUIT",PW_BATTLESUIT,
	"PW_PULL",PW_PULL,
	"PW_REDFLAG",PW_REDFLAG,
	"PW_BLUEFLAG",PW_BLUEFLAG,
	"PW_NEUTRALFLAG",PW_NEUTRALFLAG,
	"PW_SHIELDHIT",PW_SHIELDHIT,
	"PW_SPEEDBURST",PW_SPEEDBURST,
	"PW_DISINT_4",PW_DISINT_4,
	"PW_SPEED",PW_SPEED,
	"PW_CLOAKED",PW_CLOAKED,
	"PW_FORCE_ENLIGHTENED_LIGHT",PW_FORCE_ENLIGHTENED_LIGHT,
	"PW_FORCE_ENLIGHTENED_DARK",PW_FORCE_ENLIGHTENED_DARK,
	"PW_FORCE_BOON",PW_FORCE_BOON,
	"PW_YSALAMIRI",PW_YSALAMIRI,
	...
	while (buf[i])
	{
		...
		{ 
			...
			{ 
				...
				while (buf[i] && buf[i] == ' ' || buf[i] == 9 || buf[i] == '\n' || buf[i] == '\r')
				{ 
					i++;
				}
	...
	{ 
		if (buf[i] != ' ' && buf[i] != '|')
		{
			...
			{ 
				...
				if (parsedLevel > ((FORCE_LEVEL_3+1)+1))
				{
					parsedLevel = ((FORCE_LEVEL_3+1)+1);
				}
			}
			else
			{ 
...
void BG_SiegeParseClassFile(const char *filename, siegeClassDesc_t *descBuffer)
{
	...
	if (descBuffer)
	{
		...
		(void)( (!!(strlen(descBuffer->desc) < 4096)) || (_wassert(L"strlen(descBuffer->desc) < SIEGE_CLASS_DESC_LEN", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c", 790), 0) );
	}
...
#line 988 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
	}
	else
	{ 
...
#line 1010 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
		{
			...
			for (i=0;i<SPC_MAX;i++)
			{
				...
				if (arrayTitleLength>titleLength)	
				{
					break;
				}
...
void BG_SiegeLoadClasses(siegeClassDesc_t *descBuffer)
{
	...
	for (i = 0; i < numFiles; i++, fileptr += filelen+1)
	{
		...
		{
			BG_SiegeParseClassFile(filename, ((void *)0));
		}
	}
}
...
#line 1276 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
...
extern int BG_ModelCache(const char *modelName, const char *skinName); 
			...
			while (sNum < 2)
			{
				...
				if (saberName && saberName[0])
				{
					...
					{ 
						if (saber.model[0])
						{
							BG_ModelCache(saber.model, ((void *)0));
						}
					}
				}
...
#line 1415 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"

qboolean BG_SiegeCheckClassLegality(int team, char *classname)
{
	siegeTeam_t **teamPtr = ((void *)0);
	int i = 0;
...
#line 1509 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\bg_saga.c"
