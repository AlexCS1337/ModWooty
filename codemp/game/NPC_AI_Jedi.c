...
#define	MAX_VIEW_DIST		4096 ///2048
#define MAX_VIEW_SPEED		200 ///100
...
{
	int	flameTime = Q_irand( 1000, 8000 ); // 4000;//
	mdxaBone_t	boltMatrix;
	vec3_t		org, dir;
...
evasionType_t Jedi_CheckFlipEvasions( gentity_t *self, float rightdot, float zdiff )
{
	...
	{//already running on a wall
		...
		{//flip off the wall!
			...
			{
				self->client->ps.velocity[0] *= 0.6f;//0.5f
