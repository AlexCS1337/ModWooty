#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_target.c"
...
#line 4 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_target.c"
...
void Use_Target_Give( gentity_t *ent, gentity_t *other, gentity_t *activator ) {
	...
	t = ((void *)0);
	while ( (t = G_Find (t, ((int)&(((gentity_t *)0)->targetname)), ent->target)) != ((void *)0) ) {
		if ( !t->item ) {
			continue;
		}
...
#line 182 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_target.c"
...
void target_laser_think (gentity_t *self) {
	...
	if ( self->enemy ) {
		((point)[0]=(self->enemy->s.origin)[0]+(self->enemy->r.mins)[0]*(0.5),(point)[1]=(self->enemy->s.origin)[1]+(self->enemy->r.mins)[1]*(0.5),(point)[2]=(self->enemy->s.origin)[2]+(self->enemy->r.mins)[2]*(0.5));
		((point)[0]=(point)[0]+(self->enemy->r.maxs)[0]*(0.5),(point)[1]=(point)[1]+(self->enemy->r.maxs)[1]*(0.5),(point)[2]=(point)[2]+(self->enemy->r.maxs)[2]*(0.5));
		((self->movedir)[0]=(point)[0]-(self->s.origin)[0],(self->movedir)[1]=(point)[1]-(self->s.origin)[1],(self->movedir)[2]=(point)[2]-(self->s.origin)[2]);
		VectorNormalize (self->movedir);
	}

	
	((end)[0]=(self->s.origin)[0]+(self->movedir)[0]*(2048),(end)[1]=(self->s.origin)[1]+(self->movedir)[1]*(2048),(end)[2]=(self->s.origin)[2]+(self->movedir)[2]*(2048));

	trap_Trace( &tr, self->s.origin, ((void *)0), ((void *)0), end, self->s.number, 0x00000001|0x00000100|0x00000200);

	if ( tr.entityNum ) {
		
		G_Damage ( &g_entities[tr.entityNum], self, self->activator, self->movedir, 
			tr.endpos, self->damage, 0x00000004, MOD_TARGET_LASER);
	}

	((self->s.origin2)[0]=(tr.endpos)[0],(self->s.origin2)[1]=(tr.endpos)[1],(self->s.origin2)[2]=(tr.endpos)[2]);
...
void target_kill_use( gentity_t *self, gentity_t *other, gentity_t *activator ) {
	G_ActivateBehavior(self,BSET_USE);
	G_Damage ( activator, ((void *)0), ((void *)0), ((void *)0), ((void *)0), 100000, 0x00000008, MOD_TELEFRAG);
}
...
static void target_location_linkup(gentity_t *ent)
{
	...
	trap_SetConfigstring( ((((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+32)+64), "unknown" );
	...
	for (i = 0, ent = g_entities, n = 1;
		...
		if (ent->classname && !Q_stricmp(ent->classname, "target_location")) {
			...
			ent->health = n; 
			trap_SetConfigstring( ((((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+32)+64) + n, ent->message );
			n++;
...
void scriptrunner_run (gentity_t *self)
{
	...
	if ( self->count != -1 )
	{
		...
		{
			self->use = 0;
			self->behaviorSet[BSET_USE] = ((void *)0);
			return;
		}
		else
		{
	...
	if (self->behaviorSet[BSET_USE])
	{
		if ( self->spawnflags & 1 )
		{
			...
			trap_ICARUS_RunScript( self->activator, va( "%s/%s", "scripts", self->behaviorSet[BSET_USE] ) );
		}
		else
		{
...
void G_SetActiveState(char *targetstring, qboolean actState)
{
	...
	while( ((void *)0) != (target = G_Find(target, ((int)&(((gentity_t *)0)->targetname)), targetstring)) )
	{
		target->flags = actState ? (target->flags&~0x00010000) : (target->flags|0x00010000);
	}
}
...
void target_activate_use(gentity_t *self, gentity_t *other, gentity_t *activator)
{
	...
	G_SetActiveState(self->target, qtrue);
}
...
void target_deactivate_use(gentity_t *self, gentity_t *other, gentity_t *activator)
{
	...
	G_SetActiveState(self->target, qfalse);
}
...
{
	G_ActivateBehavior(self,BSET_USE);
	trap_SetConfigstring( 2, self->message );
}
