...
int PM_AnimLength( int index, animNumber_t anim )
{
	...
	/*if (anim == (animNumber_t)BOTH_WALL_RUN_RIGHT 
		|| anim == (animNumber_t)BOTH_WALL_RUN_LEFT 
		){
		return 5000;
	}*/
...
//#ifndef FINAL_BUILD
		...
		if ( !token ) 
		{
			///animset[animNum].loopFrames =animset[animNum].numFrames; //unwooooot
			break;
		}
...
===================
*/
extern/*static*/ void BG_StartLegsAnim( playerState_t *ps, int anim )
{
