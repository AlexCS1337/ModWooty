#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 3 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 29 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
#line 30 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 39 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"


#line 42 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 48 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
#line 49 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 70 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 92 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"

	
	g_vehicleInfo[0].RegisterAssets( pVeh );
}
...
#line 117 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 120 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
#line 121 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 144 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 157 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
	{
	...
	if ( pVeh->m_ucmd.buttons & 16 && parentPS->speed > fWalkSpeedMax )
	{
...
void WalkerYawAdjust(Vehicle_t *pVeh, playerState_t *riderPS, playerState_t *parentPS)
{
	...
	if (parentPS && parentPS->speed)
	{
		...
		float maxDif = pVeh->m_pVehicleInfo->turningSpeed*1.5f; 
...
#line 308 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 334 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"


	if ( !rider )


#line 340 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
	{
		rider = parent;
	}
...
#line 351 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"

	speed = VectorLength( parentPS->velocity );

	
	if ( rider->s.number < 32 )
	{

		WalkerYawAdjust(pVeh, riderPS, parentPS);
		
		pVeh->m_vOrientation[0] = riderPS->viewangles[0];



#line 365 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
	}
	else
	{
...
#line 380 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
		{
			turnSpeed *= 2.0f;
...
#line 387 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
			{
		...
		{
			pVeh->m_vOrientation[1] += turnSpeed;
		}
...
static void AnimateVehicle( Vehicle_t *pVeh )
{
	...
	{  
		...
		iBlend = 300;
		iFlags = 1;
		fYawDelta = pVeh->m_vPrevOrientation[1] - pVeh->m_vOrientation[1];
		...
		if ( ( pVeh->m_ucmd.buttons & 16 ) || fSpeedPercToMax < 0.275f )
		{ 
...
#line 525 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
			{
				Anim = BOTH_STAND1;
			}
			else
...
#line 541 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 567 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 582 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
#line 583 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"


extern void G_AllocateVehicleObject(Vehicle_t **pVeh);
#line 587 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 590 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
#line 591 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 609 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
	memset(*pVeh, 0, sizeof(Vehicle_t));
	(*pVeh)->m_pVehicleInfo = &g_vehicleInfo[BG_VehicleGetIndex( strAnimalType )];



#line 615 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
}
...
#line 620 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
...
#line 637 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\walkernpc.c"
