#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 3 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 29 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
#line 30 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 39 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"


#line 42 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 48 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
#line 49 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 70 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 82 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 88 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 92 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 112 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 119 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 148 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	}


	isDead = (qboolean)((parentPS->eFlags&(1<<1))!=0);


#line 155 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
		...
		((bottom)[0]=(parentPS->origin)[0],(bottom)[1]=(parentPS->origin)[1],(bottom)[2]=(parentPS->origin)[2]);
		bottom[2] -= pVeh->m_pVehicleInfo->landingHeight;

		traceFunc( &pVeh->m_LandTrace, parentPS->origin, trMins, trMaxs, bottom, pVeh->m_pParentEntity->s.number, ((0x00000001|0x00000020|0x00000100|0x00001000)&~0x00000100) );
...
{
	(void)( (!!(pVeh->m_pParentEntity)) || (_wassert(L"pVeh->m_pParentEntity", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c", 187), 0) );
...
#line 195 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
		G_VehicleTrace))
	{
		return qfalse;
	}

	if ( !g_vehicleInfo[0].Update( pVeh, pUcmd ) )
	{
		return qfalse;
	}
...
{
	if ( !g_vehicleInfo[0].Board( pVeh, pEnt ) )
		return qfalse;
...
{
	if ( g_vehicleInfo[0].Eject( pVeh, pEnt, forceEject ) )
	{
		return qtrue;
	}
...
#line 232 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
qboolean FighterIsInSpace( gentity_t *gParent )
{
	if ( gParent 
		...
		&& gParent->client->inSpaceIndex < ((1<<10)-2) )
	{
		return qtrue;
	}
	return qfalse;
}
#line 285 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 314 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
qboolean FighterIsLaunching( Vehicle_t *pVeh, playerState_t *parentPS )
{
	...
	if ( FighterOverValidLandingSurface( pVeh )
		...
		&& pVeh->m_pVehicleInfo->Inhabited( pVeh )
#line 329 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
qboolean FighterSuspended( Vehicle_t *pVeh, playerState_t *parentPS )
{
	...
	if (!pVeh->m_pPilot
		...
		&& pVeh->m_pParentEntity != ((void *)0)
		&& (((gentity_t *)pVeh->m_pParentEntity)->spawnflags&2) )
	{
		return qtrue;
	}
	return qfalse;
...
#line 352 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
}
...
#line 396 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"


	if ( parentPS->hyperSpaceTime
		&& curTime - parentPS->hyperSpaceTime < 4000 )
	{
		
		float timeFrac = ((float)(curTime-parentPS->hyperSpaceTime))/4000;
		if ( timeFrac < 0.75f )
		{
			if ( !(parentPS->eFlags2&(1<<5)) )
			{
				parentPS->speed = 0.0f;
			}
			else
			{
				if ( parentPS->speed < 10000.0f )
				{
...
#line 420 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
				}

				parentPS->speed = 10000.0f;
			}
		}
		else
		{
			parentPS->speed = 200.0f + ((1.0f-timeFrac)*(1.0f/0.75f)*(10000.0f-200.0f));
			
			if ( VectorLength( parentPS->velocity ) < parentPS->speed )
			{
				((parentPS->velocity)[0]=(parentPS->moveDir)[0]*(parentPS->speed),(parentPS->velocity)[1]=(parentPS->moveDir)[1]*(parentPS->speed),(parentPS->velocity)[2]=(parentPS->moveDir)[2]*(parentPS->speed));
			}
		}
		return;
	}
#line 437 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	...
	if ( isLandingOrLaunching
		&& (pVeh->m_ucmd.forwardmove<=0||pVeh->m_LandTrace.fraction<=0.7f) )
	{
...
#line 462 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
			}
#line 464 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
		...
		else if ( pVeh->m_ucmd.forwardmove < 0 )
		{
			...
			if ( pVeh->m_LandTrace.fraction <= 0.7f )
			{
		...
		pVeh->m_vOrientation[0] = PredictedAngularDecrement(0.7f, pVeh->m_fTimeModifier*10.0f, pVeh->m_vOrientation[0]);
...
#line 512 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
		}
	}
	...
	if ( curTime < pVeh->m_iTurboTime )
	{
		...
		parentPS->eFlags |= (1<<11);
#line 529 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	}
	...
	else
	{
		...
		if ( (parentPS->eFlags&(1<<11)) )
		{
			parentPS->eFlags &= ~(1<<11);
		}
#line 546 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	}
	...
	if ( (parentPS->brokenLimbs&(1<<5)) )
	{
		speedMax *= 0.8f;
	}
	else if ( (parentPS->brokenLimbs&(1<<1)) )
	{
		speedMax *= 0.6f;
	}
...
#line 581 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	else if ( ( parentPS->speed || parentPS->groundEntityNum == ((1<<10)-1)  ||
	...
	if ( pVeh->m_pVehicleInfo->strafePerc 
		...
		&& pVeh->m_pVehicleInfo->Inhabited( pVeh )
#line 728 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
		...
		&& pVeh->m_ucmd.rightmove )
	{
		...
		((vAngles)[0]=(pVeh->m_vOrientation)[0],(vAngles)[1]=(pVeh->m_vOrientation)[1],(vAngles)[2]=(pVeh->m_vOrientation)[2]);
		vAngles[0] = vAngles[2] = 0;
		AngleVectors( vAngles, ((void *)0), vRight, ((void *)0) );

		if ( pVeh->m_ucmd.rightmove > 0 )
		{
			
			
			if ( parentPS->hackingTime > -2000.0f )
			{
				float curStrafeSpeed = ((parentPS->velocity)[0]*(vRight)[0]+(parentPS->velocity)[1]*(vRight)[1]+(parentPS->velocity)[2]*(vRight)[2]);
				...
				if ( strafeSpeed > 0 )
				{
					((parentPS->velocity)[0]=(parentPS->velocity)[0]+(vRight)[0]*(strafeSpeed*pVeh->m_fTimeModifier),(parentPS->velocity)[1]=(parentPS->velocity)[1]+(vRight)[1]*(strafeSpeed*pVeh->m_fTimeModifier),(parentPS->velocity)[2]=(parentPS->velocity)[2]+(vRight)[2]*(strafeSpeed*pVeh->m_fTimeModifier));
				}
...
#line 799 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	...
	if ((pVeh->m_vOrientation[0]*0.1f) > 10.0f)
	{ 
		...
		else
		{
			...
			float mult = pVeh->m_vOrientation[0]*0.1f;
			if (mult < 1.0f)
			{
				mult = 1.0f;
			}
...
#line 879 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
static void FighterWingMalfunctionCheck( Vehicle_t *pVeh, playerState_t *parentPS )
{
	...
	if ( (parentPS->brokenLimbs&(1<<6)) )
	{
		pVeh->m_vOrientation[2] += (sin( pVeh->m_ucmd.serverTime*0.001 )+1.0f)*pVeh->m_fTimeModifier*mYawOverride*50.0f;
	}
	else if ( (parentPS->brokenLimbs&(1<<2)) )
	{
		pVeh->m_vOrientation[2] += (sin( pVeh->m_ucmd.serverTime*0.001 )+1.0f)*pVeh->m_fTimeModifier*mYawOverride*12.5f;
	}

	
	if ( (parentPS->brokenLimbs&(1<<7)) )
	{
		pVeh->m_vOrientation[2] -= (sin( pVeh->m_ucmd.serverTime*0.001 )+1.0f)*pVeh->m_fTimeModifier*mYawOverride*50.0f;
	}
	else if ( (parentPS->brokenLimbs&(1<<3)) )
	{
		pVeh->m_vOrientation[2] -= (sin( pVeh->m_ucmd.serverTime*0.001 )+1.0f)*pVeh->m_fTimeModifier*mYawOverride*12.5f;
	}
...
static void FighterNoseMalfunctionCheck( Vehicle_t *pVeh, playerState_t *parentPS )
{
	...
	if ( (parentPS->brokenLimbs&(1<<4)) )
	{
		
		pVeh->m_vOrientation[0] += sin( pVeh->m_ucmd.serverTime*0.001 )*pVeh->m_fTimeModifier*mPitchOverride*50.0f;
	}
	else if ( (parentPS->brokenLimbs&(1<<0)) )
	{
		
		pVeh->m_vOrientation[0] += sin( pVeh->m_ucmd.serverTime*0.001 )*pVeh->m_fTimeModifier*mPitchOverride*20.0f;
	}
}
 	...
 	if ( !pVeh->m_iRemovedSurfaces )
	{
		if ( pVeh->m_pParentEntity && isDead )
		{
			...
			if ( !(pVeh->m_pParentEntity->s.number%3) )
			{
				...
				{
					if ( pVeh->m_vOrientation[0] > 60.0f )  
					{
						pVeh->m_vOrientation[0] = 60.0f;
					}
				}
			}
			...
			if ( (pVeh->m_pParentEntity->s.number%2) )
			{
				...
				pVeh->m_vOrientation[2] += pVeh->m_fTimeModifier*4.0f;
			}
			else
			{
				pVeh->m_vOrientation[1] -= pVeh->m_fTimeModifier;
...
#line 1034 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
		G_Damage(parent, killer, killer, vec3_origin, parent->client->ps.origin, 99999, 0x00000002, MOD_SUICIDE);
	}
#line 1037 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	...
	else if ((pVeh->m_iRemovedSurfaces & (1<<2)) ||
		(pVeh->m_iRemovedSurfaces & (1<<3)))
	{ 
		float factor = 2.0f;
		if ((pVeh->m_iRemovedSurfaces & (1<<2)) &&
	...
	else if ((pVeh->m_iRemovedSurfaces & (1<<4)) ||
		(pVeh->m_iRemovedSurfaces & (1<<5)))
	{ 
		float factor = 2.0f;
		if ((pVeh->m_iRemovedSurfaces & (1<<4)) &&
...
{
	float angDif = AngleSubtract(pVeh->m_vOrientation[1], riderPS->viewangles[1]);

	if (parentPS && parentPS->speed)
	{
		float s = parentPS->speed;
		float maxDif = pVeh->m_pVehicleInfo->turningSpeed*0.8f; 
		...
		pVeh->m_vOrientation[1] = AngleNormalize180(pVeh->m_vOrientation[1] - angDif*(pVeh->m_fTimeModifier*0.2f));
	}
}

void FighterPitchAdjust(Vehicle_t *pVeh, playerState_t *riderPS, playerState_t *parentPS)
{
	float angDif = AngleSubtract(pVeh->m_vOrientation[0], riderPS->viewangles[0]);
	...
	if (parentPS && parentPS->speed)
	{
		...
		pVeh->m_vOrientation[0] = AngleNormalize360(pVeh->m_vOrientation[0] - angDif*(pVeh->m_fTimeModifier*0.2f));
	}
}
#line 1355 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
void FighterPitchClamp(Vehicle_t *pVeh, playerState_t *riderPS, playerState_t *parentPS, int curTime )
{
	if ( !BG_UnrestrainedPitchRoll( riderPS, pVeh ) )
	{
		if ( pVeh->m_pVehicleInfo->pitchLimit != -1 
			...
			&& parentPS->electrifyTime < curTime )
		{
			if (pVeh->m_vOrientation[0] > pVeh->m_pVehicleInfo->pitchLimit )
			{
				pVeh->m_vOrientation[0] = pVeh->m_pVehicleInfo->pitchLimit;
			}
			else if (pVeh->m_vOrientation[0] < -pVeh->m_pVehicleInfo->pitchLimit)
			{
				pVeh->m_vOrientation[0] = -pVeh->m_pVehicleInfo->pitchLimit;
			}
		}
...
#line 1377 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1397 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	float	curRoll = 0.0f;
	qboolean isDead = qfalse;
...
#line 1408 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1418 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"


	if ( !rider )


#line 1424 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	{
		rider = parent;
	}
...
#line 1437 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	...
	if ( parentPS->hyperSpaceTime
		&& (curTime - parentPS->hyperSpaceTime) < 4000 )
	{
		((pVeh->m_vOrientation)[0]=(riderPS->viewangles)[0],(pVeh->m_vOrientation)[1]=(riderPS->viewangles)[1],(pVeh->m_vOrientation)[2]=(riderPS->viewangles)[2]);
		((parentPS->viewangles)[0]=(riderPS->viewangles)[0],(parentPS->viewangles)[1]=(riderPS->viewangles)[1],(parentPS->viewangles)[2]=(riderPS->viewangles)[2]);
		return;
	}
#line 1474 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"

#line 1476 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	
	if ( pVeh->m_iDropTime >= curTime )
	{
		parentPS->viewangles[1] = pVeh->m_vOrientation[1] = riderPS->viewangles[1];
	...
	{ 
		...
		pVeh->m_vOrientation[2] = AngleNormalize180( pVeh->m_vOrientation[2] );
		return;
	}

	if ( !BG_UnrestrainedPitchRoll( riderPS, pVeh ) )
	{
		pVeh->m_vOrientation[2] = PredictedAngularDecrement(0.95f, angleTimeMod*2.0f, pVeh->m_vOrientation[2]);
	}
	...
	{ 
		((pVeh->m_vFullAngleVelocity)[0]=(pVeh->m_vFullAngleVelocity)[1]=(pVeh->m_vFullAngleVelocity)[2]=0);
	}

	curRoll = pVeh->m_vOrientation[2];
		...
		&& parentPS->electrifyTime<curTime)
	{
		if ( parentPS->speed > 0.0f )
		{
			...
			{
				pVeh->m_vOrientation[0] = 0.0f;
			}
			else
			{
				pVeh->m_vOrientation[0] = PredictedAngularDecrement(0.83f, angleTimeMod*10.0f, pVeh->m_vOrientation[0]);
			}
		}
		if ( pVeh->m_LandTrace.fraction > 0.1f 
			|| pVeh->m_LandTrace.plane.normal[2] < 0.8f )
...
#line 1579 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
		}
	...
	else if ( (pVeh->m_iRemovedSurfaces||parentPS->electrifyTime>=curTime)
		&& (!(pVeh->m_pParentEntity->s.number%4)||!(pVeh->m_pParentEntity->s.number%5)) )
	{
	}
	else if ( pVeh->m_pPilot && pVeh->m_pPilot->s.number < 32 && parentPS->speed > 0.0f )
	{



		if ( BG_UnrestrainedPitchRoll( riderPS, pVeh ) )
#line 1599 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
		{
			((pVeh->m_vOrientation)[0]=(riderPS->viewangles)[0],(pVeh->m_vOrientation)[1]=(riderPS->viewangles)[1],(pVeh->m_vOrientation)[2]=(riderPS->viewangles)[2]);
			((parentPS->viewangles)[0]=(riderPS->viewangles)[0],(parentPS->viewangles)[1]=(riderPS->viewangles)[1],(parentPS->viewangles)[2]=(riderPS->viewangles)[2]);

			
#line 1605 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1642 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1658 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"

				FighterNoseMalfunctionCheck( pVeh, parentPS );

				
				fYawDelta = AngleSubtract(pVeh->m_vOrientation[1], pVeh->m_vPrevOrientation[1]); 
				if ( fYawDelta > 8.0f ) 
				{
					fYawDelta = 8.0f;
				}
...
#line 1704 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
			}
		}
	}
	...
	if ( isLandingOrLanded )    
	{
		...
		{
			if ( pVeh->m_vOrientation[0] > 0 )
			{
				pVeh->m_vOrientation[0] = PredictedAngularDecrement(0.2f, angleTimeMod*10.0f, pVeh->m_vOrientation[0]);
			}
			else
			{
				pVeh->m_vOrientation[0] = PredictedAngularDecrement(0.75f, angleTimeMod*10.0f, pVeh->m_vOrientation[0]);
			}
		}
	}
...
#line 1781 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"

	if ( !parentPS->hackingTime )
	{
		pVeh->m_vOrientation[2] = curRoll;
		
		if ( pVeh->m_vOrientation[2] )
		{ 
			...
			else
			{
				if ( !BG_UnrestrainedPitchRoll( riderPS, pVeh ) )
				{
					pVeh->m_vOrientation[1] -= ((pVeh->m_vOrientation[2])*0.05f)*pVeh->m_fTimeModifier;
				}
			}
		}
	}
	...
	{
		float strafeRoll = (parentPS->hackingTime/2000.0f)*pVeh->m_pVehicleInfo->rollLimit;
		float strafeDif = AngleSubtract(strafeRoll, pVeh->m_vOrientation[2]);
		pVeh->m_vOrientation[2] += (strafeDif*0.1f)*pVeh->m_fTimeModifier;
		if ( !BG_UnrestrainedPitchRoll( riderPS, pVeh ) )
		{
			if ( pVeh->m_pVehicleInfo->rollLimit != -1 
				&& !pVeh->m_iRemovedSurfaces 
				&& parentPS->electrifyTime<curTime)
			{
				if (pVeh->m_vOrientation[2] > pVeh->m_pVehicleInfo->rollLimit )
				{
					pVeh->m_vOrientation[2] = pVeh->m_pVehicleInfo->rollLimit;
				}
				else if (pVeh->m_vOrientation[2] < -pVeh->m_pVehicleInfo->rollLimit)
				{
					pVeh->m_vOrientation[2] = -pVeh->m_pVehicleInfo->rollLimit;
				}
			}
...
#line 1850 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1858 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1902 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
					}
#line 1904 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
					pVeh->m_ulFlags |= VEH_GEARSOPEN;
	...
	if ( Anim != -1 )
	{
			...
			BG_SetAnim(pVeh->m_pParentEntity->playerState, bgAllAnims[pVeh->m_pParentEntity->localAnimIndex].anims,
				1|2, Anim, iFlags, iBlend);
		

#line 1938 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	}
}
...
#line 1947 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1972 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1987 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
#line 1988 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"


extern void G_AllocateVehicleObject(Vehicle_t **pVeh);
#line 1992 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 1995 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
#line 1996 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 2013 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
	memset(*pVeh, 0, sizeof(Vehicle_t));


#line 2017 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 2023 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
...
#line 2040 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\fighternpc.c"
