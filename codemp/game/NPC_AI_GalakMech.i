...
#line 14 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_ai_galakmech.c"
...
#line 16 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_ai_galakmech.c"
...
void NPC_GalakMech_Init( gentity_t *ent )
{
	if (ent->NPC->behaviorState != BS_CINEMATIC)
	{
		...
		ent->flags |= 0x00080000;
		
		
		
		((ent->r.mins)[0]=(-60), (ent->r.mins)[1]=(-60), (ent->r.mins)[2]=(-24));
		((ent->r.maxs)[0]=(60), (ent->r.maxs)[1]=(60), (ent->r.maxs)[2]=(80));
		...
		NPC_SetSurfaceOnOff( ent, "torso_shield", 0x00000000 );
		NPC_SetSurfaceOnOff( ent, "torso_galakface", 0x00000100 );
		NPC_SetSurfaceOnOff( ent, "torso_galakhead", 0x00000100 );
		NPC_SetSurfaceOnOff( ent, "torso_eyes_mouth", 0x00000100 );
		NPC_SetSurfaceOnOff( ent, "torso_collar", 0x00000100 );
		NPC_SetSurfaceOnOff( ent, "torso_galaktorso", 0x00000100 );
	}
	else
	{

		NPC_SetSurfaceOnOff( ent, "torso_shield", 0x00000100 );
		NPC_SetSurfaceOnOff( ent, "torso_galakface", 0x00000000 );
		NPC_SetSurfaceOnOff( ent, "torso_galakhead", 0x00000000 );
		NPC_SetSurfaceOnOff( ent, "torso_eyes_mouth", 0x00000000 );
		NPC_SetSurfaceOnOff( ent, "torso_collar", 0x00000000 );
		NPC_SetSurfaceOnOff( ent, "torso_galaktorso", 0x00000000 );
	}
		...
		if ( TIMER_Done( self, "dyingExplosion" ) )
		{
			...
			case 2:
				...
				if (!trap_G2API_GetSurfaceRenderStatus( self->ghoul2, 0, "l_hand" ))
				{
					...
					NPC_SetSurfaceOnOff( self, "l_hand", 0x00000100 );
				}
				else if (!trap_G2API_GetSurfaceRenderStatus( self->ghoul2, 0, "l_arm_wrist" ))
				{
					...
					NPC_SetSurfaceOnOff( self, "l_arm_wrist", 0x00000100 );
				}
				else if (!trap_G2API_GetSurfaceRenderStatus( self->ghoul2, 0, "l_arm_middle" ))
				{
					newBolt = trap_G2API_AddBolt( self->ghoul2, 0, "*l_arm_cap_l_hand" );
					NPC_SetSurfaceOnOff( self, "l_arm_middle", 0x00000100 );
				}
				else if (!trap_G2API_GetSurfaceRenderStatus( self->ghoul2, 0, "l_arm_augment" ))
				{
					...
					NPC_SetSurfaceOnOff( self, "l_arm_augment", 0x00000100 );
				}
				break;
			case 3:
			case 4:
...
void NPC_GM_Pain(gentity_t *self, gentity_t *attacker, int damage)
{
	...
	if ( inflictor && inflictor->lastEnemy == self )
	{
		if ( mod == MOD_REPEATER_ALT && !Q_irand( 0, 2 ) )
		{
			...
			{
				self->NPC->scriptFlags &= ~0x00000040;
		...
		if ( level.time - NPCInfo->enemyLastSeenTime < 10000 )
		{
			if ( !Q_irand( 0, 10 ) )
			{
				...
				if ( VectorCompare( impactPos4, vec3_origin ) )
				{
					...
					((impactPos4)[0]=(tr.endpos)[0],(impactPos4)[1]=(tr.endpos)[1],(impactPos4)[2]=(tr.endpos)[2]);
				}
...
#line 566 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_ai_galakmech.c"
...
{
	NPC->wait = 0;
	NPC_SetSurfaceOnOff( NPC, "torso_galakface", 0x00000000 );
	NPC_SetSurfaceOnOff( NPC, "torso_galakhead", 0x00000000 );
	NPC_SetSurfaceOnOff( NPC, "torso_eyes_mouth", 0x00000000 );
	NPC_SetSurfaceOnOff( NPC, "torso_collar", 0x00000000 );
	NPC_SetSurfaceOnOff( NPC, "torso_galaktorso", 0x00000000 );

	NPC_SetAnim( NPC, 1|2, BOTH_STAND2TO1, 1|2 );
...
#line 666 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_ai_galakmech.c"
	...
	shoot4 = qfalse;
	hitAlly4 = qfalse;
	((impactPos4)[0]=(impactPos4)[1]=(impactPos4)[2]=0);
	...
	if (0)
	{
		...
		if ( TIMER_Done( NPC, "smackTime" ) && !NPCInfo->blockedDebounceTime )
		{
			...
			if ( enemyDist4 < 6400 && InFront( NPC->enemy->r.currentOrigin, NPC->r.currentOrigin, NPC->client->ps.viewangles, 0.3f ) )
			{
				vec3_t	smackDir;
				((smackDir)[0]=(NPC->enemy->r.currentOrigin)[0]-(NPC->r.currentOrigin)[0],(smackDir)[1]=(NPC->enemy->r.currentOrigin)[1]-(NPC->r.currentOrigin)[1],(smackDir)[2]=(NPC->enemy->r.currentOrigin)[2]-(NPC->r.currentOrigin)[2]);
				smackDir[2] += 30;
				VectorNormalize( smackDir );
				
				G_Sound( NPC->enemy, CHAN_AUTO, G_SoundIndex( "sound/weapons/galak/skewerhit.wav" ) );
				G_Damage( NPC->enemy, NPC, NPC, smackDir, NPC->r.currentOrigin, (g_spskill.integer+1)*Q_irand( 5, 10), 0x00000002|0x00000004, MOD_CRUSH ); 
				if ( NPC->client->ps.torsoAnim == BOTH_ATTACK4 )
				{
					...
					NPC_SetAnim( NPC->enemy, 1|2, knockAnim, 1|2 );
				}
				else
				{
					...
					NPC_SetAnim( NPC->enemy, 1|2, BOTH_KNOCKDOWN5, 1|2 );
				}
	...
	else if ( NPC->lockCount ) 
	{
		...
		if ( NPC->lockCount == 1 )
		{
			if ( TIMER_Done( NPC, "beamDelay" ) )
			{
				...
				NPC_SetAnim( NPC, 1|2, laserAnim, 1|2 );
				...
				if ( !NPCInfo->coverTarg )
				{
					...
					if ( NPCInfo->coverTarg )
					{
						...
						NPCInfo->coverTarg->r.svFlags |= 0x00000020;
...
#line 772 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_ai_galakmech.c"
			...
			else
			{
				...
				((end)[0]=(NPC->client->renderInfo.muzzlePoint)[0]+(NPC->client->renderInfo.muzzleDir)[0]*(1024),(end)[1]=(NPC->client->renderInfo.muzzlePoint)[1]+(NPC->client->renderInfo.muzzleDir)[1]*(1024),(end)[2]=(NPC->client->renderInfo.muzzlePoint)[2]+(NPC->client->renderInfo.muzzleDir)[2]*(1024));
				trap_Trace( &trace, NPC->client->renderInfo.muzzlePoint, mins, maxs, end, NPC->s.number, (0x00000001|0x00000100|0x00000200|0x00001000) );
...
#line 849 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_ai_galakmech.c"
				
				NPC_SetAnim( NPC, 1|2, swingAnim, 1|2 );
				TIMER_Set( NPC, "attackDelay", NPC->client->ps.torsoTimer + Q_irand( 1000, 3000 ) );
		...
		else if ( !NPC->lockCount && NPC->locationDamage[HL_GENERIC1] > 25
			&& TIMER_Done( NPC, "attackDelay" )
			&& InFront( NPC->enemy->r.currentOrigin, NPC->r.currentOrigin, NPC->client->ps.viewangles, 0.3f )
			&& ((!Q_irand( 0, 10*(2-g_spskill.integer))&& enemyDist4 > 65536&& enemyDist4 < 200704)
		...
		else if ( enemyDist4 < 65536 
			&& (NPC->enemy->s.weapon != WP_TURRET || Q_stricmp( "PAS", NPC->enemy->classname ))
			&& TIMER_Done( NPC, "noRapid" ) )
		{
			if ( (NPC->client->ps.weapon == WP_REPEATER) && (NPCInfo->scriptFlags & 0x00000040) )
			{
		...
		else if ( (enemyDist4 > 200704 || (NPC->enemy->s.weapon == WP_TURRET && !Q_stricmp( "PAS", NPC->enemy->classname )))
			&& TIMER_Done( NPC, "noLob" ) )
		{
			if ( (NPC->client->ps.weapon == WP_REPEATER) && !(NPCInfo->scriptFlags & 0x00000040) )
			{
				NPCInfo->scriptFlags |= 0x00000040;
	...
	if ( NPC_ClearLOS4( NPC->enemy ) )
	{
		...
		{
			if ( ((NPC->client->ps.weapon == WP_REPEATER && (NPCInfo->scriptFlags&0x00000040))) && enemyDist4 < 65536 )
			{
				enemyCS4 = qfalse;
				hitAlly4 = qtrue;
	...
	if ( NPC->client->ps.weapon == WP_REPEATER && (NPCInfo->scriptFlags&0x00000040) && shoot4 && TIMER_Done( NPC, "attackDelay" ) )
	{
		vec3_t	muzzle;
		vec3_t	angles;
		vec3_t	target;
		...
		((target)[0]=(NPC->enemy->r.currentOrigin)[0],(target)[1]=(NPC->enemy->r.currentOrigin)[1],(target)[2]=(NPC->enemy->r.currentOrigin)[2]);

		target[0] += flrand( -5, 5 )+((2.0 * (((rand () & 0x7fff) / ((float)0x7fff)) - 0.5))*(6-NPCInfo->currentAim)*2);
		target[1] += flrand( -5, 5 )+((2.0 * (((rand () & 0x7fff) / ((float)0x7fff)) - 0.5))*(6-NPCInfo->currentAim)*2);
		target[2] += flrand( -5, 5 )+((2.0 * (((rand () & 0x7fff) / ((float)0x7fff)) - 0.5))*(6-NPCInfo->currentAim)*2);

		
		clearshot = WP_LobFire( NPC, muzzle, target, mins, maxs, (0x00000001|0x00000100|0x00000200|0x00001000)|0x00040000, 
		...
		else
		{
			...
			((NPC->client->hiddenDir)[0]=(velocity)[0],(NPC->client->hiddenDir)[1]=(velocity)[1],(NPC->client->hiddenDir)[2]=(velocity)[2]);
	...
	if ( NPC->enemy->s.weapon == WP_TURRET && !Q_stricmp( "PAS", NPC->enemy->classname ) )
	{
		if ( G_BoundsOverlap( NPC->r.absmin, NPC->r.absmax, NPC->enemy->r.absmin, NPC->enemy->r.absmax ) )
		{
			...
			if (0)
			{
				NPC->client->ps.powerups[PW_BATTLESUIT] = level.time + 500;
				G_Damage( NPC->enemy, NPC, NPC, ((void *)0), NPC->r.currentOrigin, 100, 0x00000004, MOD_UNKNOWN ); 
			}
			else
			{
				G_Damage( NPC->enemy, NPC, NPC, ((void *)0), NPC->r.currentOrigin, 100, 0x00000004, MOD_CRUSH ); 
			}
		}
	}
	else if ( NPCInfo->touchedByPlayer != ((void *)0) && NPCInfo->touchedByPlayer == NPC->enemy )
	{
...
#line 1184 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_ai_galakmech.c"
			TIMER_Set( NPC, "attackDelay", NPC->client->ps.torsoTimer );
			TIMER_Set( NPC, "standTime", NPC->client->ps.legsTimer );
			
			NPCInfo->touchedByPlayer = ((void *)0);
			...
			smackDir[2] += 30;
			VectorNormalize( smackDir );
			G_Damage( NPC->enemy, NPC, NPC, smackDir, NPC->r.currentOrigin, (g_spskill.integer+1)*Q_irand( 5, 10), 0x00000004, MOD_UNKNOWN ); 
...
void NPC_BSGM_Default( void )
{
	...
	if ( NPC->client->ps.stats[STAT_ARMOR] <= 0 )
	{
		...
		if (0)
		{
			NPC_SetSurfaceOnOff( NPC, "torso_shield", 0x00000100 );
			NPC->flags &= ~0x00080000;
			((NPC->r.mins)[0]=(-20), (NPC->r.mins)[1]=(-20), (NPC->r.mins)[2]=(-24));
			((NPC->r.maxs)[0]=(20), (NPC->r.maxs)[1]=(20), (NPC->r.maxs)[2]=(64));
			NPC->client->ps.crouchheight = NPC->client->ps.standheight = 64;
			if ( NPC->locationDamage[HL_GENERIC1] < 25 )
			{
		...
		else if ( NPCInfo->investigateDebounceTime < level.time )
		{
			...
			if ( !tr.startsolid )
			{
				((NPC->r.mins)[0]=(shieldMins)[0],(NPC->r.mins)[1]=(shieldMins)[1],(NPC->r.mins)[2]=(shieldMins)[2]);
				((NPC->r.maxs)[0]=(shieldMaxs)[0],(NPC->r.maxs)[1]=(shieldMaxs)[1],(NPC->r.maxs)[2]=(shieldMaxs)[2]);
				NPC->client->ps.crouchheight = NPC->client->ps.standheight = shieldMaxs[2];
				NPC->client->ps.stats[STAT_ARMOR] = 500;
				NPCInfo->investigateDebounceTime = 0;
				NPC->flags |= 0x00080000;
			
				NPC_SetSurfaceOnOff( NPC, "torso_shield", 0x00000000 );
			}
		}
	}
