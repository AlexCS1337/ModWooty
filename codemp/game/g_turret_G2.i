#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_turret_g2.c"
...
#line 2 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_turret_g2.c"
...
#line 3 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_turret_g2.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\q_shared.h"
...
#line 4 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_turret_g2.c"
...
#line 33 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_turret_g2.c"
	int i = 0;
...
void turretG2_set_models( gentity_t *self, qboolean dying )
{
	if ( dying )
	{
		...
		{
			self->s.modelindex = G_ModelIndex( "models/map_objects/imp_mine/turret_damage.md3" );
			self->s.modelindex2 = G_ModelIndex( "models/map_objects/imp_mine/turret_canon.glm" );
		}
	...
	else
	{
		if ( !(self->spawnflags&8) )
		{
			self->s.modelindex = G_ModelIndex( "models/map_objects/imp_mine/turret_canon.glm" );
			self->s.modelindex2 = G_ModelIndex( "models/map_objects/imp_mine/turret_damage.md3" );
		...
		{
			self->s.modelindex = G_ModelIndex( "models/map_objects/wedge/laser_cannon_model.glm" );
...

{
	...
	{
		self->attackDebounceTime = level.time + 2000 + ((rand () & 0x7fff) / ((float)0x7fff)) * 500;
...

{
	...
	((pos)[0]=(self->r.currentOrigin)[0]+(forward)[0]*(12),(pos)[1]=(self->r.currentOrigin)[1]+(forward)[1]*(12),(pos)[2]=(self->r.currentOrigin)[2]+(forward)[2]*(12));
...
void TurboLaser_SetBoneAnim(gentity_t *eweb, int startFrame, int endFrame)
{
	...
	(void)( (!!(eweb->ghoul2)) || (_wassert(L"eweb->ghoul2", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_turret_g2.c", 329), 0) );
...

{
	...
	if ( (trap_PointContents( start, ent->s.number )&(0x00000001|0x00000100|0x00000200|0x00001000)) )
	{
		return;
	}

	((org)[0]=(start)[0]+(dir)[0]*(-15),(org)[1]=(start)[1]+(dir)[1]*(-15),(org)[2]=(start)[2]+(dir)[2]*(-15)); 

	if ( ent->random )
	{
		vectoangles( dir, ang );
		ang[0] += flrand( -ent->random, ent->random );
		ang[1] += flrand( -ent->random, ent->random );
	...
	else
	{
		...
		bolt->dflags = (0x00000004|0x00001000);		
		...
		bolt->clipmask = (0x00000001|0x00000100|0x00000200|0x00001000) | 0x00040000;
		

		((bolt->r.maxs)[0]=(1.5), (bolt->r.maxs)[1]=(1.5), (bolt->r.maxs)[2]=(1.5));
		((bolt->r.mins)[0]=(bolt->r.maxs)[0]*(-1),(bolt->r.mins)[1]=(bolt->r.maxs)[1]*(-1),(bolt->r.mins)[2]=(bolt->r.maxs)[2]*(-1));
		bolt->s.pos.trType = TR_LINEAR;
		bolt->s.pos.trTime = level.time;
		((bolt->s.pos.trBase)[0]=(start)[0],(bolt->s.pos.trBase)[1]=(start)[1],(bolt->s.pos.trBase)[2]=(start)[2]);
		((bolt->s.pos.trDelta)[0]=(dir)[0]*(ent->mass),(bolt->s.pos.trDelta)[1]=(dir)[1]*(ent->mass),(bolt->s.pos.trDelta)[2]=(dir)[2]*(ent->mass));
...

{
		...
		&& self->attackDebounceTime < level.time )
	{
		...
		((org)[0]=(org)[0]+(fwd)[0]*(15),(org)[1]=(org)[1]+(fwd)[1]*(15),(org)[2]=(org)[2]+(fwd)[2]*(15));
...

{
	...
	float	maxYawSpeed = (self->spawnflags&8)?30.0f:14.0f;
	float	maxPitchSpeed = (self->spawnflags&8)?15.0f:3.0f;

	
	BG_EvaluateTrajectory( &self->s.apos, level.time, self->r.currentAngles );
	self->r.currentAngles[1] = AngleNormalize360( self->r.currentAngles[1] );
	...
	if ( self->enemy )
	{
		...
		{
			((org)[0]=(self->enemy->client->renderInfo.eyePoint)[0],(org)[1]=(self->enemy->client->renderInfo.eyePoint)[1],(org)[2]=(self->enemy->client->renderInfo.eyePoint)[2]);
		}
		else
		{
			((org)[0]=(self->enemy->r.currentOrigin)[0],(org)[1]=(self->enemy->r.currentOrigin)[1],(org)[2]=(self->enemy->r.currentOrigin)[2]);
		}
		if ( self->spawnflags & 2 )
		{
			org[2] -= 15;
		...
		if ( (self->spawnflags&16) )
		{
			...
			float dist;
			((diff)[0]=(org)[0]-(self->s.origin)[0],(diff)[1]=(org)[1]-(self->s.origin)[1],(diff)[2]=(org)[2]-(self->s.origin)[2]);
			dist = VectorNormalize( diff );
			if ( self->enemy->client )
			{
				((velocity)[0]=(self->enemy->client->ps.velocity)[0],(velocity)[1]=(self->enemy->client->ps.velocity)[1],(velocity)[2]=(self->enemy->client->ps.velocity)[2]);
			}
			else
			{
				((velocity)[0]=(self->enemy->s.pos.trDelta)[0],(velocity)[1]=(self->enemy->s.pos.trDelta)[1],(velocity)[2]=(self->enemy->s.pos.trDelta)[2]);
			}
			((org)[0]=(org)[0]+(velocity)[0]*((dist/self->mass)),(org)[1]=(org)[1]+(velocity)[1]*((dist/self->mass)),(org)[2]=(org)[2]+(velocity)[2]*((dist/self->mass)));
		}
		...
		((enemyDir)[0]=(org)[0]-(org2)[0],(enemyDir)[1]=(org)[1]-(org2)[1],(enemyDir)[2]=(org)[2]-(org2)[2]);
		vectoangles( enemyDir, desiredAngles );

		diffYaw = AngleSubtract( self->r.currentAngles[1], desiredAngles[1] );
		diffPitch = AngleSubtract( self->speed, desiredAngles[0] );
	}
	else
	{
	...
	if ( diffYaw )
	{
		...
		((setAngle)[0]=(0.0f), (setAngle)[1]=(diffYaw), (setAngle)[2]=(0.0f));

		((self->s.apos.trBase)[0]=(self->r.currentAngles)[0],(self->s.apos.trBase)[1]=(self->r.currentAngles)[1],(self->s.apos.trBase)[2]=(self->r.currentAngles)[2]);
		((self->s.apos.trDelta)[0]=(setAngle)[0]*(- 5),(self->s.apos.trDelta)[1]=(setAngle)[1]*(- 5),(self->s.apos.trDelta)[2]=(setAngle)[2]*(- 5));
	...
	if ( diffPitch )
	{
		...
		if ( (self->spawnflags&8) )
		{
			if ( self->spawnflags & 2 )
			{
				((desiredAngles)[0]=(0.0f), (desiredAngles)[1]=(0.0f), (desiredAngles)[2]=(-self->speed));
			}
			else
			{
				((desiredAngles)[0]=(0.0f), (desiredAngles)[1]=(0.0f), (desiredAngles)[2]=(self->speed));
		...
		else
		{
			if ( self->spawnflags & 2 )
			{
				((desiredAngles)[0]=(self->speed), (desiredAngles)[1]=(0.0f), (desiredAngles)[2]=(0.0f));
			}
			else
			{
				((desiredAngles)[0]=(-self->speed), (desiredAngles)[1]=(0.0f), (desiredAngles)[2]=(0.0f));
...

{
	...
	gentity_t	*entity_list[(1<<10)], *target, *bestTarget = ((void *)0);
	...
	((org2)[0]=(self->r.currentOrigin)[0],(org2)[1]=(self->r.currentOrigin)[1],(org2)[2]=(self->r.currentOrigin)[2]);
	if ( self->spawnflags & 2 )
	{
		org2[2] += 20;
	}
	...
	for ( i = 0; i < count; i++ )
	{
		...
		if ( !target->client )
		{
			...
			if ( !(target->flags&0x04000000)
				|| !target->takedamage
				|| (target->NPC_targetname&&self->targetname&&Q_stricmp(target->NPC_targetname,self->targetname)!=0) )
			{
				continue;
			}
		...
		if ( target->client )
		{
			((org)[0]=(target->client->renderInfo.eyePoint)[0],(org)[1]=(target->client->renderInfo.eyePoint)[1],(org)[2]=(target->client->renderInfo.eyePoint)[2]);
		}
		else
		{
		...
		if ( !tr.allsolid && !tr.startsolid && ( tr.fraction == 1.0 || tr.entityNum == target->s.number ))
		{
			...
			if ( enemyDist < bestDist || (target->client && !foundClient))
			{
	...
	if ( found )
	{
		...
		if ( ( ( self->target2 != 0 ) && ( self->target2[0] != 0 ) ))
		{
...

{
	...
	if ( self->enemy != ((void *)0) )
	{
		...
		else
		{
			...
			((enemyDir)[0]=(self->enemy->r.currentOrigin)[0]-(self->r.currentOrigin)[0],(enemyDir)[1]=(self->enemy->r.currentOrigin)[1]-(self->r.currentOrigin)[1],(enemyDir)[2]=(self->enemy->r.currentOrigin)[2]-(self->r.currentOrigin)[2]);
			enemyDist = VectorLengthSquared( enemyDir );
	...
	if ( turnOff )
	{
		if ( self->bounceCount < level.time ) 
		{
			turretG2_turnoff( self );
		}
	}
	else
	{
		...
		self->bounceCount = level.time + 2000 + ((rand () & 0x7fff) / ((float)0x7fff)) * 150;
	}
...

{
	...
	if (( self->s.eFlags & (1<<4) ) && ( self->spawnflags & 1 )) 
	{
		self->s.frame = 1; 
	}
	else
...
void finish_spawning_turretG2( gentity_t *base )
{
	...
	AngleVectors( base->r.currentAngles, fwd, ((void *)0), ((void *)0) );
	...
	base->nextthink = level.time + 50 * 5;

	
	base->speed = 0;

	
	if ( (base->spawnflags&4) && !base->count )
	{
		base->count = 20000;
	}
	...
	if ( (base->spawnflags&8) )
	{
		...
		if ( (base->spawnflags&8) )
		{
			((base->r.maxs)[0]=(64.0f), (base->r.maxs)[1]=(64.0f), (base->r.maxs)[2]=(30.0f));
			((base->r.mins)[0]=(-64.0f), (base->r.mins)[1]=(-64.0f), (base->r.mins)[2]=(-30.0f));
		}
	...
	else
	{
		...
		if ( !base->wait )
		{
			base->wait = 150 + ((rand () & 0x7fff) / ((float)0x7fff)) * 55;
		}
		...
		if ( base->spawnflags & 2 )
		{
			((base->r.maxs)[0]=(10.0f), (base->r.maxs)[1]=(10.0f), (base->r.maxs)[2]=(30.0f));
			((base->r.mins)[0]=(-10.0f), (base->r.mins)[1]=(-10.0f), (base->r.mins)[2]=(0.0f));
		}
		else
		{
			((base->r.maxs)[0]=(10.0f), (base->r.maxs)[1]=(10.0f), (base->r.maxs)[2]=(0.0f));
			((base->r.mins)[0]=(-10.0f), (base->r.mins)[1]=(-10.0f), (base->r.mins)[2]=(-30.0f));
		}
	}
	...
	{ 
		...
		((base->r.mins)[0]=(base->r.mins)[0]*(fScale),(base->r.mins)[1]=(base->r.mins)[1]*(fScale),(base->r.mins)[2]=(base->r.mins)[2]*(fScale));
		((base->r.maxs)[0]=(base->r.maxs)[0]*(fScale),(base->r.maxs)[1]=(base->r.maxs)[1]*(fScale),(base->r.maxs)[2]=(base->r.maxs)[2]*(fScale));
	}
	...
	base->r.contents = 0x00000100|0x00000010|0x00000020|0x00000080;
