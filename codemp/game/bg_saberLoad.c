...
void WP_SetSaber( int entNum, saberInfo_t *sabers, int saberNum, const char *saberName )
{
	...
	else
	{
		WP_SaberParseParms( saberName, &sabers[saberNum] );//get saber info
			...
			/*if (sabers[saberNum].type == SABER_SITH_SWORD || sabers[saberNum].type == SABER_TRIDENT){
			
				sabers[saberNum].trailStyle = 2;
				sabers[saberNum].trailStyle2 = 2;
				sabers[saberNum].saberFlags2 |= SFL2_NO_BLADE;
				sabers[saberNum].saberFlags2 |= SFL2_NO_BLADE2;
				sabers[saberNum].saberFlags2 |= SFL2_NO_DLIGHT;
				sabers[saberNum].saberFlags2 |= SFL2_NO_WALL_MARKS;
				sabers[saberNum].saberFlags2 |= SFL2_NO_DLIGHT2;
				sabers[saberNum].saberFlags2 |= SFL2_NO_WALL_MARKS2;
				sabers[saberNum].saberFlags2 |= SFL2_NO_MANUAL_DEACTIVATE;
				sabers[saberNum].saberFlags2 |= SFL2_NO_MANUAL_DEACTIVATE2;
			}*/
