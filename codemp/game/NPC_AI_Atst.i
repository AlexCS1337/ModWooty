...
#line 57 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\npc_ai_atst.c"
...
void ATST_Attack( void )
{
	...
	distRate	= ( distance > ( 640 * 640 ) ) ? DIST_LONG : DIST_MELEE;
	...
	case DIST_LONG:
		...
		if ( blasterTest != -1
			&& !(blasterTest&0x00000100)  
			&& chargerTest != -1
			&& !(chargerTest&0x00000100))
		{
			weapon = Q_irand( 0, 1);	
...
void ATST_Idle( void )
{
	...
	NPC_SetAnim( NPC, 1|2, BOTH_STAND1, 0 );
}
