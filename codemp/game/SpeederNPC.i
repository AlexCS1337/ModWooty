#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 3 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 29 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
#line 30 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 39 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"


#line 42 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 49 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
#line 50 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 72 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 83 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 87 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 92 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 145 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 270 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 302 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 315 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
	{
		speedInc = 0;
...
#line 333 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"



	if ( (pVeh->m_pPilot  &&
		(pVeh->m_ucmd.buttons & 128) && pVeh->m_pVehicleInfo->turboSpeed)
		...
		)
	{
			  ...
			  (pVeh->m_pPilot->playerState->weapon == WP_SABER && BG_SabersOff( pVeh->m_pPilot->playerState ) ))) )
		{
			if ((curTime - pVeh->m_iTurboTime)>pVeh->m_pVehicleInfo->turboRecharge)
			{
				...
				{
					int i;
					for (i=0; (i<12 && pVeh->m_iExhaustTag[i]!=-1); i++)
					{
						...
						{ 
							...
							((boltDir)[0]=(0.0f), (boltDir)[1]=(pVeh->m_pParentEntity->playerState->viewangles[1]), (boltDir)[2]=(0.0f));

							trap_G2API_GetBoltMatrix(pVeh->m_pParentEntity->ghoul2, 0, pVeh->m_iExhaustTag[i], &boltMatrix, boltDir, pVeh->m_pParentEntity->playerState->origin, level.time, ((void *)0), pVeh->m_pParentEntity->modelScale);
...
#line 371 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
					}
				}
	...
	if (pVeh->m_ulFlags&VEH_SLIDEBREAKING)
	{
		...
		fabs(pVeh->m_vOrientation[2])>25.0f)
	{
		pVeh->m_ulFlags |= VEH_SLIDEBREAKING;
	}
	...
	if ( parentPS->speed || parentPS->groundEntityNum == ((1<<10)-1)  ||
	...
	else
	{
		if ( !pVeh->m_pVehicleInfo->strafePerc 
			...
			|| (0 && pVeh->m_pParentEntity->s.number < 32) )


#line 467 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
		{
...
#line 505 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
void ProcessOrientCommands( Vehicle_t *pVeh )
{
	...
	angDif = AngleSubtract(pVeh->m_vOrientation[1], riderPS->viewangles[1]);
	if (parentPS && parentPS->speed)
	{
		float s = parentPS->speed;
		float maxDif = pVeh->m_pVehicleInfo->turningSpeed*4.0f; 
		if (s < 0.0f)
		{
			s = -s;
		}
		...
		{ 
			pVeh->m_vOrientation[1] += (sin(pm->cmd.serverTime/1000.0f)*3.0f)*pVeh->m_fTimeModifier;
		}
	}
...
#line 596 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 613 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
void AnimateRiders( Vehicle_t *pVeh )
{
	...
	if ( pVeh->m_iBoarding != 0 )
	{
		...
		if ( pVeh->m_iBoarding < 0 )
		{
			...
			else if ( pVeh->m_iBoarding == -5)
			{
				iBlend = 0;
				Anim = BOTH_VS_MOUNTTHROW_R;
			}
			else if ( pVeh->m_iBoarding == -6)
			{
				iBlend = 0;
...
#line 688 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 703 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
		}
	...
	if (1) return;
#line 743 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 751 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 760 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 770 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
	{
		Anim = BOTH_VS_REV;
		iBlend = 500;
	}
	else 
	{
		...
		qboolean		Attacking	= (HasWeapon && !!(pVeh->m_ucmd.buttons&1));
...
#line 785 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 832 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
 		...
 		if (Attacking && WeaponPose)
		{
			...
			if (Left)
			{
				...
				default:				(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c", 903), 0) );
				}
			}
			else if (Right)
			{
				...
				default:				(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c", 913), 0) );
				}
			}
			else
			{
				...
				default:				(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c", 921), 0) );
				}
			}

		}
		else if (Left && pVeh->m_ucmd.buttons&32)
		{
			iBlend	= 400;
			iFlags	= 1 | 2;
			switch(WeaponPose)
		...
		else if (Right && pVeh->m_ucmd.buttons&32)
		{
			iBlend	= 400;
			iFlags	= 1 | 2;
			switch(WeaponPose)
		...
		else if (Flying)
		{
			...
			default:				(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c", 965), 0) );
			}
		}
		else if (Crashing)
		{
			...
			default:				(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c", 979), 0) );
			}
		}
		else
		{
			...
			if (pVeh->m_vOrientation[2] <= -20)
			{
				...
				default:				(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c", 995), 0) );
				}
			}
			else if (pVeh->m_vOrientation[2] >= 20)
			{
				switch(WeaponPose)
				{
				...
				default:				(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c", 1006), 0) );
				}
			}
			else
			{
				...
				case WPOSE_SABERLEFT:	Anim = BOTH_VS_IDLE_SL;			break;
				case WPOSE_SABERRIGHT:	Anim = BOTH_VS_IDLE_SR;			break;
				default:				(void)( (!!(0)) || (_wassert(L"0", L"c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c", 1017), 0) );
				}
			}
		}
	}
	...
	BG_SetAnim(pVeh->m_pPilot->playerState, bgAllAnims[pVeh->m_pPilot->localAnimIndex].anims,
		1|2, Anim, iFlags|2, iBlend);


#line 1038 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
}
...
#line 1064 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 1081 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
#line 1082 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"


extern void G_AllocateVehicleObject(Vehicle_t **pVeh);
#line 1086 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 1089 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
#line 1090 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 1106 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 1113 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
}
...
#line 1118 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
...
#line 1135 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\speedernpc.c"
