#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_mover.c"
...
#line 5 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_mover.c"
...
gentity_t	*G_TestEntityPosition( gentity_t *ent ) {
	...
	if ( ent->clipmask ) {
		...
		mask = (0x00000001|0x00001000);
	}
	if ( ent->client ) {
		vec3_t vMax;
		((vMax)[0]=(ent->r.maxs)[0],(vMax)[1]=(ent->r.maxs)[1],(vMax)[2]=(ent->r.maxs)[2]);
		if (vMax[2] < 1)
		{
			vMax[2] = 1;
		}
...
void G_RotatePoint(vec3_t point, vec3_t matrix[3]) {
	...
	((tvec)[0]=(point)[0],(tvec)[1]=(point)[1],(tvec)[2]=(point)[2]);
	point[0] = ((matrix[0])[0]*(tvec)[0]+(matrix[0])[1]*(tvec)[1]+(matrix[0])[2]*(tvec)[2]);
	point[1] = ((matrix[1])[0]*(tvec)[0]+(matrix[1])[1]*(tvec)[1]+(matrix[1])[2]*(tvec)[2]);
	point[2] = ((matrix[2])[0]*(tvec)[0]+(matrix[2])[1]*(tvec)[1]+(matrix[2])[2]*(tvec)[2]);
}
...
qboolean	G_TryPushingEntity( gentity_t *check, gentity_t *pusher, vec3_t move, vec3_t amove ) {
	...
	if ( pusher->s.apos.trType != TR_STATIONARY
		&& (pusher->spawnflags&16) 
		&& Q_stricmp( "func_rotating", pusher->classname ) == 0 )
	{
		G_Damage( check, pusher, pusher, ((void *)0), ((void *)0), pusher->damage, 0x00000004, MOD_CRUSH );
		return qtrue;
	}

	
	if (pushed_p > &pushed[(1<<10)]) {
		G_Error( "pushed_p > &pushed[MAX_GENTITIES]" );
	}
	pushed_p->ent = check;
	((pushed_p->origin)[0]=(check->s.pos.trBase)[0],(pushed_p->origin)[1]=(check->s.pos.trBase)[1],(pushed_p->origin)[2]=(check->s.pos.trBase)[2]);
	((pushed_p->angles)[0]=(check->s.apos.trBase)[0],(pushed_p->angles)[1]=(check->s.apos.trBase)[1],(pushed_p->angles)[2]=(check->s.apos.trBase)[2]);
	if ( check->client ) {
		pushed_p->deltayaw = check->client->ps.delta_angles[1];
		((pushed_p->origin)[0]=(check->client->ps.origin)[0],(pushed_p->origin)[1]=(check->client->ps.origin)[1],(pushed_p->origin)[2]=(check->client->ps.origin)[2]);
	}
	pushed_p++;
	...
	if ( check->client ) {
		((org)[0]=(check->client->ps.origin)[0]-(pusher->r.currentOrigin)[0],(org)[1]=(check->client->ps.origin)[1]-(pusher->r.currentOrigin)[1],(org)[2]=(check->client->ps.origin)[2]-(pusher->r.currentOrigin)[2]);
	}
	else {
		((org)[0]=(check->s.pos.trBase)[0]-(pusher->r.currentOrigin)[0],(org)[1]=(check->s.pos.trBase)[1]-(pusher->r.currentOrigin)[1],(org)[2]=(check->s.pos.trBase)[2]-(pusher->r.currentOrigin)[2]);
	}
	((org2)[0]=(org)[0],(org2)[1]=(org)[1],(org2)[2]=(org)[2]);
	G_RotatePoint( org2, matrix );
	((move2)[0]=(org2)[0]-(org)[0],(move2)[1]=(org2)[1]-(org)[1],(move2)[2]=(org2)[2]-(org)[2]);
	
	((check->s.pos.trBase)[0]=(check->s.pos.trBase)[0]+(move)[0],(check->s.pos.trBase)[1]=(check->s.pos.trBase)[1]+(move)[1],(check->s.pos.trBase)[2]=(check->s.pos.trBase)[2]+(move)[2]);
	((check->s.pos.trBase)[0]=(check->s.pos.trBase)[0]+(move2)[0],(check->s.pos.trBase)[1]=(check->s.pos.trBase)[1]+(move2)[1],(check->s.pos.trBase)[2]=(check->s.pos.trBase)[2]+(move2)[2]);
	if ( check->client ) {
		((check->client->ps.origin)[0]=(check->client->ps.origin)[0]+(move)[0],(check->client->ps.origin)[1]=(check->client->ps.origin)[1]+(move)[1],(check->client->ps.origin)[2]=(check->client->ps.origin)[2]+(move)[2]);
		((check->client->ps.origin)[0]=(check->client->ps.origin)[0]+(move2)[0],(check->client->ps.origin)[1]=(check->client->ps.origin)[1]+(move2)[1],(check->client->ps.origin)[2]=(check->client->ps.origin)[2]+(move2)[2]);
		
		check->client->ps.delta_angles[1] += ((int)((amove[1])*65536/360) & 65535);
	}
	...
	if (!block) {
		...
		if ( check->client ) {
			((check->r.currentOrigin)[0]=(check->client->ps.origin)[0],(check->r.currentOrigin)[1]=(check->client->ps.origin)[1],(check->r.currentOrigin)[2]=(check->client->ps.origin)[2]);
		} else {
			((check->r.currentOrigin)[0]=(check->s.pos.trBase)[0],(check->r.currentOrigin)[1]=(check->s.pos.trBase)[1],(check->r.currentOrigin)[2]=(check->s.pos.trBase)[2]);
		}
		trap_LinkEntity (check);
		return qtrue;
	}

	if (check->takedamage && !check->client && check->s.weapon && check->r.ownerNum < 32 &&
		check->health < 500)
	{
		if (check->health > 0)
		{
	...
	((check->s.pos.trBase)[0]=((pushed_p-1)->origin)[0],(check->s.pos.trBase)[1]=((pushed_p-1)->origin)[1],(check->s.pos.trBase)[2]=((pushed_p-1)->origin)[2]);
	if ( check->client ) {
		((check->client->ps.origin)[0]=((pushed_p-1)->origin)[0],(check->client->ps.origin)[1]=((pushed_p-1)->origin)[1],(check->client->ps.origin)[2]=((pushed_p-1)->origin)[2]);
	}
	((check->s.apos.trBase)[0]=((pushed_p-1)->angles)[0],(check->s.apos.trBase)[1]=((pushed_p-1)->angles)[1],(check->s.apos.trBase)[2]=((pushed_p-1)->angles)[2]);
	block = G_TestEntityPosition (check);
	if ( !block ) {
...
qboolean G_MoverPush( gentity_t *pusher, vec3_t move, vec3_t amove, gentity_t **obstacle ) {
	...
	*obstacle = ((void *)0);
	...
	if ( pusher->r.currentAngles[0] || pusher->r.currentAngles[1] || pusher->r.currentAngles[2]
		...
		((totalMins)[0]=(pusher->r.absmin)[0],(totalMins)[1]=(pusher->r.absmin)[1],(totalMins)[2]=(pusher->r.absmin)[2]);
		((totalMaxs)[0]=(pusher->r.absmax)[0],(totalMaxs)[1]=(pusher->r.absmax)[1],(totalMaxs)[2]=(pusher->r.absmax)[2]);
		for (i=0 ; i<3 ; i++) {
			if ( move[i] > 0 ) {
				totalMaxs[i] += move[i];
			} else {
	...
	listedEntities = trap_EntitiesInBox( totalMins, totalMaxs, entityList, (1<<10) );

	
	((pusher->r.currentOrigin)[0]=(pusher->r.currentOrigin)[0]+(move)[0],(pusher->r.currentOrigin)[1]=(pusher->r.currentOrigin)[1]+(move)[1],(pusher->r.currentOrigin)[2]=(pusher->r.currentOrigin)[2]+(move)[2]);
	((pusher->r.currentAngles)[0]=(pusher->r.currentAngles)[0]+(amove)[0],(pusher->r.currentAngles)[1]=(pusher->r.currentAngles)[1]+(amove)[1],(pusher->r.currentAngles)[2]=(pusher->r.currentAngles)[2]+(amove)[2]);
	...
	for ( e = 0 ; e < listedEntities ; e++ ) {
		...
		if (  check->s.eType != ET_PLAYER && check->s.eType != ET_NPC && !check->physicsObject ) {
			continue;
		}
		...
		{
			G_Damage( check, pusher, pusher, ((void *)0), ((void *)0), pusher->damage, 0, MOD_CRUSH );
			continue;
		}
		...
		{ 
			G_Damage( check, pusher, pusher, ((void *)0), ((void *)0), 999, 0, MOD_CRUSH );
			continue;
		}
		...
		*obstacle = check;
		...
		for ( p=pushed_p-1 ; p>=pushed ; p-- ) {
			((p->ent->s.pos.trBase)[0]=(p->origin)[0],(p->ent->s.pos.trBase)[1]=(p->origin)[1],(p->ent->s.pos.trBase)[2]=(p->origin)[2]);
			((p->ent->s.apos.trBase)[0]=(p->angles)[0],(p->ent->s.apos.trBase)[1]=(p->angles)[1],(p->ent->s.apos.trBase)[2]=(p->angles)[2]);
			if ( p->ent->client ) {
				p->ent->client->ps.delta_angles[1] = p->deltayaw;
				((p->ent->client->ps.origin)[0]=(p->origin)[0],(p->ent->client->ps.origin)[1]=(p->origin)[1],(p->ent->client->ps.origin)[2]=(p->origin)[2]);
			}
...
void G_MoverTeam( gentity_t *ent ) {
	...
	for (part = ent ; part ; part=part->teamchain) {
		...
		((move)[0]=(origin)[0]-(part->r.currentOrigin)[0],(move)[1]=(origin)[1]-(part->r.currentOrigin)[1],(move)[2]=(origin)[2]-(part->r.currentOrigin)[2]);
		((amove)[0]=(angles)[0]-(part->r.currentAngles)[0],(amove)[1]=(angles)[1]-(part->r.currentAngles)[1],(amove)[2]=(angles)[2]-(part->r.currentAngles)[2]);
...
void CalcTeamDoorCenter ( gentity_t *ent, vec3_t center ) 
{
	...
	((center)[0]=(ent->r.mins)[0]+(ent->r.maxs)[0],(center)[1]=(ent->r.mins)[1]+(ent->r.maxs)[1],(center)[2]=(ent->r.mins)[2]+(ent->r.maxs)[2]);
	((center)[0]=(center)[0]*(0.5),(center)[1]=(center)[1]*(0.5),(center)[2]=(center)[2]*(0.5));
	for ( slave = ent->teamchain ; slave ; slave = slave->teamchain ) 
	{
		
		((slavecenter)[0]=(slave->r.mins)[0]+(slave->r.maxs)[0],(slavecenter)[1]=(slave->r.mins)[1]+(slave->r.maxs)[1],(slavecenter)[2]=(slave->r.mins)[2]+(slave->r.maxs)[2]);
		((slavecenter)[0]=(slavecenter)[0]*(0.5),(slavecenter)[1]=(slavecenter)[1]*(0.5),(slavecenter)[2]=(slavecenter)[2]*(0.5));
		
		((center)[0]=(center)[0]+(slavecenter)[0],(center)[1]=(center)[1]+(slavecenter)[1],(center)[2]=(center)[2]+(slavecenter)[2]);
		((center)[0]=(center)[0]*(0.5),(center)[1]=(center)[1]*(0.5),(center)[2]=(center)[2]*(0.5));
	}
}
...
void SetMoverState( gentity_t *ent, moverState_t moverState, int time ) {
	...
	switch( moverState ) {
	case MOVER_POS1:
		((ent->s.pos.trBase)[0]=(ent->pos1)[0],(ent->s.pos.trBase)[1]=(ent->pos1)[1],(ent->s.pos.trBase)[2]=(ent->pos1)[2]);
		ent->s.pos.trType = TR_STATIONARY;
		break;
	case MOVER_POS2:
		((ent->s.pos.trBase)[0]=(ent->pos2)[0],(ent->s.pos.trBase)[1]=(ent->pos2)[1],(ent->s.pos.trBase)[2]=(ent->pos2)[2]);
		ent->s.pos.trType = TR_STATIONARY;
		break;
	case MOVER_1TO2:
		((ent->s.pos.trBase)[0]=(ent->pos1)[0],(ent->s.pos.trBase)[1]=(ent->pos1)[1],(ent->s.pos.trBase)[2]=(ent->pos1)[2]);
		((delta)[0]=(ent->pos2)[0]-(ent->pos1)[0],(delta)[1]=(ent->pos2)[1]-(ent->pos1)[1],(delta)[2]=(ent->pos2)[2]-(ent->pos1)[2]);
		f = 1000.0 / ent->s.pos.trDuration;
		((ent->s.pos.trDelta)[0]=(delta)[0]*(f),(ent->s.pos.trDelta)[1]=(delta)[1]*(f),(ent->s.pos.trDelta)[2]=(delta)[2]*(f));
		if ( ent->alt_fire )
		{
	...
	case MOVER_2TO1:
		((ent->s.pos.trBase)[0]=(ent->pos2)[0],(ent->s.pos.trBase)[1]=(ent->pos2)[1],(ent->s.pos.trBase)[2]=(ent->pos2)[2]);
		((delta)[0]=(ent->pos1)[0]-(ent->pos2)[0],(delta)[1]=(ent->pos1)[1]-(ent->pos2)[1],(delta)[2]=(ent->pos1)[2]-(ent->pos2)[2]);
		f = 1000.0 / ent->s.pos.trDuration;
		((ent->s.pos.trDelta)[0]=(delta)[0]*(f),(ent->s.pos.trDelta)[1]=(delta)[1]*(f),(ent->s.pos.trDelta)[2]=(delta)[2]*(f));
		if ( ent->alt_fire )
		{
...
void Reached_BinaryMover( gentity_t *ent ) 
{
	...
	if ( ent->moverState == MOVER_1TO2 ) 
	{
		...
		else
		{
			...
			{
				ent->nextthink = level.time + (int)(ent->wait / 2.5f);
			}
		}
...
void Use_BinaryMover_Go( gentity_t *ent ) 
{
	...
	if ( ent->moverState == MOVER_2TO1 ) 
	{
		if ( ent->s.pos.trType == TR_NONLINEAR_STOP )
		{
			...
			((curDelta)[0]=(ent->r.currentOrigin)[0]-(ent->pos1)[0],(curDelta)[1]=(ent->r.currentOrigin)[1]-(ent->pos1)[1],(curDelta)[2]=(ent->r.currentOrigin)[2]-(ent->pos1)[2]);
			fPartial = VectorLength( curDelta )/VectorLength( ent->s.pos.trDelta );
			((curDelta)[0]=(ent->s.pos.trDelta)[0]*(fPartial),(curDelta)[1]=(ent->s.pos.trDelta)[1]*(fPartial),(curDelta)[2]=(ent->s.pos.trDelta)[2]*(fPartial));
			fPartial /= ent->s.pos.trDuration;
			fPartial /= 0.001f;
			fPartial = acos( fPartial );
			fPartial = ( ( (fPartial) * 180.0f ) / 3.14159265358979323846f );
	...
	if ( ent->moverState == MOVER_1TO2 ) 
	{
		if ( ent->s.pos.trType == TR_NONLINEAR_STOP )
		{
			...
			float fPartial;
			total = ent->s.pos.trDuration-50;
			((curDelta)[0]=(ent->r.currentOrigin)[0]-(ent->pos2)[0],(curDelta)[1]=(ent->r.currentOrigin)[1]-(ent->pos2)[1],(curDelta)[2]=(ent->r.currentOrigin)[2]-(ent->pos2)[2]);
			fPartial = VectorLength( curDelta )/VectorLength( ent->s.pos.trDelta );
			((curDelta)[0]=(ent->s.pos.trDelta)[0]*(fPartial),(curDelta)[1]=(ent->s.pos.trDelta)[1]*(fPartial),(curDelta)[2]=(ent->s.pos.trDelta)[2]*(fPartial));
			fPartial /= ent->s.pos.trDuration;
			fPartial /= 0.001f;
...
void UnLockDoors(gentity_t *const ent)
{
	...
	do 
	{	
		if( !(slave->spawnflags & 8) )
		{
			slave->targetname = ((void *)0);
		}
		slave->spawnflags &= ~16;
		slave->s.frame = 1;
...
void InitMoverTrData( gentity_t *ent )
{
	...
	((move)[0]=(ent->pos2)[0]-(ent->pos1)[0],(move)[1]=(ent->pos2)[1]-(ent->pos1)[1],(move)[2]=(ent->pos2)[2]-(ent->pos1)[2]);
	distance = VectorLength( move );
	if ( ! ent->speed ) 
	{
		ent->speed = 100;
	}
	((ent->s.pos.trDelta)[0]=(move)[0]*(ent->speed),(ent->s.pos.trDelta)[1]=(move)[1]*(ent->speed),(ent->s.pos.trDelta)[2]=(move)[2]*(ent->speed));
...
void InitMover( gentity_t *ent ) 
{
	...
	ent->r.svFlags = 0x00000080;
	if ( ent->spawnflags & 128 )
	{
		ent->flags |= 0x00010000;	
	}
	...
	((ent->r.currentOrigin)[0]=(ent->pos1)[0],(ent->r.currentOrigin)[1]=(ent->pos1)[1],(ent->r.currentOrigin)[2]=(ent->pos1)[2]);
	trap_LinkEntity( ent );
...
static void Touch_DoorTriggerSpectator( gentity_t *ent, gentity_t *other, trace_t *trace ) {
	...
	((pMins)[0]=(-15.0f), (pMins)[1]=(-15.0f), (pMins)[2]=(-24));
	((pMaxs)[0]=(15.0f), (pMaxs)[1]=(15.0f), (pMaxs)[2]=(40));
...
void Touch_DoorTrigger( gentity_t *ent, gentity_t *other, trace_t *trace ) 
{
	...
	{
		if (other->client && other->s.number >= 32 &&
	...
	if ( ent->parent->spawnflags & 16 )
	{
		...
		{
			if ( ent->parent->flags & 0x00000400 ) 
			{
...
void Think_SpawnNewDoorTrigger( gentity_t *ent ) 
{
	...
	((mins)[0]=(ent->r.absmin)[0],(mins)[1]=(ent->r.absmin)[1],(mins)[2]=(ent->r.absmin)[2]);
	((maxs)[0]=(ent->r.absmax)[0],(maxs)[1]=(ent->r.absmax)[1],(maxs)[2]=(ent->r.absmax)[2]);
	...
	other = G_Spawn ();
	((other->r.mins)[0]=(mins)[0],(other->r.mins)[1]=(mins)[1],(other->r.mins)[2]=(mins)[2]);
	((other->r.maxs)[0]=(maxs)[0],(other->r.maxs)[1]=(maxs)[1],(other->r.maxs)[2]=(maxs)[2]);
	other->parent = ent;
	other->r.contents = 0x00000400;
...
qboolean G_EntIsDoor( int entityNum )
{
	...
	if ( entityNum < 0 || entityNum >= ((1<<10)-2) )
	{
		return qfalse;
	}
...
gentity_t *G_FindDoorTrigger( gentity_t *ent )
{
	...
	gentity_t *door = ent;
	if ( door->flags & 0x00000400 )
	{
		while ( door->teammaster && (door->flags&0x00000400))
		{
	...
	if ( door->targetname )
	{
		...
		while ( (owner = G_Find( owner, ((int)&(((gentity_t *)0)->target)), door->targetname )) != ((void *)0) )
		{
			if ( owner && (owner->r.contents&0x00000400) )
			{
				return owner;
			}
		}
		owner = ((void *)0);
		while ( (owner = G_Find( owner, ((int)&(((gentity_t *)0)->target2)), door->targetname )) != ((void *)0) )
		{
			if ( owner && (owner->r.contents&0x00000400) )
			{
				return owner;
	...
	owner = ((void *)0);
	while ( (owner = G_Find( owner, ((int)&(((gentity_t *)0)->classname)), "trigger_door" )) != ((void *)0) )
	{
...
qboolean G_EntIsUnlockedDoor( int entityNum )
{
	...
	if ( G_EntIsDoor( entityNum ) )
	{
		...
		if ( ent->flags & 0x00000400 )
		{
			while ( ent->teammaster && (ent->flags&0x00000400))
			{
				ent = ent->teammaster;
			}
		}
		if ( ent->targetname )
		{
			...
			while ( (owner = G_Find( owner, ((int)&(((gentity_t *)0)->target)), ent->targetname )) != ((void *)0) )
			{
				if ( !Q_stricmp( "trigger_multiple", owner->classname ) )
				{
					if ( !(owner->flags & 0x00010000) )
					{
						return qtrue;
					}
				}
			...
			owner = ((void *)0);
			while ( (owner = G_Find( owner, ((int)&(((gentity_t *)0)->target2)), ent->targetname )) != ((void *)0) )
			{
				if ( !Q_stricmp( "trigger_multiple", owner->classname ) )
				{
					if ( !(owner->flags & 0x00010000) )
		...
		else
		{
			...
			if ( owner && (owner->flags&0x00010000) )
			{
				return qfalse;
			}
		}
...
void SP_func_door (gentity_t *ent) 
{
	...
	((ent->pos1)[0]=(ent->s.origin)[0],(ent->pos1)[1]=(ent->s.origin)[1],(ent->pos1)[2]=(ent->s.origin)[2]);
	...
	((size)[0]=(ent->r.maxs)[0]-(ent->r.mins)[0],(size)[1]=(ent->r.maxs)[1]-(ent->r.mins)[1],(size)[2]=(ent->r.maxs)[2]-(ent->r.mins)[2]);
	distance = ((abs_movedir)[0]*(size)[0]+(abs_movedir)[1]*(size)[1]+(abs_movedir)[2]*(size)[2]) - lip;
	((ent->pos2)[0]=(ent->pos1)[0]+(ent->movedir)[0]*(distance),(ent->pos2)[1]=(ent->pos1)[1]+(ent->movedir)[1]*(distance),(ent->pos2)[2]=(ent->pos1)[2]+(ent->movedir)[2]*(distance));
	...
	if ( ent->spawnflags & 1 ) 
	{
		...
		((temp)[0]=(ent->pos2)[0],(temp)[1]=(ent->pos2)[1],(temp)[2]=(ent->pos2)[2]);
		((ent->pos2)[0]=(ent->s.origin)[0],(ent->pos2)[1]=(ent->s.origin)[1],(ent->pos2)[2]=(ent->s.origin)[2]);
		((ent->pos1)[0]=(temp)[0],(ent->pos1)[1]=(temp)[1],(ent->pos1)[2]=(temp)[2]);
	}
	...
	if ( !(ent->flags&0x00000400) ) 
	{
		...
		if ( !(ent->spawnflags&16) && (ent->targetname || health || ent->spawnflags & 64 || ent->spawnflags & 2) )
		{
...
void SpawnPlatTrigger( gentity_t *ent ) {
	...
	((trigger->r.mins)[0]=(tmin)[0],(trigger->r.mins)[1]=(tmin)[1],(trigger->r.mins)[2]=(tmin)[2]);
	((trigger->r.maxs)[0]=(tmax)[0],(trigger->r.maxs)[1]=(tmax)[1],(trigger->r.maxs)[2]=(tmax)[2]);
...
void SP_func_plat (gentity_t *ent) {
	...
	((ent->s.angles)[0]=(ent->s.angles)[1]=(ent->s.angles)[2]=0);
	...
	((ent->pos2)[0]=(ent->s.origin)[0],(ent->pos2)[1]=(ent->s.origin)[1],(ent->pos2)[2]=(ent->s.origin)[2]);
	((ent->pos1)[0]=(ent->pos2)[0],(ent->pos1)[1]=(ent->pos2)[1],(ent->pos1)[2]=(ent->pos2)[2]);
	ent->pos1[2] -= height;
...
void Reached_Train( gentity_t *ent ) {
	...
	((ent->pos1)[0]=(next->s.origin)[0],(ent->pos1)[1]=(next->s.origin)[1],(ent->pos1)[2]=(next->s.origin)[2]);
	((ent->pos2)[0]=(next->nextTrain->s.origin)[0],(ent->pos2)[1]=(next->nextTrain->s.origin)[1],(ent->pos2)[2]=(next->nextTrain->s.origin)[2]);
...
void Think_SetupTrainTargets( gentity_t *ent ) {
	...
	ent->nextTrain = G_Find( ((void *)0), ((int)&(((gentity_t *)0)->targetname)), ent->target );
	if ( !ent->nextTrain ) {
	...
	for ( path = ent->nextTrain ; path != start ; path = next ) {
		...
		next = ((void *)0);
		do {
			next = G_Find( next, ((int)&(((gentity_t *)0)->targetname)), path->target );
			if ( !next ) {
...
#line 1985 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_mover.c"
...
void SP_func_rotating (gentity_t *ent) {
	...
	else
	{
		...
		((ent->s.pos.trBase)[0]=(ent->s.origin)[0],(ent->s.pos.trBase)[1]=(ent->s.origin)[1],(ent->s.pos.trBase)[2]=(ent->s.origin)[2]);
		...
		((ent->r.currentAngles)[0]=(ent->s.apos.trBase)[0],(ent->r.currentAngles)[1]=(ent->s.apos.trBase)[1],(ent->r.currentAngles)[2]=(ent->s.apos.trBase)[2]);
	...
	G_SpawnInt("model2scale", "0", &ent->s.iModelScale);
#line 2149 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_mover.c"
	if (ent->s.iModelScale < 0)
	{
		ent->s.iModelScale = 0;
	}
	...
	if ( G_SpawnVector( "spinangles", "0 0 0", spinangles ) )
	{
		...
		((ent->s.apos.trDelta)[0]=(spinangles)[0],(ent->s.apos.trDelta)[1]=(spinangles)[1],(ent->s.apos.trDelta)[2]=(spinangles)[2]);
	}
	else
	{
		if ( !ent->speed ) {
...
void SP_func_bobbing (gentity_t *ent) {
	...
	((ent->s.pos.trBase)[0]=(ent->s.origin)[0],(ent->s.pos.trBase)[1]=(ent->s.origin)[1],(ent->s.pos.trBase)[2]=(ent->s.origin)[2]);
	((ent->r.currentOrigin)[0]=(ent->s.origin)[0],(ent->r.currentOrigin)[1]=(ent->s.origin)[1],(ent->r.currentOrigin)[2]=(ent->s.origin)[2]);
...
void SP_func_pendulum(gentity_t *ent) {
	...
	freq = 1 / ( 3.14159265358979323846f * 2 ) * sqrt( g_gravity.value / ( 3 * length ) );
...
void G_MiscModelExplosion( vec3_t mins, vec3_t maxs, int size, material_t chunkType )
{
	...
	((mid)[0]=(mins)[0]+(maxs)[0],(mid)[1]=(mins)[1]+(maxs)[1],(mid)[2]=(mins)[2]+(maxs)[2]);
	((mid)[0]=(mid)[0]*(0.5f),(mid)[1]=(mid)[1]*(0.5f),(mid)[2]=(mid)[2]*(0.5f));

	te = G_TempEntity( mid, EV_MISC_MODEL_EXP );

	((te->s.origin2)[0]=(maxs)[0],(te->s.origin2)[1]=(maxs)[1],(te->s.origin2)[2]=(maxs)[2]);
	((te->s.angles2)[0]=(mins)[0],(te->s.angles2)[1]=(mins)[1],(te->s.angles2)[2]=(mins)[2]);
	te->s.time = size;
						...
						float speed, int numChunks, material_t chunkType, int customChunk, float baseScale )
{
	...
	te->s.owner = owner;
	((te->s.origin)[0]=(origin)[0],(te->s.origin)[1]=(origin)[1],(te->s.origin)[2]=(origin)[2]);
	((te->s.angles)[0]=(normal)[0],(te->s.angles)[1]=(normal)[1],(te->s.angles)[2]=(normal)[2]);
	((te->s.origin2)[0]=(maxs)[0],(te->s.origin2)[1]=(maxs)[1],(te->s.origin2)[2]=(maxs)[2]);
	((te->s.angles2)[0]=(mins)[0],(te->s.angles2)[1]=(mins)[1],(te->s.angles2)[2]=(mins)[2]);
	te->s.speed = speed;
...
void funcBBrushDieGo (gentity_t *self)
{
	...
	for ( i = 0; i < (1<<10); i++ )
	{
		if ( g_entities[i].s.groundEntityNum == self->s.number && ( g_entities[i].s.eFlags & (1<<22) ))
		{
			G_Damage( &g_entities[i], self, self, ((void *)0), ((void *)0), 99999, 0, MOD_CRUSH ); 
		}
	}
	...
	if ( self->target && attacker != ((void *)0) )
	{
		G_UseTargets(self, attacker);
	}

	((org)[0]=(self->r.absmax)[0]-(self->r.absmin)[0],(org)[1]=(self->r.absmax)[1]-(self->r.absmin)[1],(org)[2]=(self->r.absmax)[2]-(self->r.absmin)[2]);

	numChunks = ((rand () & 0x7fff) / ((float)0x7fff)) * 6 + 18;
	...
	((org)[0]=(self->r.absmin)[0]+(org)[0]*(0.5),(org)[1]=(self->r.absmin)[1]+(org)[1]*(0.5),(org)[2]=(self->r.absmin)[2]+(org)[2]*(0.5));
	((org)[0]=(self->r.absmin)[0]+(self->r.absmax)[0],(org)[1]=(self->r.absmin)[1]+(self->r.absmax)[1],(org)[2]=(self->r.absmin)[2]+(self->r.absmax)[2]);
	((org)[0]=(org)[0]*(0.5f),(org)[1]=(org)[1]*(0.5f),(org)[2]=(org)[2]*(0.5f));

	if ( attacker != ((void *)0) && attacker->client )
	{
		((dir)[0]=(org)[0]-(attacker->r.currentOrigin)[0],(dir)[1]=(org)[1]-(attacker->r.currentOrigin)[1],(dir)[2]=(org)[2]-(attacker->r.currentOrigin)[2]);
		VectorNormalize( dir );
	}
	else
	{
		((dir)[0]=(up)[0],(dir)[1]=(up)[1],(dir)[2]=(up)[2]);
	} 
	...
	{ 
		vec3_t ang;
		((ang)[0]=(0.0f), (ang)[1]=(1.0f), (ang)[2]=(0.0f));
	...
	if ( self->splashDamage > 0 && self->splashRadius > 0 )
	{
		...
		G_RadiusDamage( org, self, self->splashDamage, self->splashRadius, self, ((void *)0), MOD_UNKNOWN );
...
void funcBBrushPain(gentity_t *self, gentity_t *attacker, int damage)
{
		...
		|| self->material == MAT_SNOWY_ROCK )
	{
		...
		if ( attacker != ((void *)0) && attacker->client )
		{
			((dir)[0]=(attacker->r.currentOrigin)[0]-(org)[0],(dir)[1]=(attacker->r.currentOrigin)[1]-(org)[1],(dir)[2]=(attacker->r.currentOrigin)[2]-(org)[2]);
			VectorNormalize( dir );
		}
		else
		{
...
void SP_func_breakable( gentity_t *self ) 
{
	...
	G_SpawnFloat( "radius", "1", &self->radius ); 
...
void GlassDie(gentity_t *self, gentity_t *inflictor, gentity_t *attacker, int damage, int mod)
{
	...
	self->splashRadius = 40; 

	te = G_TempEntity( dif, EV_GLASS_SHATTER );
	te->s.genericenemyindex = self->s.number;
	((te->s.origin)[0]=(self->pos1)[0],(te->s.origin)[1]=(self->pos1)[1],(te->s.origin)[2]=(self->pos1)[2]);
	((te->s.angles)[0]=(self->pos2)[0],(te->s.angles)[1]=(self->pos2)[1],(te->s.angles)[2]=(self->pos2)[2]);
...
void GlassDie_Old(gentity_t *self, gentity_t *inflictor, gentity_t *attacker, int damage, int mod)
{
	...
	te = G_TempEntity( dif, EV_GLASS_SHATTER );
	te->s.genericenemyindex = self->s.number;
	((te->s.origin)[0]=(self->r.maxs)[0],(te->s.origin)[1]=(self->r.maxs)[1],(te->s.origin)[2]=(self->r.maxs)[2]);
	((te->s.angles)[0]=(self->r.mins)[0],(te->s.angles)[1]=(self->r.mins)[1],(te->s.angles)[2]=(self->r.mins)[2]);
...
void GlassUse(gentity_t *self, gentity_t *other, gentity_t *activator)
{
	...
	((temp1)[0]=(self->r.mins)[0]+(self->r.maxs)[0],(temp1)[1]=(self->r.mins)[1]+(self->r.maxs)[1],(temp1)[2]=(self->r.mins)[2]+(self->r.maxs)[2]);
	((temp1)[0]=(temp1)[0]*(0.5f),(temp1)[1]=(temp1)[1]*(0.5f),(temp1)[2]=(temp1)[2]*(0.5f));

	((temp2)[0]=(other->r.mins)[0]+(other->r.maxs)[0],(temp2)[1]=(other->r.mins)[1]+(other->r.maxs)[1],(temp2)[2]=(other->r.mins)[2]+(other->r.maxs)[2]);
	((temp2)[0]=(temp2)[0]*(0.5f),(temp2)[1]=(temp2)[1]*(0.5f),(temp2)[2]=(temp2)[2]*(0.5f));

	((self->pos2)[0]=(temp1)[0]-(temp2)[0],(self->pos2)[1]=(temp1)[1]-(temp2)[1],(self->pos2)[2]=(temp1)[2]-(temp2)[2]);
	((self->pos1)[0]=(temp1)[0],(self->pos1)[1]=(temp1)[1],(self->pos1)[2]=(temp1)[2]);

	VectorNormalize( self->pos2 );
	((self->pos2)[0]=(self->pos2)[0]*(390),(self->pos2)[1]=(self->pos2)[1]*(390),(self->pos2)[2]=(self->pos2)[2]*(390));
...
void func_wait_return_solid( gentity_t *self )
{
	...
	self->clipmask = 0x00000100;
	if ( !(self->spawnflags&16) || G_TestEntityPosition( self ) == ((void *)0) )
	{
		trap_SetBrushModel( self, self->model );
		InitMover( self );
		((self->s.pos.trBase)[0]=(self->s.origin)[0],(self->s.pos.trBase)[1]=(self->s.origin)[1],(self->s.pos.trBase)[2]=(self->s.origin)[2]);
		((self->r.currentOrigin)[0]=(self->s.origin)[0],(self->r.currentOrigin)[1]=(self->s.origin)[1],(self->r.currentOrigin)[2]=(self->s.origin)[2]);
		self->r.svFlags &= ~0x00000001;
		self->s.eFlags &= ~(1<<8);
...
qboolean G_EntIsRemovableUsable( int entNum )
{
	...
	{
		if ( !(ent->s.eFlags&(1<<4)) && !(ent->spawnflags&8) && ent->targetname )
		{
			return qtrue;
		}
	}
...
void SP_func_usable( gentity_t *self ) 
{
	...
	((self->s.pos.trBase)[0]=(self->s.origin)[0],(self->s.pos.trBase)[1]=(self->s.origin)[1],(self->s.pos.trBase)[2]=(self->s.origin)[2]);
	((self->r.currentOrigin)[0]=(self->s.origin)[0],(self->r.currentOrigin)[1]=(self->s.origin)[1],(self->r.currentOrigin)[2]=(self->s.origin)[2]);
	((self->pos1)[0]=(self->s.origin)[0],(self->pos1)[1]=(self->s.origin)[1],(self->pos1)[2]=(self->s.origin)[2]);
