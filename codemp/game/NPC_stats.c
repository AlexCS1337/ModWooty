...
void NPC_BuildRandom( gentity_t *NPC )
{
	...
	case 0://female
		...
		default:
		case 0:
			Q_strncpyz( NPC->client->renderInfo.torsoModelName, "crewfemale/admin_number", sizeof(NPC->client->renderInfo.torsoModelName), qtrue );
			break;
		case 1:
	...
	case 2://male
		...
		case 2:
			...
			break;
			//NOTE: 3 - 5 should be red, admin_number & blue, afram hands
		}
...
*/
	...
	*/
	...
	//NPC->client->dismemberProbHead = 50;
	//NPC->client->dismemberProbArms = 50;
	//NPC->client->dismemberProbHands = 50;
	//NPC->client->dismemberProbWaist = 50;
	//NPC->client->dismemberProbLegs = 50;//100 all
