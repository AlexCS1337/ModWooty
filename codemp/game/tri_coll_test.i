#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\tri_coll_test.c"
...
#line 16 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\tri_coll_test.c"
...
#line 17 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\tri_coll_test.c"
...
#line 18 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\tri_coll_test.c"
...
#line 231 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\tri_coll_test.c"
  du0du1=du0*du1;
  du0du2=du0*du2;
  ...
  if(fabs(dv0)<0.000001) dv0=0.0;
  if(fabs(dv1)<0.000001) dv1=0.0;
  if(fabs(dv2)<0.000001) dv2=0.0;
#line 254 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\tri_coll_test.c"
  ...
  if(dv0dv1>0.0f) { isect1[0]=vp2+(vp0-vp2)*dv2/(dv2-dv0); isect1[1]=vp2+(vp1-vp2)*dv2/(dv2-dv1);; } else if(dv0dv2>0.0f) { isect1[0]=vp1+(vp0-vp1)*dv1/(dv1-dv0); isect1[1]=vp1+(vp2-vp1)*dv1/(dv1-dv2);; } else if(dv1*dv2>0.0f || dv0!=0.0f) { isect1[0]=vp0+(vp1-vp0)*dv0/(dv0-dv1); isect1[1]=vp0+(vp2-vp0)*dv0/(dv0-dv2);; } else if(dv1!=0.0f) { isect1[0]=vp1+(vp0-vp1)*dv1/(dv1-dv0); isect1[1]=vp1+(vp2-vp1)*dv1/(dv1-dv2);; } else if(dv2!=0.0f) { isect1[0]=vp2+(vp0-vp2)*dv2/(dv2-dv0); isect1[1]=vp2+(vp1-vp2)*dv2/(dv2-dv1);; } else { return coplanar_tri_tri(N1,V0,V1,V2,U0,U1,U2); };

  
  if(du0du1>0.0f) { isect2[0]=up2+(up0-up2)*du2/(du2-du0); isect2[1]=up2+(up1-up2)*du2/(du2-du1);; } else if(du0du2>0.0f) { isect2[0]=up1+(up0-up1)*du1/(du1-du0); isect2[1]=up1+(up2-up1)*du1/(du1-du2);; } else if(du1*du2>0.0f || du0!=0.0f) { isect2[0]=up0+(up1-up0)*du0/(du0-du1); isect2[1]=up0+(up2-up0)*du0/(du0-du2);; } else if(du1!=0.0f) { isect2[0]=up1+(up0-up1)*du1/(du1-du0); isect2[1]=up1+(up2-up1)*du1/(du1-du2);; } else if(du2!=0.0f) { isect2[0]=up2+(up0-up2)*du2/(du2-du0); isect2[1]=up2+(up1-up2)*du2/(du2-du1);; } else { return coplanar_tri_tri(N1,V0,V1,V2,U0,U1,U2); };

  if(isect1[0]>isect1[1]) { float c; c=isect1[0]; isect1[0]=isect1[1]; isect1[1]=c; };
  if(isect2[0]>isect2[1]) { float c; c=isect2[0]; isect2[0]=isect2[1]; isect2[1]=c; };
