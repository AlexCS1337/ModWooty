#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_util.c"
...
#line 2 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_util.c"
#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\q_shared.h"
...
#line 3 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_util.c"
...
#line 4 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_util.c"
...
#line 5 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_util.c"
...
#line 80 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\ai_util.c"
}
...
int BotDoChat(bot_state_t *bs, char *section, int always)
{
	...
	if (Q_irand(1, 7) > bs->chatFrequency && !always) 
	{
		return 0;
	}
	...
	chatgroup = (char *)B_TempAlloc(8192);
...
int ReadChatGroups(bot_state_t *bs, char *buf)
{
	...
	if (strlen(cgroupbegin) >= 8192)
	{
		G_Printf("^1" "Error: Personality chat section exceeds max size\n");
		return 0;
	}
...
void BotUtilizePersonality(bot_state_t *bs)
{
	...
	if (!f)
	{
		G_Printf("^1" "Error: Specified personality not found\n");
		B_TempFree(131072); 
		return;
	}
	...
	if (len >= 131072)
	{
		G_Printf("^1" "Personality file exceeds maximum length\n");
		B_TempFree(131072); 
		return;
	}
	...
	{
		G_Printf("^1" "Personality file contains no GeneralBotInfo group\n");
		failed = 1; 
	}
	...
	{
		bs->skills.turnspeed_combat = 0.05f; 
	}
	...
	{
		Com_sprintf(bs->forceinfo, sizeof(bs->forceinfo), "%s\0", "5-1-333000203330333203");
	}
