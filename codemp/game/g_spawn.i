#line 1 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_spawn.c"
...
#line 5 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_spawn.c"
...
BG_field_t fields[] = {
	{"classname", ((int)&(((gentity_t *)0)->classname)), F_LSTRING},
	{"teamnodmg", ((int)&(((gentity_t *)0)->teamnodmg)), F_INT},
	{"teamowner", ((int)&(((gentity_t *)0)->s.teamowner)), F_INT},
	{"teamuser", ((int)&(((gentity_t *)0)->alliedTeam)), F_INT},
	{"alliedTeam", ((int)&(((gentity_t *)0)->alliedTeam)), F_INT},
	{"roffname", ((int)&(((gentity_t *)0)->roffname)), F_LSTRING},
	{"rofftarget", ((int)&(((gentity_t *)0)->rofftarget)), F_LSTRING},
	{"healingclass", ((int)&(((gentity_t *)0)->healingclass)), F_LSTRING},
	{"healingsound", ((int)&(((gentity_t *)0)->healingsound)), F_LSTRING},
	{"healingrate", ((int)&(((gentity_t *)0)->healingrate)), F_INT},
	{"ownername", ((int)&(((gentity_t *)0)->ownername)), F_LSTRING},
	{"origin", ((int)&(((gentity_t *)0)->s.origin)), F_VECTOR},
	{"model", ((int)&(((gentity_t *)0)->model)), F_LSTRING},
	{"model2", ((int)&(((gentity_t *)0)->model2)), F_LSTRING},
	{"spawnflags", ((int)&(((gentity_t *)0)->spawnflags)), F_INT},
	{"speed", ((int)&(((gentity_t *)0)->speed)), F_FLOAT},
	{"target", ((int)&(((gentity_t *)0)->target)), F_LSTRING},
	{"target2", ((int)&(((gentity_t *)0)->target2)), F_LSTRING},
	{"target3", ((int)&(((gentity_t *)0)->target3)), F_LSTRING},
	{"target4", ((int)&(((gentity_t *)0)->target4)), F_LSTRING},
	{"target5", ((int)&(((gentity_t *)0)->target5)), F_LSTRING},
	{"target6", ((int)&(((gentity_t *)0)->target6)), F_LSTRING},
	{"NPC_targetname", ((int)&(((gentity_t *)0)->NPC_targetname)), F_LSTRING},
	{"NPC_target", ((int)&(((gentity_t *)0)->NPC_target)), F_LSTRING},
	{"NPC_target2", ((int)&(((gentity_t *)0)->target2)), F_LSTRING},
	{"NPC_target4", ((int)&(((gentity_t *)0)->target4)), F_LSTRING},
	{"NPC_type", ((int)&(((gentity_t *)0)->NPC_type)), F_LSTRING},
	{"targetname", ((int)&(((gentity_t *)0)->targetname)), F_LSTRING},
	{"message", ((int)&(((gentity_t *)0)->message)), F_LSTRING},
	{"team", ((int)&(((gentity_t *)0)->team)), F_LSTRING},
	{"wait", ((int)&(((gentity_t *)0)->wait)), F_FLOAT},
	{"delay", ((int)&(((gentity_t *)0)->delay)), F_INT},
	{"random", ((int)&(((gentity_t *)0)->random)), F_FLOAT},
	{"count", ((int)&(((gentity_t *)0)->count)), F_INT},
	{"health", ((int)&(((gentity_t *)0)->health)), F_INT},
	{"light", 0, F_IGNORE},
	{"dmg", ((int)&(((gentity_t *)0)->damage)), F_INT},
	{"angles", ((int)&(((gentity_t *)0)->s.angles)), F_VECTOR},
	{"angle", ((int)&(((gentity_t *)0)->s.angles)), F_ANGLEHACK},
	{"targetShaderName", ((int)&(((gentity_t *)0)->targetShaderName)), F_LSTRING},
	{"targetShaderNewName", ((int)&(((gentity_t *)0)->targetShaderNewName)), F_LSTRING},
	{"linear", ((int)&(((gentity_t *)0)->alt_fire)), F_INT},

	{"closetarget", ((int)&(((gentity_t *)0)->closetarget)), F_LSTRING},
	{"opentarget", ((int)&(((gentity_t *)0)->opentarget)), F_LSTRING},
	{"paintarget", ((int)&(((gentity_t *)0)->paintarget)), F_LSTRING},

	{"goaltarget", ((int)&(((gentity_t *)0)->goaltarget)), F_LSTRING},
	{"idealclass", ((int)&(((gentity_t *)0)->idealclass)), F_LSTRING},

	
	{"spawnscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_SPAWN])), F_LSTRING},
	{"usescript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_USE])), F_LSTRING},
	{"awakescript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_AWAKE])), F_LSTRING},
	{"angerscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_ANGER])), F_LSTRING},
	{"attackscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_ATTACK])), F_LSTRING},
	{"victoryscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_VICTORY])), F_LSTRING},
	{"lostenemyscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_LOSTENEMY])), F_LSTRING},
	{"painscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_PAIN])), F_LSTRING},
	{"fleescript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_FLEE])), F_LSTRING},
	{"deathscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_DEATH])), F_LSTRING},
	{"delayscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_DELAYED])), F_LSTRING},
	{"delayscripttime", ((int)&(((gentity_t *)0)->delayScriptTime)), F_INT},
	{"blockedscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_BLOCKED])), F_LSTRING},
	{"ffirescript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_FFIRE])), F_LSTRING},
	{"ffdeathscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_FFDEATH])), F_LSTRING},
	{"mindtrickscript", ((int)&(((gentity_t *)0)->behaviorSet[BSET_MINDTRICK])), F_LSTRING},
	{"script_targetname", ((int)&(((gentity_t *)0)->script_targetname)), F_LSTRING},

	{"fullName", ((int)&(((gentity_t *)0)->fullName)), F_LSTRING},

	{"soundSet", ((int)&(((gentity_t *)0)->soundSet)), F_LSTRING},
	{"radius", ((int)&(((gentity_t *)0)->radius)), F_FLOAT},
	{"numchunks", ((int)&(((gentity_t *)0)->radius)), F_FLOAT},
	{"chunksize", ((int)&(((gentity_t *)0)->mass)), F_FLOAT},
...
#line 764 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_spawn.c"
...
#line 766 "c:\\projects\\jedi_academy_sdk(mp)\\codemp\\game\\g_spawn.c"
...
char *G_AddSpawnVarToken( const char *string ) {
	...
	l = strlen( string );
	if ( level.numSpawnVarChars + l + 1 > 4096 ) {
		return;
...
static void HandleEntityAdjustment(void)
{
	...
	rotation = ( ( (level.mRotationAdjust) * 3.14159265358979323846f ) / 180.0F );
	...
	((newOrigin)[0]=(newOrigin)[0]+(level.mOriginAdjust)[0],(newOrigin)[1]=(newOrigin)[1]+(level.mOriginAdjust)[1],(newOrigin)[2]=(newOrigin)[2]+(level.mOriginAdjust)[2]);
	
	Com_sprintf(temp, 64, "%0.0f %0.0f %0.0f", newOrigin[0], newOrigin[1], newOrigin[2]);
	...
	if (Q_stricmp(value, "novalue") != 0)
	{
		...
		Com_sprintf(temp, 64, "%0.0f %0.0f %0.0f", angles[0], angles[1], angles[2]);
	...
	else
	{
		...
		angles[1] = fmod(angles[1] + level.mRotationAdjust, 360.0f);
		Com_sprintf(temp, 64, "%0.0f", angles[1]);
	...
	if (Q_stricmp(value, "novalue") != 0)
	{
		Com_sprintf(temp, 64, "%s%s", level.mTargetAdjust, value);
...
void SP_worldspawn( void ) 
{
	...
	G_SpawnFloat("distanceCull", va("%i.0",g_serverculldist.integer), &g_cullDistance);
	...
	for ( i = 0 ; i < level.numSpawnVars ; i++ ) 
	{
		...
		{
			BG_ParseField( fields, level.spawnVars[i][0], level.spawnVars[i][1], (byte *)&g_entities[((1<<10)-2)] );
		}
	}
	...
	trap_SetConfigstring( 20, "basejka-1" );

	trap_SetConfigstring( 21, va("%i", level.startTime ) );

	G_SpawnString( "music", "", &text );
	trap_SetConfigstring( 2, text );

	G_SpawnString( "message", "", &text );
	trap_SetConfigstring( 3, text );				

	trap_SetConfigstring( 4, g_motd.string );		
	...
	trap_SetConfigstring( 32, text );

	g_entities[((1<<10)-2)].s.number = ((1<<10)-2);
	g_entities[((1<<10)-2)].classname = "worldspawn";

	
	trap_SetConfigstring( 5, "" );
	...
	trap_SetConfigstring((((((((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+32)+64)+64)+64) + 64)+(0*3)+0, defaultStyles[0][0]);
	trap_SetConfigstring((((((((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+32)+64)+64)+64) + 64)+(0*3)+1, defaultStyles[0][1]);
	trap_SetConfigstring((((((((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+32)+64)+64)+64) + 64)+(0*3)+2, defaultStyles[0][2]);
	...
	for(i=1;i<32;i++)
	{
		...
		trap_SetConfigstring((((((((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+32)+64)+64)+64) + 64)+((i+0)*3)+0, text);

		Com_sprintf(temp, sizeof(temp), "ls_%dg", i);
		G_SpawnString(temp, defaultStyles[i][1], &text);
		lengthGreen = strlen(text);
		trap_SetConfigstring((((((((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+32)+64)+64)+64) + 64)+((i+0)*3)+1, text);

		Com_sprintf(temp, sizeof(temp), "ls_%db", i);
		G_SpawnString(temp, defaultStyles[i][2], &text);
		lengthBlue = strlen(text);
		trap_SetConfigstring((((((((((((((((37+256)+1)+1)+1)+1)+1)+512)+1)+256)+64)+32)+64)+64)+64) + 64)+((i+0)*3)+2, text);
...
void G_SpawnEntitiesFromString( qboolean inSubBSP ) {
	...
	if( g_entities[((1<<10)-2)].behaviorSet[BSET_SPAWN] && g_entities[((1<<10)-2)].behaviorSet[BSET_SPAWN][0] )
	{
		
		gentity_t *script_runner = G_Spawn();
		if ( script_runner )
		{
			script_runner->behaviorSet[BSET_USE] = g_entities[((1<<10)-2)].behaviorSet[BSET_SPAWN];
